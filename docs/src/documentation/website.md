...
This repo contains the visualization website for MATSim/EpiSim, available at [covid-sim.info](https://covid-sim.info). See that website for information on the use of MATSim for COVID-19 disease propagation, given various measures for combating its spread.

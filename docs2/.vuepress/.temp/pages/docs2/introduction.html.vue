...
<p>EpiSim is an agent-based epidemiological model used to track the development of
COVID-19 cases
and estimate the impact of various government-imposed mitigation
strategies (<a href="https://doi.org/10.48550/arXiv.2011.11453" target="_blank" rel="noopener noreferrer">Müller 2020</a>). The first version was programmed in
...
Research until February 2024 (<a href="https://depositonce.tu-berlin.de/handle/11303/11125" target="_blank" rel="noopener noreferrer">MODUS-COVID consortium 2020-2024</a>).</p>
<p>EpiSim is
...
the political and the scientific discourse.</p>
<ol>
<li>
<p>Many of the mechanics of EpiSim are directly fed by external data
...
updating the data sources.</p>
</li>
<li>
<p>The agent-based nature of EpiSim, as well as the mechanical infection
...
specific age-groups, or activity types.</p>
</li>
</ol>
<p>This user guide introduces the basic software structure of
EpiSim,
...
comment on our department's implementations of certain functionalities.</p>
</div></template>

    ...
    .content
      .main
        .top
          p.headline
            b COVID-Sim:
            | &nbsp;a virus spreading dynamics model which combines advanced human mobility models with virus infection dynamics taken from recent literature and publications
        ...
        p The following interactive visualizations illustrate the method and results which emerge from the model. These are produced directly from simulated model results. Note that due to the advanced nature of the visualizations, only modern versions of recent web browsers are supported.

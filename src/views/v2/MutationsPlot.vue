...
export default defineComponent({
  ...
  props: {
    ...
    strainValues: { type: Array as PropType<any[]>, required: true },
  ...
  data() {
    return {
      isResizing: false,
      color: '#04f',
      originalDataUrl: PUBLIC_SVN + 'original-data/Fallzahlen/',
      factor100k: 1,
      svnUrl: '',
      ...
      unselectedLines3: [] as string[],
      startURL: [] as string[],
      startURL2: [] as string[],
      startURL3: [] as string[],

      cacheRawVOCData: {} as { [city: string]: any[] },

      lineDataLookup: {} as any,
  ...
  methods: {
    ...
    calculateValueForStrain(strain: string) {
      const x: any[] = []
      const r: any[] = []
      const t: any[] = []

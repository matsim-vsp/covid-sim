var z=Object.defineProperty;var B=(n,t,e)=>t in n?z(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var v=(n,t,e)=>B(n,typeof t!="symbol"?t+"":t,e);import{d as _,s as p,C as f,D as S,L as b,n as x,g as F}from"./index-BSPVUhcA.js";import{P as E}from"./papaparse.min-pxEmrU2H.js";import{V as L}from"./vue-slider-component.umd.min-CtmwEXCl.js";import{B as R,F as k,C as y,S as H,W as O,L as I,a as l,b as M,E as u,V as D,c as V,d as G,N as j,P as q,e as U,M as W,f as Y,g as X,_ as J}from"./darkmode-BCA3TCNZ.js";import{Z as K}from"./zip-loader.module-BRLILkva.js";function Z(n,t){for(var e=0;e<t.length;e++){const i=t[e];if(typeof i!="string"&&!Array.isArray(i)){for(const s in i)if(s!=="default"&&!(s in n)){const o=Object.getOwnPropertyDescriptor(i,s);o&&Object.defineProperty(n,s,o.get?o:{enumerable:!0,get:()=>i[s]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}class C extends R{constructor(e,i,s){super();v(this,"midX");v(this,"midY");v(this,"tripsPerAgent",{});this.midX=i,this.midY=s;const o=[],a=[],c=[],d=[];for(const m of Object.keys(e)){const r=e[m];this.buildWaypoints(r,o,a,c,d)}this.setAttribute("position",new k(o,3)),this.setAttribute("position2",new k(a,3)),this.setAttribute("infectionTime",new k(c,3)),this.setAttribute("infectionStatus",new k(d,3));const g=2*3*o.length+2*3*c.length;console.log("######## GPU RAM:",g)}updateInfections(e){const i=[],s=[];for(const o of Object.keys(e)){const a=e[o],c=this.tripsPerAgent[a.id];for(let d=0;d<c;d++)i.push(...a.dtime),s.push(...a.d)}this.setAttribute("infectionTime",new k(i,3)),this.setAttribute("infectionStatus",new k(s,3))}buildWaypoints(e,i,s,o,a){const c=e.time.length;if(c<2)return;const d=C.buildInfectionTimes(e),g=C.buildInfectionTypes(e);let m=0;if(e.time[0]!==0){const r=e.path[0][0]-this.midX,h=e.path[0][1]-this.midY,w=e.time[0];i.push(r,h,0),s.push(r,h,w),o.push(...d),a.push(...g),m++}for(let r=0;r<c-1;r++){const h=e.path[r][0]-this.midX,w=e.path[r][1]-this.midY,T=e.time[r];i.push(h,w,T);const P=e.path[r+1][0]-this.midX,A=e.path[r+1][1]-this.midY,N=e.time[r+1];s.push(P,A,N),o.push(...d),a.push(...g),m++}if(e.time[c-1]!==86400){const r=e.path[c-1][0]-this.midX,h=e.path[c-1][1]-this.midY,w=e.time[c-1];i.push(r,h,w),s.push(r,h,86400),o.push(...d),a.push(...g),m++}this.tripsPerAgent[e.id]=m}static buildInfectionTimes(e){switch(e.dtime.length){case 0:return[0,-1,-1];case 1:return[e.dtime[0],-1,-1];case 2:return[e.dtime[0],e.dtime[1],-1];case 3:default:return[e.dtime[0],e.dtime[1],e.dtime[2]]}}static buildInfectionTypes(e){switch(e.d.length){case 0:return[0,-1,-1];case 1:return[e.d[0],-1,-1];case 2:return[e.d[0],e.d[1],-1];case 3:default:return[e.d[0],e.d[1],e.d[2]]}}}const Q=`// vertex shader: agent positions
...
`,tt=`// fragment shader: pixel colors

(function(){"use strict";var c0=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function z0(a){return a&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a}var M0={},j0=a=>a?typeof Symbol.observable=="symbol"&&typeof a[Symbol.observable]=="function"?a===a[Symbol.observable]():typeof a["@@observable"]=="function"?a===a["@@observable"]():!1:!1,X={},g0={};Object.defineProperty(g0,"__esModule",{value:!0}),g0.DefaultSerializer=g0.extendSerializer=void 0;function F0(a,c){const W=a.deserialize.bind(a),b=a.serialize.bind(a);return{deserialize(S){return c.deserialize(S,W)},serialize(S){return c.serialize(S,b)}}}g0.extendSerializer=F0;const P0={deserialize(a){return Object.assign(Error(a.message),{name:a.name,stack:a.stack})},serialize(a){return{__error_marker:"$$error",message:a.message,name:a.name,stack:a.stack}}},L0=a=>a&&typeof a=="object"&&"__error_marker"in a&&a.__error_marker==="$$error";g0.DefaultSerializer={deserialize(a){return L0(a)?P0.deserialize(a):a},serialize(a){return a instanceof Error?P0.serialize(a):a}},Object.defineProperty(X,"__esModule",{value:!0}),X.serialize=X.deserialize=X.registerSerializer=void 0;const V0=g0;let S0=V0.DefaultSerializer;function $0(a){S0=V0.extendSerializer(S0,a)}X.registerSerializer=$0;function U0(a){return S0.deserialize(a)}X.deserialize=U0;function q0(a){return S0.serialize(a)}X.serialize=q0;var h0={},L={};Object.defineProperty(L,"__esModule",{value:!0}),L.$worker=L.$transferable=L.$terminate=L.$events=L.$errors=void 0,L.$errors=Symbol("thread.errors"),L.$events=Symbol("thread.events"),L.$terminate=Symbol("thread.terminate"),L.$transferable=Symbol("thread.transferable"),L.$worker=Symbol("thread.worker"),Object.defineProperty(h0,"__esModule",{value:!0}),h0.Transfer=h0.isTransferDescriptor=void 0;const _0=L;function K0(a){return!(!a||typeof a!="object")}function J0(a){return a&&typeof a=="object"&&a[_0.$transferable]}h0.isTransferDescriptor=J0;function G0(a,c){if(!c){if(!K0(a))throw Error();c=[a]}return{[_0.$transferable]:!0,send:a,transferables:c}}h0.Transfer=G0;var v0={};(function(a){Object.defineProperty(a,"__esModule",{value:!0}),a.WorkerMessageType=a.MasterMessageType=void 0,function(c){c.cancel="cancel",c.run="run"}(a.MasterMessageType||(a.MasterMessageType={})),function(c){c.error="error",c.init="init",c.result="result",c.running="running",c.uncaughtError="uncaughtError"}(a.WorkerMessageType||(a.WorkerMessageType={}))})(v0);var W0={};Object.defineProperty(W0,"__esModule",{value:!0});const Q0=function(){const c=typeof self<"u"&&typeof Window<"u"&&self instanceof Window;return!!(typeof self<"u"&&self.postMessage&&!c)},Z0=function(c,W){self.postMessage(c,W)},Y0=function(c){const W=S=>{c(S.data)},b=()=>{self.removeEventListener("message",W)};return self.addEventListener("message",W),b};W0.default={isWorkerRuntime:Q0,postMessageToMaster:Z0,subscribeToMasterMessages:Y0},function(a){var c=c0&&c0.__awaiter||function(n,e,r,i){function l(d){return d instanceof r?d:new r(function(u){u(d)})}return new(r||(r=Promise))(function(d,u){function E(p){try{t(i.next(p))}catch(o){u(o)}}function k(p){try{t(i.throw(p))}catch(o){u(o)}}function t(p){p.done?d(p.value):l(p.value).then(E,k)}t((i=i.apply(n,e||[])).next())})},W=c0&&c0.__importDefault||function(n){return n&&n.__esModule?n:{default:n}};Object.defineProperty(a,"__esModule",{value:!0}),a.expose=a.isWorkerRuntime=a.Transfer=a.registerSerializer=void 0;const b=W(j0),S=X,V=h0,R=v0,z=W(W0);var s=X;Object.defineProperty(a,"registerSerializer",{enumerable:!0,get:function(){return s.registerSerializer}});var f=h0;Object.defineProperty(a,"Transfer",{enumerable:!0,get:function(){return f.Transfer}}),a.isWorkerRuntime=z.default.isWorkerRuntime;let y=!1;const v=new Map,Q=n=>n&&n.type===R.MasterMessageType.cancel,n0=n=>n&&n.type===R.MasterMessageType.run,$=n=>b.default(n)||K(n);function K(n){return n&&typeof n=="object"&&typeof n.subscribe=="function"}function e0(n){return V.isTransferDescriptor(n)?{payload:n.send,transferables:n.transferables}:{payload:n,transferables:void 0}}function d0(){const n={type:R.WorkerMessageType.init,exposed:{type:"function"}};z.default.postMessageToMaster(n)}function u0(n){const e={type:R.WorkerMessageType.init,exposed:{type:"module",methods:n}};z.default.postMessageToMaster(e)}function B0(n,e){const{payload:r,transferables:i}=e0(e),l={type:R.WorkerMessageType.error,uid:n,error:S.serialize(r)};z.default.postMessageToMaster(l,i)}function o0(n,e,r){const{payload:i,transferables:l}=e0(r),d={type:R.WorkerMessageType.result,uid:n,complete:e?!0:void 0,payload:i};z.default.postMessageToMaster(d,l)}function N0(n,e){const r={type:R.WorkerMessageType.running,uid:n,resultType:e};z.default.postMessageToMaster(r)}function a0(n){try{const e={type:R.WorkerMessageType.uncaughtError,error:S.serialize(n)};z.default.postMessageToMaster(e)}catch(e){console.error(`Not reporting uncaught error back to master thread as it occured while reporting an uncaught error already.
Latest error:`,e,`
Original error:`,n)}}function J(n,e,r){return c(this,void 0,void 0,function*(){let i;try{i=e(...r)}catch(d){return B0(n,d)}const l=$(i)?"observable":"promise";if(N0(n,l),$(i)){const d=i.subscribe(u=>o0(n,!1,S.serialize(u)),u=>{B0(n,S.serialize(u)),v.delete(n)},()=>{o0(n,!0),v.delete(n)});v.set(n,d)}else try{const d=yield i;o0(n,!0,S.serialize(d))}catch(d){B0(n,S.serialize(d))}})}function A(n){if(!z.default.isWorkerRuntime())throw Error("expose() called in the master thread.");if(y)throw Error("expose() called more than once. This is not possible. Pass an object to expose() if you want to expose multiple functions.");if(y=!0,typeof n=="function")z.default.subscribeToMasterMessages(e=>{n0(e)&&!e.method&&J(e.uid,n,e.args.map(S.deserialize))}),d0();else if(typeof n=="object"&&n){z.default.subscribeToMasterMessages(r=>{n0(r)&&r.method&&J(r.uid,n[r.method],r.args.map(S.deserialize))});const e=Object.keys(n).filter(r=>typeof n[r]=="function");u0(e)}else throw Error(`Invalid argument passed to expose(). Expected a function or an object, got: ${n}`);z.default.subscribeToMasterMessages(e=>{if(Q(e)){const r=e.uid,i=v.get(r);i&&(i.unsubscribe(),v.delete(r))}})}a.expose=A,typeof self<"u"&&typeof self.addEventListener=="function"&&z.default.isWorkerRuntime()&&(self.addEventListener("error",n=>{setTimeout(()=>a0(n.error||n),250)}),self.addEventListener("unhandledrejection",n=>{const e=n.reason;e&&typeof e.message=="string"&&setTimeout(()=>a0(e),250)})),typeof process<"u"&&typeof process.on=="function"&&z.default.isWorkerRuntime()&&(process.on("uncaughtException",n=>{setTimeout(()=>a0(n),250)}),process.on("unhandledRejection",n=>{n&&typeof n.message=="string"&&setTimeout(()=>a0(n),250)}))}(M0);var A0=z0(M0);const X0=A0.expose;A0.registerSerializer,A0.Transfer;const y0="https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/episim/";var E0={exports:{}};/* @license
Papa Parse
v5.3.2
https://github.com/mholt/PapaParse
License: MIT
*/(function(a,c){(function(W,b){a.exports=b()})(c0,function W(){var b=typeof self<"u"?self:typeof window<"u"?window:b!==void 0?b:{},S=!b.document&&!!b.postMessage,V=S&&/blob:/i.test((b.location||{}).protocol),R={},z=0,s={},f=[];if(s.parse=function(n,e){var r=(e=e||{}).dynamicTyping||!1;if(A(r)&&(e.dynamicTypingFunction=r,r={}),e.dynamicTyping=r,e.transform=!!A(e.transform)&&e.transform,e.worker&&s.WORKERS_SUPPORTED){var i=function(){if(!s.WORKERS_SUPPORTED)return!1;var d=(E=b.URL||b.webkitURL||null,k=W.toString(),s.BLOB_URL||(s.BLOB_URL=E.createObjectURL(new Blob(["(",k,")();"],{type:"text/javascript"})))),u=new b.Worker(d),E,k;return u.onmessage=B0,u.id=z++,R[u.id]=u}();return i.userStep=e.step,i.userChunk=e.chunk,i.userComplete=e.complete,i.userError=e.error,e.step=A(e.step),e.chunk=A(e.chunk),e.complete=A(e.complete),e.error=A(e.error),delete e.worker,void i.postMessage({input:n,config:e,workerId:i.id})}var l=null;return s.NODE_STREAM_INPUT,typeof n=="string"?l=e.download?new Q(e):new $(e):n.readable===!0&&A(n.read)&&A(n.on)?l=new K(e):(b.File&&n instanceof File||n instanceof Object)&&(l=new n0(e)),l.stream(n)},s.unparse=function(n,e){var r=!1,i=!0,l=",",d=`\r
`,u='"',E=u+u,k=!1,t=null,p=!1;(function(){if(typeof e=="object"){if(typeof e.delimiter!="string"||s.BAD_DELIMITERS.filter(function(h){return e.delimiter.indexOf(h)!==-1}).length||(l=e.delimiter),(typeof e.quotes=="boolean"||typeof e.quotes=="function"||Array.isArray(e.quotes))&&(r=e.quotes),typeof e.skipEmptyLines!="boolean"&&typeof e.skipEmptyLines!="string"||(k=e.skipEmptyLines),typeof e.newline=="string"&&(d=e.newline),typeof e.quoteChar=="string"&&(u=e.quoteChar),typeof e.header=="boolean"&&(i=e.header),Array.isArray(e.columns)){if(e.columns.length===0)throw new Error("Option columns is empty");t=e.columns}e.escapeChar!==void 0&&(E=e.escapeChar+u),(typeof e.escapeFormulae=="boolean"||e.escapeFormulae instanceof RegExp)&&(p=e.escapeFormulae instanceof RegExp?e.escapeFormulae:/^[=+\-@\t\r].*$/)}})();var o=new RegExp(d0(u),"g");if(typeof n=="string"&&(n=JSON.parse(n)),Array.isArray(n)){if(!n.length||Array.isArray(n[0]))return Z(null,n,k);if(typeof n[0]=="object")return Z(t||Object.keys(n[0]),n,k)}else if(typeof n=="object")return typeof n.data=="string"&&(n.data=JSON.parse(n.data)),Array.isArray(n.data)&&(n.fields||(n.fields=n.meta&&n.meta.fields||t),n.fields||(n.fields=Array.isArray(n.data[0])?n.fields:typeof n.data[0]=="object"?Object.keys(n.data[0]):[]),Array.isArray(n.data[0])||typeof n.data[0]=="object"||(n.data=[n.data])),Z(n.fields||[],n.data||[],k);throw new Error("Unable to serialize unrecognized input");function Z(h,w,D){var M="";typeof h=="string"&&(h=JSON.parse(h)),typeof w=="string"&&(w=JSON.parse(w));var x=Array.isArray(h)&&0<h.length,C=!Array.isArray(w[0]);if(x&&i){for(var O=0;O<h.length;O++)0<O&&(M+=l),M+=I(h[O],O);0<w.length&&(M+=d)}for(var g=0;g<w.length;g++){var H=x?h.length:w[g].length,T=!1,_=x?Object.keys(w[g]).length===0:w[g].length===0;if(D&&!x&&(T=D==="greedy"?w[g].join("").trim()==="":w[g].length===1&&w[g][0].length===0),D==="greedy"&&x){for(var m=[],N=0;N<H;N++){var P=C?h[N]:N;m.push(w[g][P])}T=m.join("").trim()===""}if(!T){for(var B=0;B<H;B++){0<B&&!_&&(M+=l);var s0=x&&C?h[B]:B;M+=I(w[g][s0],B)}g<w.length-1&&(!D||0<H&&!_)&&(M+=d)}}return M}function I(h,w){if(h==null)return"";if(h.constructor===Date)return JSON.stringify(h).slice(1,25);var D=!1;p&&typeof h=="string"&&p.test(h)&&(h="'"+h,D=!0);var M=h.toString().replace(o,E);return(D=D||r===!0||typeof r=="function"&&r(h,w)||Array.isArray(r)&&r[w]||function(x,C){for(var O=0;O<C.length;O++)if(-1<x.indexOf(C[O]))return!0;return!1}(M,s.BAD_DELIMITERS)||-1<M.indexOf(l)||M.charAt(0)===" "||M.charAt(M.length-1)===" ")?u+M+u:M}},s.RECORD_SEP="",s.UNIT_SEP="",s.BYTE_ORDER_MARK="\uFEFF",s.BAD_DELIMITERS=["\r",`
`,'"',s.BYTE_ORDER_MARK],s.WORKERS_SUPPORTED=!S&&!!b.Worker,s.NODE_STREAM_INPUT=1,s.LocalChunkSize=10485760,s.RemoteChunkSize=5242880,s.DefaultDelimiter=",",s.Parser=u0,s.ParserHandle=e0,s.NetworkStreamer=Q,s.FileStreamer=n0,s.StringStreamer=$,s.ReadableStreamStreamer=K,b.jQuery){var y=b.jQuery;y.fn.parse=function(n){var e=n.config||{},r=[];return this.each(function(d){if(!(y(this).prop("tagName").toUpperCase()==="INPUT"&&y(this).attr("type").toLowerCase()==="file"&&b.FileReader)||!this.files||this.files.length===0)return!0;for(var u=0;u<this.files.length;u++)r.push({file:this.files[u],inputElem:this,instanceConfig:y.extend({},e)})}),i(),this;function i(){if(r.length!==0){var d,u,E,k,t=r[0];if(A(n.before)){var p=n.before(t.file,t.inputElem);if(typeof p=="object"){if(p.action==="abort")return d="AbortError",u=t.file,E=t.inputElem,k=p.reason,void(A(n.error)&&n.error({name:d},u,E,k));if(p.action==="skip")return void l();typeof p.config=="object"&&(t.instanceConfig=y.extend(t.instanceConfig,p.config))}else if(p==="skip")return void l()}var o=t.instanceConfig.complete;t.instanceConfig.complete=function(Z){A(o)&&o(Z,t.file,t.inputElem),l()},s.parse(t.file,t.instanceConfig)}else A(n.complete)&&n.complete()}function l(){r.splice(0,1),i()}}}function v(n){this._handle=null,this._finished=!1,this._completed=!1,this._halted=!1,this._input=null,this._baseIndex=0,this._partialLine="",this._rowCount=0,this._start=0,this._nextChunk=null,this.isFirstChunk=!0,this._completeResults={data:[],errors:[],comments:[],meta:{}},(function(e){var r=a0(e);r.chunkSize=parseInt(r.chunkSize),e.step||e.chunk||(r.chunkSize=null),this._handle=new e0(r),(this._handle.streamer=this)._config=r}).call(this,n),this.parseChunk=function(e,r){if(this.isFirstChunk&&A(this._config.beforeFirstChunk)){var i=this._config.beforeFirstChunk(e);i!==void 0&&(e=i)}this.isFirstChunk=!1,this._halted=!1;var l=this._partialLine+e;this._partialLine="";var d=this._handle.parse(l,this._baseIndex,!this._finished);if(!this._handle.paused()&&!this._handle.aborted()){var u=d.meta.cursor;this._finished||(this._partialLine=l.substring(u-this._baseIndex),this._baseIndex=u),d&&d.data&&(this._rowCount+=d.data.length);var E=this._finished||this._config.preview&&this._rowCount>=this._config.preview;if(V)b.postMessage({results:d,workerId:s.WORKER_ID,finished:E});else if(A(this._config.chunk)&&!r){if(this._config.chunk(d,this._handle),f=[],this._handle.paused()||this._handle.aborted())return void(this._halted=!0);d=void 0,this._completeResults=void 0}return this._config.step||this._config.chunk||(this._completeResults.data=this._completeResults.data.concat(d.data),this._completeResults.errors=this._completeResults.errors.concat(d.errors),this._completeResults.comments=this._completeResults.comments.concat(d.comments),this._completeResults.meta=d.meta),this._completed||!E||!A(this._config.complete)||d&&d.meta.aborted||(this._config.complete(this._completeResults,this._input),this._completed=!0),E||d&&d.meta.paused||this._nextChunk(),d}this._halted=!0},this._sendError=function(e){A(this._config.error)?this._config.error(e):V&&this._config.error&&b.postMessage({workerId:s.WORKER_ID,error:e,finished:!1})}}function Q(n){var e;(n=n||{}).chunkSize||(n.chunkSize=s.RemoteChunkSize),v.call(this,n),this._nextChunk=S?function(){this._readChunk(),this._chunkLoaded()}:function(){this._readChunk()},this.stream=function(r){this._input=r,this._nextChunk()},this._readChunk=function(){if(this._finished)this._chunkLoaded();else{if(e=new XMLHttpRequest,this._config.withCredentials&&(e.withCredentials=this._config.withCredentials),S||(e.onload=J(this._chunkLoaded,this),e.onerror=J(this._chunkError,this)),e.open(this._config.downloadRequestBody?"POST":"GET",this._input,!S),this._config.downloadRequestHeaders){var r=this._config.downloadRequestHeaders;for(var i in r)e.setRequestHeader(i,r[i])}if(this._config.chunkSize){var l=this._start+this._config.chunkSize-1;e.setRequestHeader("Range","bytes="+this._start+"-"+l)}try{e.send(this._config.downloadRequestBody)}catch(d){this._chunkError(d.message)}S&&e.status===0&&this._chunkError()}},this._chunkLoaded=function(){var r;e.readyState===4&&(e.status<200||400<=e.status?this._chunkError():(this._start+=this._config.chunkSize?this._config.chunkSize:e.responseText.length,this._finished=!this._config.chunkSize||this._start>=((r=e.getResponseHeader("Content-Range"))!==null?parseInt(r.substring(r.lastIndexOf("/")+1)):-1),this.parseChunk(e.responseText)))},this._chunkError=function(r){var i=e.statusText||r;this._sendError(new Error(i))}}function n0(n){var e,r;(n=n||{}).chunkSize||(n.chunkSize=s.LocalChunkSize),v.call(this,n);var i=typeof FileReader<"u";this.stream=function(l){this._input=l,r=l.slice||l.webkitSlice||l.mozSlice,i?((e=new FileReader).onload=J(this._chunkLoaded,this),e.onerror=J(this._chunkError,this)):e=new FileReaderSync,this._nextChunk()},this._nextChunk=function(){this._finished||this._config.preview&&!(this._rowCount<this._config.preview)||this._readChunk()},this._readChunk=function(){var l=this._input;if(this._config.chunkSize){var d=Math.min(this._start+this._config.chunkSize,this._input.size);l=r.call(l,this._start,d)}var u=e.readAsText(l,this._config.encoding);i||this._chunkLoaded({target:{result:u}})},this._chunkLoaded=function(l){this._start+=this._config.chunkSize,this._finished=!this._config.chunkSize||this._start>=this._input.size,this.parseChunk(l.target.result)},this._chunkError=function(){this._sendError(e.error)}}function $(n){var e;v.call(this,n=n||{}),this.stream=function(r){return e=r,this._nextChunk()},this._nextChunk=function(){if(!this._finished){var r,i=this._config.chunkSize;return e=i?(r=e.substring(0,i),e.substring(i)):(r=e,""),this._finished=!e,this.parseChunk(r)}}}function K(n){v.call(this,n=n||{});var e=[],r=!0,i=!1;this.pause=function(){v.prototype.pause.apply(this,arguments),this._input.pause()},this.resume=function(){v.prototype.resume.apply(this,arguments),this._input.resume()},this.stream=function(l){this._input=l,this._input.on("data",this._streamData),this._input.on("end",this._streamEnd),this._input.on("error",this._streamError)},this._checkIsFinished=function(){i&&e.length===1&&(this._finished=!0)},this._nextChunk=function(){this._checkIsFinished(),e.length?this.parseChunk(e.shift()):r=!0},this._streamData=J(function(l){try{e.push(typeof l=="string"?l:l.toString(this._config.encoding)),r&&(r=!1,this._checkIsFinished(),this.parseChunk(e.shift()))}catch(d){this._streamError(d)}},this),this._streamError=J(function(l){this._streamCleanUp(),this._sendError(l)},this),this._streamEnd=J(function(){this._streamCleanUp(),i=!0,this._streamData("")},this),this._streamCleanUp=J(function(){this._input.removeListener("data",this._streamData),this._input.removeListener("end",this._streamEnd),this._input.removeListener("error",this._streamError)},this)}function e0(n){var e,r,i,l=Math.pow(2,53),d=-l,u=/^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/,E=/^(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))$/,k=this,t=0,p=0,o=!1,Z=!1,I=[],h={data:[],errors:[],comments:[],meta:{}};if(A(n.step)){var w=n.step;n.step=function(g){if(h=g,x())M();else{if(M(),h.data.length===0)return;t+=g.data.length,n.preview&&t>n.preview?r.abort():(h.data=h.data[0],w(h,k))}}}function D(g){return n.skipEmptyLines==="greedy"?g.join("").trim()==="":g.length===1&&g[0].length===0}function M(){return h&&i&&(O("Delimiter","UndetectableDelimiter","Unable to auto-detect delimiting character; defaulted to '"+s.DefaultDelimiter+"'"),i=!1),n.skipEmptyLines&&(h.data=h.data.filter(function(g){return!D(g)})),x()&&function(){if(!h)return;function g(T,_){A(n.transformHeader)&&(T=n.transformHeader(T,_)),I.push(T)}if(Array.isArray(h.data[0])){for(var H=0;x()&&H<h.data.length;H++)h.data[H].forEach(g);h.data.splice(0,1)}else h.data.forEach(g)}(),function(){if(!h||!n.header&&!n.dynamicTyping&&!n.transform)return h;function g(T,_){var m,N=n.header?{}:[];for(m=0;m<T.length;m++){var P=m,B=T[m];n.header&&(P=m>=I.length?"__parsed_extra":I[m]),n.transform&&(B=n.transform(B,P)),B=C(P,B),P==="__parsed_extra"?(N[P]=N[P]||[],N[P].push(B)):N[P]=B}return n.header&&(m>I.length?O("FieldMismatch","TooManyFields","Too many fields: expected "+I.length+" fields but parsed "+m,p+_):m<I.length&&O("FieldMismatch","TooFewFields","Too few fields: expected "+I.length+" fields but parsed "+m,p+_)),N}var H=1;return!h.data.length||Array.isArray(h.data[0])?(h.data=h.data.map(g),H=h.data.length):h.data=g(h.data,0),n.header&&h.meta&&(h.meta.fields=I),p+=H,h}()}function x(){return n.header&&I.length===0}function C(g,H){return T=g,n.dynamicTypingFunction&&n.dynamicTyping[T]===void 0&&(n.dynamicTyping[T]=n.dynamicTypingFunction(T)),(n.dynamicTyping[T]||n.dynamicTyping)===!0?H==="true"||H==="TRUE"||H!=="false"&&H!=="FALSE"&&(H.startsWith('"')?H.slice(1):function(_){if(u.test(_)){var m=parseFloat(_);if(d<m&&m<l)return!0}return!1}(H)?parseFloat(H):E.test(H)?new Date(H):H===""?null:H):H;var T}function O(g,H,T,_){var m={type:g,code:H,message:T};_!==void 0&&(m.row=_),h.errors.push(m)}this.parse=function(g,H,T){var _=n.quoteChar||'"';if(n.newline||(n.newline=function(P,B){P=P.substring(0,1048576);var s0=new RegExp(d0(B)+"([^]*?)"+d0(B),"gm"),G=(P=P.replace(s0,"")).split("\r"),U=P.split(`
`),i0=1<U.length&&U[0].length<G[0].length;if(G.length===1||i0)return`
`;for(var Y=0,q=0;q<G.length;q++)G[q][0]===`
`&&Y++;return Y>=G.length/2?`\r
`:"\r"}(g,_)),i=!1,n.delimiter)A(n.delimiter)&&(n.delimiter=n.delimiter(g),h.meta.delimiter=n.delimiter);else{var m=function(P,B,s0,G,U){var i0,Y,q,j;U=U||[",","	","|",";",s.RECORD_SEP,s.UNIT_SEP];for(var l0=0;l0<U.length;l0++){var F=U[l0],t0=0,r0=0,D0=0;q=void 0;for(var m0=new u0({comments:G,delimiter:F,newline:B,preview:10}).parse(P),p0=0;p0<m0.data.length;p0++)if(s0&&D(m0.data[p0]))D0++;else{var b0=m0.data[p0].length;r0+=b0,q!==void 0?0<b0&&(t0+=Math.abs(b0-q),q=b0):q=b0}0<m0.data.length&&(r0/=m0.data.length-D0),(Y===void 0||t0<=Y)&&(j===void 0||j<r0)&&1.99<r0&&(Y=t0,i0=F,j=r0)}return{successful:!!(n.delimiter=i0),bestDelimiter:i0}}(g,n.newline,n.skipEmptyLines,n.comments,n.delimitersToGuess);m.successful?n.delimiter=m.bestDelimiter:(i=!0,n.delimiter=s.DefaultDelimiter),h.meta.delimiter=n.delimiter}var N=a0(n);return n.preview&&n.header&&N.preview++,e=g,r=new u0(N),h=r.parse(e,H,T),M(),o?{meta:{paused:!0}}:h||{meta:{paused:!1}}},this.paused=function(){return o},this.pause=function(){o=!0,r.abort(),e=A(n.chunk)?"":e.substring(r.getCharIndex())},this.resume=function(){k.streamer._halted?(o=!1,k.streamer.parseChunk(e,!0)):setTimeout(k.resume,3)},this.aborted=function(){return Z},this.abort=function(){Z=!0,r.abort(),h.meta.aborted=!0,A(n.complete)&&n.complete(h),e=""}}function d0(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function u0(n){var e,r=(n=n||{}).delimiter,i=n.newline,l=n.comments,d=n.step,u=n.preview,E=n.fastMode,k=e=n.quoteChar===void 0||n.quoteChar===null?'"':n.quoteChar;if(n.escapeChar!==void 0&&(k=n.escapeChar),(typeof r!="string"||-1<s.BAD_DELIMITERS.indexOf(r))&&(r=","),l===r)throw new Error("Comment character same as delimiter");l===!0?l="#":(typeof l!="string"||-1<s.BAD_DELIMITERS.indexOf(l))&&(l=!1),i!==`
`&&i!=="\r"&&i!==`\r
`&&(i=`
`);var t=0,p=!1;this.parse=function(o,Z,I){if(typeof o!="string")throw new Error("Input must be a string");var h=o.length,w=r.length,D=i.length,M=l.length,x=A(d),C=[],O=[],g=[],H=t=0;if(!o)return j();if(E||E!==!1&&o.indexOf(e)===-1){for(var T=o.split(i),_=0;_<T.length;_++){if(g=T[_],t+=g.length,_!==T.length-1)t+=i.length;else if(I)return j();if(l&&g.substring(0,M)===l)f.push(g);else{if(x){if(C=[],U(g.split(r)),l0(),p)return j()}else U(g.split(r));if(u&&u<=_)return C=C.slice(0,u),j(!0)}}return j()}for(var m=o.indexOf(r,t),N=o.indexOf(i,t),P=new RegExp(d0(k)+d0(e),"g"),B=o.indexOf(e,t);;)if(o[t]!==e)if(l&&g.length===0&&o.substring(t,t+M)===l){if(N===-1)return j();t=N+D,N=o.indexOf(i,t),m=o.indexOf(r,t)}else if(m!==-1&&(m<N||N===-1))g.push(o.substring(t,m)),t=m+w,m=o.indexOf(r,t);else{if(N===-1)break;if(g.push(o.substring(t,N)),q(N+D),x&&(l0(),p))return j();if(u&&C.length>=u)return j(!0)}else for(B=t,t++;;){if((B=o.indexOf(e,B+1))===-1)return I||O.push({type:"Quotes",code:"MissingQuotes",message:"Quoted field unterminated",row:C.length,index:t}),Y();if(B===h-1)return Y(o.substring(t,B).replace(P,e));if(e!==k||o[B+1]!==k){if(e===k||B===0||o[B-1]!==k){m!==-1&&m<B+1&&(m=o.indexOf(r,B+1)),N!==-1&&N<B+1&&(N=o.indexOf(i,B+1));var s0=i0(N===-1?m:Math.min(m,N));if(o.substr(B+1+s0,w)===r){g.push(o.substring(t-1,B).replace(P,e)),o[t=B+1+s0+w]!==e&&(B=o.indexOf(e,t)),m=o.indexOf(r,t),N=o.indexOf(i,t);break}var G=i0(N);if(o.substring(B+1+G,B+1+G+D)===i){if(g.push(o.substring(t-1,B).replace(P,e)),q(B+1+G+D),m=o.indexOf(r,t),B=o.indexOf(e,t),x&&(l0(),p))return j();if(u&&C.length>=u)return j(!0);break}O.push({type:"Quotes",code:"InvalidQuotes",message:"Trailing quote on quoted field is malformed",row:C.length,index:t}),B++}}else B++}return Y();function U(F){C.push(F),H=t}function i0(F){var t0=0;if(F!==-1){var r0=o.substring(B+1,F);r0&&r0.trim()===""&&(t0=r0.length)}return t0}function Y(F){return I||(F===void 0&&(F=o.substring(t)),g.push(F),t=h,U(g),x&&l0()),j()}function q(F){t=F,U(g),g=[],N=o.indexOf(i,t)}function j(F){var t0=JSON.parse(JSON.stringify(f));return{data:C,errors:O,comments:t0,meta:{delimiter:r,linebreak:i,aborted:p,truncated:!!F,cursor:H+(Z||0)}}}function l0(){d(j()),C=[],O=[]}},this.abort=function(){p=!0},this.getCharIndex=function(){return t}}function B0(n){var e=n.data,r=R[e.workerId],i=!1;if(e.error)r.userError(e.error,e.file);else if(e.results&&e.results.data){var l={abort:function(){i=!0,o0(e.workerId,{data:[],comments:[],errors:[],meta:{aborted:!0}})},pause:N0,resume:N0};if(A(r.userStep)){for(var d=0;d<e.results.data.length&&(r.userStep({data:e.results.data[d],errors:e.results.errors,comments:e.results.comments,meta:e.results.meta},l),!i);d++);delete e.results}else A(r.userChunk)&&(r.userChunk(e.results,l,e.file),delete e.results)}e.finished&&!i&&o0(e.workerId,e.results)}function o0(n,e){var r=R[n];A(r.userComplete)&&r.userComplete(e),r.terminate(),delete R[n]}function N0(){throw new Error("Not implemented.")}function a0(n){if(typeof n!="object"||n===null)return n;var e=Array.isArray(n)?[]:{};for(var r in n)e[r]=a0(n[r]);return e}function J(n,e){return function(){n.apply(e,arguments)}}function A(n){return typeof n=="function"}return V&&(b.onmessage=function(n){var e=n.data;if(s.WORKER_ID===void 0&&e&&(s.WORKER_ID=e.workerId),typeof e.input=="string")b.postMessage({workerId:s.WORKER_ID,results:s.parse(e.input,e.config),finished:!0});else if(b.File&&e.input instanceof File||e.input instanceof Object){var r=s.parse(e.input,e.config);r&&b.postMessage({workerId:s.WORKER_ID,results:r,finished:!0})}}),(Q.prototype=Object.create(v.prototype)).constructor=Q,(n0.prototype=Object.create(v.prototype)).constructor=n0,($.prototype=Object.create($.prototype)).constructor=$,(K.prototype=Object.create(v.prototype)).constructor=K,s})})(E0);var n1=E0.exports,f0=z0(n1),e1=`Datum,Bundesland,Bundesland_Id,Altersgruppe,fixierte_7T_Hospitalisierung_Faelle,aktualisierte_7T_Hospitalisierung_Faelle,PS_adjustierte_7T_Hospitalisierung_Faelle,UG_PI_adjustierte_7T_Hospitalisierung_Faelle,OG_PI_adjustierte_7T_Hospitalisierung_Faelle,Bevoelkerung,fixierte_7T_Hospitalisierung_Inzidenz,aktualisierte_7T_Hospitalisierung_Inzidenz,PS_adjustierte_7T_Hospitalisierung_Inzidenz,UG_PI_adjustierte_7T_Hospitalisierung_Inzidenz,OG_PI_adjustierte_7T_Hospitalisierung_Inzidenz
2023-12-20,Bundesgebiet,00,00+,7379,7379,NA,NA,NA,83155031,8.87,8.87,NA,NA,NA
2023-12-19,Bundesgebiet,00,00+,7049,8503,NA,NA,NA,83155031,8.48,10.23,NA,NA,NA
2023-12-18,Bundesgebiet,00,00+,7998,9476,NA,NA,NA,83155031,9.62,11.4,NA,NA,NA
2023-12-17,Bundesgebiet,00,00+,8152,9530,11011,10793,11341,83155031,9.8,11.46,13.24,12.98,13.64
2023-12-16,Bundesgebiet,00,00+,8301,9562,10932,10749,11160,83155031,9.98,11.5,13.15,12.93,13.42
2023-12-15,Bundesgebiet,00,00+,7790,9765,10892,10721,11127,83155031,9.37,11.74,13.1,12.89,13.38
2023-12-14,Bundesgebiet,00,00+,7730,9824,10768,10611,10984,83155031,9.3,11.81,12.95,12.76,13.21
2023-12-13,Bundesgebiet,00,00+,7313,9786,10563,10414,10761,83155031,8.79,11.77,12.7,12.52,12.94
2023-12-12,Bundesgebiet,00,00+,6703,9785,10425,10293,10612,83155031,8.06,11.77,12.54,12.38,12.76
2023-12-11,Bundesgebiet,00,00+,6553,8908,9335,9234,9487,83155031,7.88,10.71,11.23,11.11,11.41
2023-12-10,Bundesgebiet,00,00+,6646,8860,9277,9178,9427,83155031,7.99,10.65,11.16,11.04,11.34
2023-12-09,Bundesgebiet,00,00+,6756,8827,9236,9139,9385,83155031,8.12,10.62,11.11,10.99,11.29
2023-12-08,Bundesgebiet,00,00+,6266,8566,8920,8830,9057,83155031,7.54,10.3,10.73,10.62,10.89
2023-12-07,Bundesgebiet,00,00+,5916,8234,8531,8450,8656,83155031,7.11,9.9,10.26,10.16,10.41
2023-12-06,Bundesgebiet,00,00+,5397,7993,8243,8169,8359,83155031,6.49,9.61,9.91,9.82,10.05
2023-12-05,Bundesgebiet,00,00+,5145,7746,7952,7887,8058,83155031,6.19,9.32,9.56,9.48,9.69
2023-12-04,Bundesgebiet,00,00+,5940,7915,8081,8022,8180,83155031,7.14,9.52,9.72,9.65,9.84
2023-12-03,Bundesgebiet,00,00+,6062,7939,8103,8045,8203,83155031,7.29,9.55,9.75,9.68,9.86
2023-12-02,Bundesgebiet,00,00+,6173,7954,8117,8058,8216,83155031,7.42,9.57,9.76,9.69,9.88
2023-12-01,Bundesgebiet,00,00+,5859,7940,8088,8033,8184,83155031,7.05,9.55,9.73,9.66,9.84
2023-11-30,Bundesgebiet,00,00+,5595,7884,8016,7966,8104,83155031,6.73,9.48,9.64,9.58,9.75
2023-11-29,Bundesgebiet,00,00+,5310,7820,7936,7892,8015,83155031,6.39,9.4,9.54,9.49,9.64
2023-11-28,Bundesgebiet,00,00+,5312,7941,8042,8003,8113,83155031,6.39,9.55,9.67,9.62,9.76
2023-11-27,Bundesgebiet,00,00+,5849,8064,8146,8114,8204,83155031,7.03,9.7,9.8,9.76,9.87
2023-11-26,Bundesgebiet,00,00+,5939,8044,8125,8093,8182,83155031,7.14,9.67,9.77,9.73,9.84
2023-11-25,Bundesgebiet,00,00+,6041,8029,8109,8077,8165,83155031,7.26,9.66,9.75,9.71,9.82
2023-11-24,Bundesgebiet,00,00+,5732,7959,8030,8003,8077,83155031,6.89,9.57,9.66,9.62,9.71
2023-11-23,Bundesgebiet,00,00+,5735,8072,8135,8111,8175,83155031,6.9,9.71,9.78,9.75,9.83
2023-11-22,Bundesgebiet,00,00+,5505,8009,8063,8043,8096,83155031,6.62,9.63,9.7,9.67,9.74
2023-11-21,Bundesgebiet,00,00+,5128,7652,7694,7679,7717,83155031,6.17,9.2,9.25,9.23,9.28
2023-11-20,Bundesgebiet,00,00+,5433,7307,7332,7324,7342,83155031,6.53,8.79,8.82,8.81,8.83
2023-11-19,Bundesgebiet,00,00+,5531,7312,7336,7329,7345,83155031,6.65,8.79,8.82,8.81,8.83
2023-11-18,Bundesgebiet,00,00+,5667,7339,7362,7355,7371,83155031,6.81,8.83,8.85,8.85,8.86
2023-11-17,Bundesgebiet,00,00+,5189,7260,7278,7273,7285,83155031,6.24,8.73,8.75,8.75,8.76
2023-11-16,Bundesgebiet,00,00+,5146,7251,7264,7260,7269,83155031,6.19,8.72,8.74,8.73,8.74
2023-11-15,Bundesgebiet,00,00+,5206,7495,7503,7501,7507,83155031,6.26,9.01,9.02,9.02,9.03
2023-11-14,Bundesgebiet,00,00+,4600,7184,7189,7187,7191,83155031,5.53,8.64,8.65,8.64,8.65
2023-11-13,Bundesgebiet,00,00+,5425,7379,7379,7379,7380,83155031,6.52,8.87,8.87,8.87,8.88
2023-11-12,Bundesgebiet,00,00+,5530,7375,7375,7375,7375,83155031,6.65,8.87,8.87,8.87,8.87
2023-11-11,Bundesgebiet,00,00+,5636,7346,7346,7346,7346,83155031,6.78,8.83,8.83,8.83,8.83
2023-11-10,Bundesgebiet,00,00+,5392,7446,7446,7446,7446,83155031,6.48,8.95,8.95,8.95,8.95
2023-11-09,Bundesgebiet,00,00+,5457,7750,7750,7750,7750,83155031,6.56,9.32,9.32,9.32,9.32
2023-11-08,Bundesgebiet,00,00+,5357,7445,7445,7445,7445,83155031,6.44,8.95,8.95,8.95,8.95
2023-11-07,Bundesgebiet,00,00+,4787,7402,7402,7402,7402,83155031,5.76,8.9,8.9,8.9,8.9
2023-11-06,Bundesgebiet,00,00+,4985,7077,7077,7077,7077,83155031,5.99,8.51,8.51,8.51,8.51
2023-11-05,Bundesgebiet,00,00+,5093,7086,7086,7086,7086,83155031,6.12,8.52,8.52,8.52,8.52
2023-11-04,Bundesgebiet,00,00+,5173,7067,7067,7067,7067,83155031,6.22,8.5,8.5,8.5,8.5
2023-11-03,Bundesgebiet,00,00+,4642,6956,6956,6956,6956,83155031,5.58,8.37,8.37,8.37,8.37
2023-11-02,Bundesgebiet,00,00+,4097,6482,6482,6482,6482,83155031,4.93,7.8,7.8,7.8,7.8
2023-11-01,Bundesgebiet,00,00+,4201,6446,6446,6446,6446,83155031,5.05,7.75,7.75,7.75,7.75
2023-10-31,Bundesgebiet,00,00+,4378,6678,6678,6678,6678,83155031,5.26,8.03,8.03,8.03,8.03
2023-10-30,Bundesgebiet,00,00+,4683,6535,6535,6535,6535,83155031,5.63,7.86,7.86,7.86,7.86
2023-10-29,Bundesgebiet,00,00+,4798,6538,6538,6538,6538,83155031,5.77,7.86,7.86,7.86,7.86
2023-10-28,Bundesgebiet,00,00+,4885,6531,6531,6531,6531,83155031,5.87,7.85,7.85,7.85,7.85
2023-10-27,Bundesgebiet,00,00+,4437,6290,6290,6290,6290,83155031,5.34,7.56,7.56,7.56,7.56
2023-10-26,Bundesgebiet,00,00+,4141,5918,5918,5918,5918,83155031,4.98,7.12,7.12,7.12,7.12
2023-10-25,Bundesgebiet,00,00+,3741,5494,5494,5494,5494,83155031,4.5,6.61,6.61,6.61,6.61
2023-10-24,Bundesgebiet,00,00+,3100,5022,5022,5022,5022,83155031,3.73,6.04,6.04,6.04,6.04
2023-10-23,Bundesgebiet,00,00+,3085,4382,4382,4382,4382,83155031,3.71,5.27,5.27,5.27,5.27
2023-10-22,Bundesgebiet,00,00+,3145,4328,4328,4328,4328,83155031,3.78,5.2,5.2,5.2,5.2
2023-10-21,Bundesgebiet,00,00+,3214,4314,4314,4314,4314,83155031,3.87,5.19,5.19,5.19,5.19
2023-10-20,Bundesgebiet,00,00+,3106,4232,4232,4232,4232,83155031,3.74,5.09,5.09,5.09,5.09
2023-10-19,Bundesgebiet,00,00+,2997,4124,4124,4124,4124,83155031,3.6,4.96,4.96,4.96,4.96
2023-10-18,Bundesgebiet,00,00+,2735,4058,4058,4058,4058,83155031,3.29,4.88,4.88,4.88,4.88
2023-10-17,Bundesgebiet,00,00+,2585,4022,4022,4022,4022,83155031,3.11,4.84,4.84,4.84,4.84
2023-10-16,Bundesgebiet,00,00+,2718,3824,3824,3824,3824,83155031,3.27,4.6,4.6,4.6,4.6
2023-10-15,Bundesgebiet,00,00+,2777,3822,3822,3822,3822,83155031,3.34,4.6,4.6,4.6,4.6
2023-10-14,Bundesgebiet,00,00+,2833,3806,3806,3806,3806,83155031,3.41,4.58,4.58,4.58,4.58
2023-10-13,Bundesgebiet,00,00+,2598,3719,3719,3719,3719,83155031,3.12,4.47,4.47,4.47,4.47
2023-10-12,Bundesgebiet,00,00+,2609,3715,3715,3715,3715,83155031,3.14,4.47,4.47,4.47,4.47
2023-10-11,Bundesgebiet,00,00+,2828,4018,4018,4018,4018,83155031,3.4,4.83,4.83,4.83,4.83
2023-10-10,Bundesgebiet,00,00+,2157,3366,3366,3366,3366,83155031,2.59,4.05,4.05,4.05,4.05
2023-10-09,Bundesgebiet,00,00+,2094,3129,3129,3129,3129,83155031,2.52,3.76,3.76,3.76,3.76
2023-10-08,Bundesgebiet,00,00+,2130,3102,3102,3102,3102,83155031,2.56,3.73,3.73,3.73,3.73
2023-10-07,Bundesgebiet,00,00+,2173,3090,3090,3090,3090,83155031,2.61,3.72,3.72,3.72,3.72
2023-10-06,Bundesgebiet,00,00+,1985,2950,2950,2950,2950,83155031,2.39,3.55,3.55,3.55,3.55
2023-10-05,Bundesgebiet,00,00+,1643,2767,2767,2767,2767,83155031,1.98,3.33,3.33,3.33,3.33
2023-10-04,Bundesgebiet,00,00+,1173,2220,2220,2220,2220,83155031,1.41,2.67,2.67,2.67,2.67
2023-10-03,Bundesgebiet,00,00+,1586,2630,2630,2630,2630,83155031,1.91,3.16,3.16,3.16,3.16
2023-10-02,Bundesgebiet,00,00+,1691,2450,2450,2450,2450,83155031,2.03,2.95,2.95,2.95,2.95
2023-10-01,Bundesgebiet,00,00+,1721,2438,2438,2438,2438,83155031,2.07,2.93,2.93,2.93,2.93
2023-09-30,Bundesgebiet,00,00+,1755,2422,2422,2422,2422,83155031,2.11,2.91,2.91,2.91,2.91
2023-09-29,Bundesgebiet,00,00+,1652,2341,2341,2341,2341,83155031,1.99,2.82,2.82,2.82,2.82
2023-09-28,Bundesgebiet,00,00+,1647,2288,2288,2288,2288,83155031,1.98,2.75,2.75,2.75,2.75
2023-09-27,Bundesgebiet,00,00+,1557,2240,2240,2240,2240,83155031,1.87,2.69,2.69,2.69,2.69
2023-09-26,Bundesgebiet,00,00+,1424,2216,2216,2216,2216,83155031,1.71,2.66,2.66,2.66,2.66
2023-09-25,Bundesgebiet,00,00+,1610,2208,2208,2208,2208,83155031,1.94,2.66,2.66,2.66,2.66
2023-09-24,Bundesgebiet,00,00+,1641,2213,2213,2213,2213,83155031,1.97,2.66,2.66,2.66,2.66
2023-09-23,Bundesgebiet,00,00+,1692,2230,2230,2230,2230,83155031,2.03,2.68,2.68,2.68,2.68
2023-09-22,Bundesgebiet,00,00+,1631,2215,2215,2215,2215,83155031,1.96,2.66,2.66,2.66,2.66
2023-09-21,Bundesgebiet,00,00+,1574,2160,2160,2160,2160,83155031,1.89,2.6,2.6,2.6,2.6
2023-09-20,Bundesgebiet,00,00+,1495,2172,2172,2172,2172,83155031,1.8,2.61,2.61,2.61,2.61
2023-09-19,Bundesgebiet,00,00+,1387,2181,2181,2181,2181,83155031,1.67,2.62,2.62,2.62,2.62
2023-09-18,Bundesgebiet,00,00+,1596,2221,2221,2221,2221,83155031,1.92,2.67,2.67,2.67,2.67
2023-09-17,Bundesgebiet,00,00+,1627,2218,2218,2218,2218,83155031,1.96,2.67,2.67,2.67,2.67
2023-09-16,Bundesgebiet,00,00+,1656,2199,2199,2199,2199,83155031,1.99,2.64,2.64,2.64,2.64
2023-09-15,Bundesgebiet,00,00+,1688,2283,2283,2283,2283,83155031,2.03,2.75,2.75,2.75,2.75
2023-09-14,Bundesgebiet,00,00+,1736,2350,2350,2350,2350,83155031,2.09,2.83,2.83,2.83,2.83
2023-09-13,Bundesgebiet,00,00+,1642,2377,2377,2377,2377,83155031,1.97,2.86,2.86,2.86,2.86
2023-09-12,Bundesgebiet,00,00+,1501,2311,2311,2311,2311,83155031,1.81,2.78,2.78,2.78,2.78
2023-09-11,Bundesgebiet,00,00+,1507,2089,2089,2089,2089,83155031,1.81,2.51,2.51,2.51,2.51
2023-09-10,Bundesgebiet,00,00+,1538,2086,2086,2086,2086,83155031,1.85,2.51,2.51,2.51,2.51
2023-09-09,Bundesgebiet,00,00+,1561,2077,2077,2077,2077,83155031,1.88,2.5,2.5,2.5,2.5
2023-09-08,Bundesgebiet,00,00+,1374,1937,1937,1937,1937,83155031,1.65,2.33,2.33,2.33,2.33
2023-09-07,Bundesgebiet,00,00+,1244,1789,1789,1789,1789,83155031,1.5,2.15,2.15,2.15,2.15
2023-09-06,Bundesgebiet,00,00+,1149,1691,1691,1691,1691,83155031,1.38,2.03,2.03,2.03,2.03
2023-09-05,Bundesgebiet,00,00+,985,1565,1565,1565,1565,83155031,1.18,1.88,1.88,1.88,1.88
2023-09-04,Bundesgebiet,00,00+,1112,1546,1546,1546,1546,83155031,1.34,1.86,1.86,1.86,1.86
2023-09-03,Bundesgebiet,00,00+,1129,1533,1533,1533,1533,83155031,1.36,1.84,1.84,1.84,1.84
2023-09-02,Bundesgebiet,00,00+,1151,1536,1536,1536,1536,83155031,1.38,1.85,1.85,1.85,1.85
2023-09-01,Bundesgebiet,00,00+,1130,1545,1545,1545,1545,83155031,1.36,1.86,1.86,1.86,1.86
2023-08-31,Bundesgebiet,00,00+,1102,1551,1551,1551,1551,83155031,1.33,1.87,1.87,1.87,1.87
2023-08-30,Bundesgebiet,00,00+,1058,1529,1529,1529,1529,83155031,1.27,1.84,1.84,1.84,1.84
2023-08-29,Bundesgebiet,00,00+,1085,1591,1591,1591,1591,83155031,1.3,1.91,1.91,1.91,1.91
2023-08-28,Bundesgebiet,00,00+,0,1580,1580,1580,1580,83155031,0,1.9,1.9,1.9,1.9
2023-08-27,Bundesgebiet,00,00+,0,1587,1587,1587,1587,83155031,0,1.91,1.91,1.91,1.91
2023-08-26,Bundesgebiet,00,00+,0,1593,1593,1593,1593,83155031,0,1.92,1.92,1.92,1.92
2023-08-25,Bundesgebiet,00,00+,0,1546,1546,1546,1546,83155031,0,1.86,1.86,1.86,1.86
2023-08-24,Bundesgebiet,00,00+,1096,1525,1525,1525,1525,83155031,1.32,1.83,1.83,1.83,1.83
2023-08-23,Bundesgebiet,00,00+,1071,1522,1522,1522,1522,83155031,1.29,1.83,1.83,1.83,1.83
2023-08-22,Bundesgebiet,00,00+,865,1389,1389,1389,1389,83155031,1.04,1.67,1.67,1.67,1.67
2023-08-21,Bundesgebiet,00,00+,848,1285,1285,1285,1285,83155031,1.02,1.55,1.55,1.55,1.55
2023-08-20,Bundesgebiet,00,00+,868,1282,1282,1282,1282,83155031,1.04,1.54,1.54,1.54,1.54
2023-08-19,Bundesgebiet,00,00+,882,1262,1262,1262,1262,83155031,1.06,1.52,1.52,1.52,1.52
2023-08-18,Bundesgebiet,00,00+,809,1198,1198,1198,1198,83155031,0.97,1.44,1.44,1.44,1.44
2023-08-17,Bundesgebiet,00,00+,737,1104,1104,1104,1104,83155031,0.89,1.33,1.33,1.33,1.33
2023-08-16,Bundesgebiet,00,00+,661,988,988,988,988,83155031,0.79,1.19,1.19,1.19,1.19
2023-08-15,Bundesgebiet,00,00+,558,935,935,935,935,83155031,0.67,1.12,1.12,1.12,1.12
2023-08-14,Bundesgebiet,00,00+,544,764,764,764,764,83155031,0.65,0.92,0.92,0.92,0.92
2023-08-13,Bundesgebiet,00,00+,556,754,754,754,754,83155031,0.67,0.91,0.91,0.91,0.91
2023-08-12,Bundesgebiet,00,00+,567,751,751,751,751,83155031,0.68,0.9,0.9,0.9,0.9
2023-08-11,Bundesgebiet,00,00+,501,711,711,711,711,83155031,0.6,0.86,0.86,0.86,0.86
2023-08-10,Bundesgebiet,00,00+,458,650,650,650,650,83155031,0.55,0.78,0.78,0.78,0.78
2023-08-09,Bundesgebiet,00,00+,419,619,619,619,619,83155031,0.5,0.74,0.74,0.74,0.74
2023-08-08,Bundesgebiet,00,00+,383,593,593,593,593,83155031,0.46,0.71,0.71,0.71,0.71
2023-08-07,Bundesgebiet,00,00+,413,575,575,575,575,83155031,0.5,0.69,0.69,0.69,0.69
2023-08-06,Bundesgebiet,00,00+,421,570,570,570,570,83155031,0.51,0.69,0.69,0.69,0.69
2023-08-05,Bundesgebiet,00,00+,439,579,579,579,579,83155031,0.53,0.7,0.7,0.7,0.7
2023-08-04,Bundesgebiet,00,00+,389,557,557,557,557,83155031,0.47,0.67,0.67,0.67,0.67
2023-08-03,Bundesgebiet,00,00+,377,565,565,565,565,83155031,0.45,0.68,0.68,0.68,0.68
2023-08-02,Bundesgebiet,00,00+,350,551,551,551,551,83155031,0.42,0.66,0.66,0.66,0.66
2023-08-01,Bundesgebiet,00,00+,329,516,516,516,516,83155031,0.4,0.62,0.62,0.62,0.62
2023-07-31,Bundesgebiet,00,00+,346,482,482,482,482,83155031,0.42,0.58,0.58,0.58,0.58
2023-07-30,Bundesgebiet,00,00+,353,481,481,481,481,83155031,0.42,0.58,0.58,0.58,0.58
2023-07-29,Bundesgebiet,00,00+,362,471,471,471,471,83155031,0.44,0.57,0.57,0.57,0.57
2023-07-28,Bundesgebiet,00,00+,339,462,462,462,462,83155031,0.41,0.56,0.56,0.56,0.56
...
2023-06-29,Bundesgebiet,00,00+,246,336,336,336,336,83155031,0.3,0.4,0.4,0.4,0.4
2023-06-28,Bundesgebiet,00,00+,243,349,349,349,349,83155031,0.29,0.42,0.42,0.42,0.42
2023-06-27,Bundesgebiet,00,00+,269,360,360,360,360,83155031,0.32,0.43,0.43,0.43,0.43
2023-06-26,Bundesgebiet,00,00+,331,429,429,429,429,83155031,0.4,0.52,0.52,0.52,0.52
2023-06-25,Bundesgebiet,00,00+,337,428,428,428,428,83155031,0.41,0.51,0.51,0.51,0.51
2023-06-24,Bundesgebiet,00,00+,342,429,429,429,429,83155031,0.41,0.52,0.52,0.52,0.52
2023-06-23,Bundesgebiet,00,00+,353,462,462,462,462,83155031,0.42,0.56,0.56,0.56,0.56
...
2023-06-19,Bundesgebiet,00,00+,487,657,657,657,657,83155031,0.59,0.79,0.79,0.79,0.79
2023-06-18,Bundesgebiet,00,00+,505,677,677,677,677,83155031,0.61,0.81,0.81,0.81,0.81
2023-06-17,Bundesgebiet,00,00+,519,686,686,686,686,83155031,0.62,0.82,0.82,0.82,0.82
2023-06-16,Bundesgebiet,00,00+,521,726,726,726,726,83155031,0.63,0.87,0.87,0.87,0.87
2023-06-15,Bundesgebiet,00,00+,469,680,680,680,680,83155031,0.56,0.82,0.82,0.82,0.82
2023-06-14,Bundesgebiet,00,00+,489,712,712,712,712,83155031,0.59,0.86,0.86,0.86,0.86
2023-06-13,Bundesgebiet,00,00+,470,732,732,732,732,83155031,0.57,0.88,0.88,0.88,0.88
2023-06-12,Bundesgebiet,00,00+,529,781,781,781,781,83155031,0.64,0.94,0.94,0.94,0.94
2023-06-11,Bundesgebiet,00,00+,542,771,771,771,771,83155031,0.65,0.93,0.93,0.93,0.93
2023-06-10,Bundesgebiet,00,00+,550,765,765,765,765,83155031,0.66,0.92,0.92,0.92,0.92
2023-06-09,Bundesgebiet,00,00+,517,762,762,762,762,83155031,0.62,0.92,0.92,0.92,0.92
2023-06-08,Bundesgebiet,00,00+,592,862,862,862,862,83155031,0.71,1.04,1.04,1.04,1.04
2023-06-07,Bundesgebiet,00,00+,626,918,918,918,918,83155031,0.75,1.1,1.1,1.1,1.1
2023-06-06,Bundesgebiet,00,00+,808,1122,1122,1122,1122,83155031,0.97,1.35,1.35,1.35,1.35
2023-06-05,Bundesgebiet,00,00+,655,879,879,879,879,83155031,0.79,1.06,1.06,1.06,1.06
2023-06-04,Bundesgebiet,00,00+,666,878,878,878,878,83155031,0.8,1.06,1.06,1.06,1.06
2023-06-03,Bundesgebiet,00,00+,680,884,884,884,884,83155031,0.82,1.06,1.06,1.06,1.06
...
2023-05-31,Bundesgebiet,00,00+,631,958,958,958,958,83155031,0.76,1.15,1.15,1.15,1.15
...
2023-05-26,Bundesgebiet,00,00+,1161,1481,1481,1481,1481,83155031,1.4,1.78,1.78,1.78,1.78
2023-05-25,Bundesgebiet,00,00+,962,1343,1343,1343,1343,83155031,1.16,1.62,1.62,1.62,1.62
2023-05-24,Bundesgebiet,00,00+,1017,1404,1404,1404,1404,83155031,1.22,1.69,1.69,1.69,1.69
2023-05-23,Bundesgebiet,00,00+,882,1423,1423,1423,1423,83155031,1.06,1.71,1.71,1.71,1.71
2023-05-22,Bundesgebiet,00,00+,933,1389,1389,1389,1389,83155031,1.12,1.67,1.67,1.67,1.67
2023-05-21,Bundesgebiet,00,00+,958,1391,1391,1391,1391,83155031,1.15,1.67,1.67,1.67,1.67
2023-05-20,Bundesgebiet,00,00+,995,1398,1398,1398,1398,83155031,1.2,1.68,1.68,1.68,1.68
2023-05-19,Bundesgebiet,00,00+,1036,1460,1460,1460,1460,83155031,1.25,1.76,1.76,1.76,1.76
2023-05-18,Bundesgebiet,00,00+,1274,1700,1700,1700,1700,83155031,1.53,2.04,2.04,2.04,2.04
2023-05-17,Bundesgebiet,00,00+,1229,1693,1693,1693,1693,83155031,1.48,2.04,2.04,2.04,2.04
2023-05-16,Bundesgebiet,00,00+,1290,1836,1836,1836,1836,83155031,1.55,2.21,2.21,2.21,2.21
...
2023-05-11,Bundesgebiet,00,00+,1663,2215,2215,2215,2215,83155031,2,2.66,2.66,2.66,2.66
2023-05-10,Bundesgebiet,00,00+,1698,2385,2385,2385,2385,83155031,2.04,2.87,2.87,2.87,2.87
2023-05-09,Bundesgebiet,00,00+,2144,2883,2883,2883,2883,83155031,2.58,3.47,3.47,3.47,3.47
...
2023-05-04,Bundesgebiet,00,00+,1606,2333,2333,2333,2333,83155031,1.93,2.81,2.81,2.81,2.81
2023-05-03,Bundesgebiet,00,00+,1408,2314,2314,2314,2314,83155031,1.69,2.78,2.78,2.78,2.78
2023-05-02,Bundesgebiet,00,00+,1261,1959,1959,1959,1959,83155031,1.52,2.36,2.36,2.36,2.36
2023-05-01,Bundesgebiet,00,00+,2055,2765,2765,2765,2765,83155031,2.47,3.33,3.33,3.33,3.33
2023-04-30,Bundesgebiet,00,00+,2124,2782,2782,2782,2782,83155031,2.55,3.35,3.35,3.35,3.35
2023-04-29,Bundesgebiet,00,00+,2174,2759,2759,2759,2759,83155031,2.61,3.32,3.32,3.32,3.32
...
2023-04-25,Bundesgebiet,00,00+,2179,3180,3180,3180,3180,83155031,2.62,3.82,3.82,3.82,3.82
2023-04-24,Bundesgebiet,00,00+,2422,3348,3348,3348,3348,83155031,2.91,4.03,4.03,4.03,4.03
2023-04-23,Bundesgebiet,00,00+,2499,3351,3351,3351,3351,83155031,3.01,4.03,4.03,4.03,4.03
2023-04-22,Bundesgebiet,00,00+,2570,3378,3378,3378,3378,83155031,3.09,4.06,4.06,4.06,4.06
2023-04-21,Bundesgebiet,00,00+,2623,3496,3496,3496,3496,83155031,3.15,4.2,4.2,4.2,4.2
2023-04-20,Bundesgebiet,00,00+,2724,3689,3689,3689,3689,83155031,3.28,4.44,4.44,4.44,4.44
2023-04-19,Bundesgebiet,00,00+,2867,3912,3912,3912,3912,83155031,3.45,4.7,4.7,4.7,4.7
2023-04-18,Bundesgebiet,00,00+,3576,4941,4941,4941,4941,83155031,4.3,5.94,5.94,5.94,5.94
2023-04-17,Bundesgebiet,00,00+,2839,4017,4017,4017,4017,83155031,3.41,4.83,4.83,4.83,4.83
2023-04-16,Bundesgebiet,00,00+,2946,4052,4052,4052,4052,83155031,3.54,4.87,4.87,4.87,4.87
2023-04-15,Bundesgebiet,00,00+,3051,4098,4098,4098,4098,83155031,3.67,4.93,4.93,4.93,4.93
2023-04-14,Bundesgebiet,00,00+,2627,3655,3655,3655,3655,83155031,3.16,4.4,4.4,4.4,4.4
2023-04-13,Bundesgebiet,00,00+,2435,3566,3566,3566,3566,83155031,2.93,4.29,4.29,4.29,4.29
2023-04-12,Bundesgebiet,00,00+,1921,3502,3502,3502,3502,83155031,2.31,4.21,4.21,4.21,4.21
2023-04-11,Bundesgebiet,00,00+,1448,2715,2715,2715,2715,83155031,1.74,3.26,3.26,3.26,3.26
2023-04-10,Bundesgebiet,00,00+,2709,4061,4061,4061,4061,83155031,3.26,4.88,4.88,4.88,4.88
...
2023-04-05,Bundesgebiet,00,00+,3678,5209,5209,5209,5209,83155031,4.42,6.26,6.26,6.26,6.26
2023-04-04,Bundesgebiet,00,00+,3623,5347,5347,5347,5347,83155031,4.36,6.43,6.43,6.43,6.43
2023-04-03,Bundesgebiet,00,00+,4178,5770,5770,5770,5770,83155031,5.02,6.94,6.94,6.94,6.94
2023-04-02,Bundesgebiet,00,00+,4338,5812,5812,5812,5812,83155031,5.22,6.99,6.99,6.99,6.99
2023-04-01,Bundesgebiet,00,00+,4475,5829,5829,5829,5829,83155031,5.38,7.01,7.01,7.01,7.01
2023-03-31,Bundesgebiet,00,00+,4557,6078,6078,6078,6078,83155031,5.48,7.31,7.31,7.31,7.31
2023-03-30,Bundesgebiet,00,00+,4691,6377,6377,6377,6377,83155031,5.64,7.67,7.67,7.67,7.67
2023-03-29,Bundesgebiet,00,00+,4754,6726,6726,6726,6726,83155031,5.72,8.09,8.09,8.09,8.09
2023-03-28,Bundesgebiet,00,00+,4726,7173,7173,7173,7173,83155031,5.68,8.63,8.63,8.63,8.63
2023-03-27,Bundesgebiet,00,00+,5383,7729,7729,7729,7729,83155031,6.47,9.29,9.29,9.29,9.29
2023-03-26,Bundesgebiet,00,00+,5610,7796,7796,7796,7796,83155031,6.75,9.38,9.38,9.38,9.38
2023-03-25,Bundesgebiet,00,00+,5839,7910,7910,7910,7910,83155031,7.02,9.51,9.51,9.51,9.51
2023-03-24,Bundesgebiet,00,00+,5809,8146,8146,8146,8146,83155031,6.99,9.8,9.8,9.8,9.8
2023-03-23,Bundesgebiet,00,00+,5917,8456,8456,8456,8456,83155031,7.12,10.17,10.17,10.17,10.17
2023-03-22,Bundesgebiet,00,00+,5838,8684,8684,8684,8684,83155031,7.02,10.44,10.44,10.44,10.44
2023-03-21,Bundesgebiet,00,00+,5948,9023,9023,9023,9023,83155031,7.15,10.85,10.85,10.85,10.85
2023-03-20,Bundesgebiet,00,00+,6427,9230,9230,9230,9230,83155031,7.73,11.1,11.1,11.1,11.1
...
2023-03-16,Bundesgebiet,00,00+,6494,9362,9362,9362,9362,83155031,7.81,11.26,11.26,11.26,11.26
2023-03-15,Bundesgebiet,00,00+,6255,9149,9149,9149,9149,83155031,7.52,11,11,11,11
2023-03-14,Bundesgebiet,00,00+,5791,8935,8935,8935,8935,83155031,6.96,10.74,10.74,10.74,10.74
2023-03-13,Bundesgebiet,00,00+,5823,8613,8613,8613,8613,83155031,7,10.36,10.36,10.36,10.36
2023-03-12,Bundesgebiet,00,00+,6048,8570,8570,8570,8570,83155031,7.27,10.31,10.31,10.31,10.31
2023-03-11,Bundesgebiet,00,00+,6251,8513,8513,8513,8513,83155031,7.52,10.24,10.24,10.24,10.24
2023-03-10,Bundesgebiet,00,00+,5976,8336,8336,8336,8336,83155031,7.19,10.02,10.02,10.02,10.02
2023-03-09,Bundesgebiet,00,00+,5616,8096,8096,8096,8096,83155031,6.75,9.74,9.74,9.74,9.74
2023-03-08,Bundesgebiet,00,00+,5464,8193,8193,8193,8193,83155031,6.57,9.85,9.85,9.85,9.85
2023-03-07,Bundesgebiet,00,00+,5499,8352,8352,8352,8352,83155031,6.61,10.04,10.04,10.04,10.04
2023-03-06,Bundesgebiet,00,00+,5999,8730,8730,8730,8730,83155031,7.21,10.5,10.5,10.5,10.5
2023-03-05,Bundesgebiet,00,00+,6288,8802,8802,8802,8802,83155031,7.56,10.59,10.59,10.59,10.59
2023-03-04,Bundesgebiet,00,00+,6569,8897,8897,8897,8897,83155031,7.9,10.7,10.7,10.7,10.7
2023-03-03,Bundesgebiet,00,00+,6625,9180,9180,9180,9180,83155031,7.97,11.04,11.04,11.04,11.04
2023-03-02,Bundesgebiet,00,00+,6686,9554,9554,9554,9554,83155031,8.04,11.49,11.49,11.49,11.49
2023-03-01,Bundesgebiet,00,00+,6823,9981,9981,9981,9981,83155031,8.21,12,12,12,12
2023-02-28,Bundesgebiet,00,00+,6770,10226,10226,10226,10226,83155031,8.14,12.3,12.3,12.3,12.3
2023-02-27,Bundesgebiet,00,00+,6629,9853,9853,9853,9853,83155031,7.97,11.85,11.85,11.85,11.85
2023-02-26,Bundesgebiet,00,00+,6933,9902,9902,9902,9902,83155031,8.34,11.91,11.91,11.91,11.91
2023-02-25,Bundesgebiet,00,00+,7171,9854,9854,9854,9854,83155031,8.62,11.85,11.85,11.85,11.85
2023-02-24,Bundesgebiet,00,00+,6781,9830,9830,9830,9830,83155031,8.15,11.82,11.82,11.82,11.82
2023-02-23,Bundesgebiet,00,00+,6507,9678,9678,9678,9678,83155031,7.83,11.64,11.64,11.64,11.64
2023-02-22,Bundesgebiet,00,00+,5776,9477,9477,9477,9477,83155031,6.95,11.4,11.4,11.4,11.4
2023-02-21,Bundesgebiet,00,00+,5478,9191,9191,9191,9191,83155031,6.59,11.05,11.05,11.05,11.05
2023-02-20,Bundesgebiet,00,00+,6127,9240,9240,9240,9240,83155031,7.37,11.11,11.11,11.11,11.11
2023-02-19,Bundesgebiet,00,00+,6362,9149,9149,9149,9149,83155031,7.65,11,11,11,11
2023-02-18,Bundesgebiet,00,00+,6607,9143,9143,9143,9143,83155031,7.95,11,11,11,11
2023-02-17,Bundesgebiet,00,00+,6220,8854,8854,8854,8854,83155031,7.48,10.65,10.65,10.65,10.65
2023-02-16,Bundesgebiet,00,00+,5856,8612,8612,8612,8612,83155031,7.04,10.36,10.36,10.36,10.36
2023-02-15,Bundesgebiet,00,00+,5333,8216,8216,8216,8216,83155031,6.41,9.88,9.88,9.88,9.88
2023-02-14,Bundesgebiet,00,00+,4958,7791,7791,7791,7791,83155031,5.96,9.37,9.37,9.37,9.37
2023-02-13,Bundesgebiet,00,00+,4926,7338,7338,7338,7338,83155031,5.92,8.82,8.82,8.82,8.82
2023-02-12,Bundesgebiet,00,00+,5114,7277,7277,7277,7277,83155031,6.15,8.75,8.75,8.75,8.75
2023-02-11,Bundesgebiet,00,00+,5302,7215,7215,7215,7215,83155031,6.38,8.68,8.68,8.68,8.68
2023-02-10,Bundesgebiet,00,00+,5200,7171,7171,7171,7171,83155031,6.25,8.62,8.62,8.62,8.62
...
2023-02-07,Bundesgebiet,00,00+,4293,6538,6538,6538,6538,83155031,5.16,7.86,7.86,7.86,7.86
2023-02-06,Bundesgebiet,00,00+,4101,6125,6125,6125,6125,83155031,4.93,7.37,7.37,7.37,7.37
2023-02-05,Bundesgebiet,00,00+,4276,6100,6100,6100,6100,83155031,5.14,7.34,7.34,7.34,7.34
2023-02-04,Bundesgebiet,00,00+,4420,6050,6050,6050,6050,83155031,5.32,7.28,7.28,7.28,7.28
2023-02-03,Bundesgebiet,00,00+,4182,5817,5817,5817,5817,83155031,5.03,7,7,7,7
2023-02-02,Bundesgebiet,00,00+,4236,5770,5770,5770,5770,83155031,5.09,6.94,6.94,6.94,6.94
2023-02-01,Bundesgebiet,00,00+,3923,5509,5509,5509,5509,83155031,4.72,6.62,6.62,6.62,6.62
2023-01-31,Bundesgebiet,00,00+,3542,5322,5322,5322,5322,83155031,4.26,6.4,6.4,6.4,6.4
2023-01-30,Bundesgebiet,00,00+,3525,5141,5141,5141,5141,83155031,4.24,6.18,6.18,6.18,6.18
2023-01-29,Bundesgebiet,00,00+,3664,5106,5106,5106,5106,83155031,4.41,6.14,6.14,6.14,6.14
2023-01-28,Bundesgebiet,00,00+,3787,5082,5082,5082,5082,83155031,4.55,6.11,6.11,6.11,6.11
2023-01-27,Bundesgebiet,00,00+,3601,4907,4907,4907,4907,83155031,4.33,5.9,5.9,5.9,5.9
2023-01-26,Bundesgebiet,00,00+,3483,4762,4762,4762,4762,83155031,4.19,5.73,5.73,5.73,5.73
2023-01-25,Bundesgebiet,00,00+,3382,4754,4754,4754,4754,83155031,4.07,5.72,5.72,5.72,5.72
2023-01-24,Bundesgebiet,00,00+,3236,4676,4676,4676,4676,83155031,3.89,5.62,5.62,5.62,5.62
2023-01-23,Bundesgebiet,00,00+,3451,4884,4884,4884,4884,83155031,4.15,5.87,5.87,5.87,5.87
2023-01-22,Bundesgebiet,00,00+,3589,4881,4881,4881,4881,83155031,4.32,5.87,5.87,5.87,5.87
2023-01-21,Bundesgebiet,00,00+,3728,4908,4908,4908,4908,83155031,4.48,5.9,5.9,5.9,5.9
2023-01-20,Bundesgebiet,00,00+,3739,5115,5115,5115,5115,83155031,4.5,6.15,6.15,6.15,6.15
2023-01-19,Bundesgebiet,00,00+,3742,5261,5261,5261,5261,83155031,4.5,6.33,6.33,6.33,6.33
2023-01-18,Bundesgebiet,00,00+,3883,5547,5547,5547,5547,83155031,4.67,6.67,6.67,6.67,6.67
2023-01-17,Bundesgebiet,00,00+,3934,5948,5948,5948,5948,83155031,4.73,7.15,7.15,7.15,7.15
2023-01-16,Bundesgebiet,00,00+,4661,6670,6670,6670,6670,83155031,5.61,8.02,8.02,8.02,8.02
2023-01-15,Bundesgebiet,00,00+,4847,6725,6725,6725,6725,83155031,5.83,8.09,8.09,8.09,8.09
2023-01-14,Bundesgebiet,00,00+,5057,6806,6806,6806,6806,83155031,6.08,8.18,8.18,8.18,8.18
2023-01-13,Bundesgebiet,00,00+,4966,6858,6858,6858,6858,83155031,5.97,8.25,8.25,8.25,8.25
2023-01-12,Bundesgebiet,00,00+,5316,7420,7420,7420,7420,83155031,6.39,8.92,8.92,8.92,8.92
2023-01-11,Bundesgebiet,00,00+,5486,7979,7979,7979,7979,83155031,6.6,9.6,9.6,9.6,9.6
2023-01-10,Bundesgebiet,00,00+,5550,8602,8602,8602,8602,83155031,6.67,10.34,10.34,10.34,10.34
2023-01-09,Bundesgebiet,00,00+,5953,9128,9128,9128,9128,83155031,7.16,10.98,10.98,10.98,10.98
2023-01-08,Bundesgebiet,00,00+,6217,9242,9242,9242,9242,83155031,7.48,11.11,11.11,11.11,11.11
...
2023-12-20,Schleswig-Holstein,01,00+,265,265,NA,NA,NA,2910875,9.1,9.1,NA,NA,NA
2023-12-19,Schleswig-Holstein,01,00+,256,327,NA,NA,NA,2910875,8.79,11.23,NA,NA,NA
2023-12-18,Schleswig-Holstein,01,00+,315,380,NA,NA,NA,2910875,10.82,13.05,NA,NA,NA
2023-12-17,Schleswig-Holstein,01,00+,323,385,444,433,470,2910875,11.1,13.23,15.27,14.91,16.16
2023-12-16,Schleswig-Holstein,01,00+,333,388,438,430,448,2910875,11.44,13.33,15.07,14.8,15.42
2023-12-15,Schleswig-Holstein,01,00+,328,407,451,444,461,2910875,11.27,13.98,15.5,15.26,15.86
2023-12-14,Schleswig-Holstein,01,00+,342,439,479,472,490,2910875,11.75,15.08,16.49,16.24,16.85
2023-12-13,Schleswig-Holstein,01,00+,337,442,476,470,485,2910875,11.58,15.18,16.38,16.17,16.69
2023-12-12,Schleswig-Holstein,01,00+,298,426,453,448,461,2910875,10.24,14.63,15.59,15.41,15.85
2023-12-11,Schleswig-Holstein,01,00+,292,396,415,410,421,2910875,10.03,13.6,14.26,14.1,14.49
2023-12-10,Schleswig-Holstein,01,00+,303,400,418,414,425,2910875,10.41,13.74,14.39,14.23,14.62
2023-12-09,Schleswig-Holstein,01,00+,311,396,414,409,420,2910875,10.68,13.6,14.23,14.07,14.45
2023-12-08,Schleswig-Holstein,01,00+,256,404,420,415,426,2910875,8.79,13.88,14.44,14.29,14.67
2023-12-07,Schleswig-Holstein,01,00+,246,380,393,389,399,2910875,8.45,13.05,13.52,13.39,13.72
2023-12-06,Schleswig-Holstein,01,00+,241,357,368,364,373,2910875,8.28,12.26,12.65,12.53,12.83
2023-12-05,Schleswig-Holstein,01,00+,244,359,368,365,373,2910875,8.38,12.33,12.66,12.55,12.83
2023-12-04,Schleswig-Holstein,01,00+,289,382,390,387,394,2910875,9.93,13.12,13.4,13.3,13.57
2023-12-03,Schleswig-Holstein,01,00+,295,376,383,380,388,2910875,10.13,12.92,13.19,13.08,13.35
2023-12-02,Schleswig-Holstein,01,00+,302,375,382,379,387,2910875,10.37,12.88,13.15,13.05,13.31
2023-12-01,Schleswig-Holstein,01,00+,290,357,363,361,367,2910875,9.96,12.26,12.49,12.4,12.64
2023-11-30,Schleswig-Holstein,01,00+,239,350,355,353,359,2910875,8.21,12.02,12.23,12.15,12.36
2023-11-29,Schleswig-Holstein,01,00+,204,370,375,373,379,2910875,7.01,12.71,12.9,12.83,13.03
2023-11-28,Schleswig-Holstein,01,00+,220,354,358,356,361,2910875,7.56,12.16,12.32,12.26,12.43
2023-11-27,Schleswig-Holstein,01,00+,237,318,321,320,323,2910875,8.14,10.92,11.04,10.99,11.12
2023-11-26,Schleswig-Holstein,01,00+,241,315,318,316,320,2910875,8.28,10.82,10.93,10.89,11.01
2023-11-25,Schleswig-Holstein,01,00+,250,317,320,318,322,2910875,8.59,10.89,11,10.96,11.08
2023-11-24,Schleswig-Holstein,01,00+,248,303,305,304,307,2910875,8.52,10.41,10.5,10.47,10.57
2023-11-23,Schleswig-Holstein,01,00+,202,296,298,297,299,2910875,6.94,10.17,10.25,10.22,10.31
2023-11-22,Schleswig-Holstein,01,00+,178,286,287,287,289,2910875,6.11,9.83,9.89,9.87,9.93
2023-11-21,Schleswig-Holstein,01,00+,221,286,287,286,288,2910875,7.59,9.83,9.88,9.86,9.91
2023-11-20,Schleswig-Holstein,01,00+,217,256,256,256,257,2910875,7.45,8.79,8.83,8.82,8.84
2023-11-19,Schleswig-Holstein,01,00+,225,260,260,260,261,2910875,7.73,8.93,8.96,8.95,8.97
2023-11-18,Schleswig-Holstein,01,00+,231,257,257,257,258,2910875,7.94,8.83,8.86,8.85,8.87
2023-11-17,Schleswig-Holstein,01,00+,227,262,262,262,262,2910875,7.8,9,9.02,9.02,9.03
2023-11-16,Schleswig-Holstein,01,00+,185,279,279,279,279,2910875,6.36,9.58,9.6,9.6,9.61
2023-11-15,Schleswig-Holstein,01,00+,226,288,288,288,288,2910875,7.76,9.89,9.91,9.9,9.91
2023-11-14,Schleswig-Holstein,01,00+,217,268,268,268,268,2910875,7.45,9.21,9.21,9.21,9.21
2023-11-13,Schleswig-Holstein,01,00+,273,347,347,347,347,2910875,9.38,11.92,11.92,11.92,11.92
2023-11-12,Schleswig-Holstein,01,00+,276,342,342,342,342,2910875,9.48,11.75,11.75,11.75,11.75
2023-11-11,Schleswig-Holstein,01,00+,284,344,344,344,344,2910875,9.76,11.82,11.82,11.82,11.82
2023-11-10,Schleswig-Holstein,01,00+,290,353,353,353,353,2910875,9.96,12.13,12.13,12.13,12.13
2023-11-09,Schleswig-Holstein,01,00+,295,385,385,385,385,2910875,10.13,13.23,13.23,13.23,13.23
2023-11-08,Schleswig-Holstein,01,00+,309,412,412,412,412,2910875,10.62,14.15,14.15,14.15,14.15
2023-11-07,Schleswig-Holstein,01,00+,203,386,386,386,386,2910875,6.97,13.26,13.26,13.26,13.26
2023-11-06,Schleswig-Holstein,01,00+,289,371,371,371,371,2910875,9.93,12.75,12.75,12.75,12.75
2023-11-05,Schleswig-Holstein,01,00+,294,374,374,374,374,2910875,10.1,12.85,12.85,12.85,12.85
2023-11-04,Schleswig-Holstein,01,00+,304,377,377,377,377,2910875,10.44,12.95,12.95,12.95,12.95
2023-11-03,Schleswig-Holstein,01,00+,292,375,375,375,375,2910875,10.03,12.88,12.88,12.88,12.88
...
2023-10-30,Schleswig-Holstein,01,00+,231,321,321,321,321,2910875,7.94,11.03,11.03,11.03,11.03
2023-10-29,Schleswig-Holstein,01,00+,240,324,324,324,324,2910875,8.24,11.13,11.13,11.13,11.13
2023-10-28,Schleswig-Holstein,01,00+,248,321,321,321,321,2910875,8.52,11.03,11.03,11.03,11.03
2023-10-27,Schleswig-Holstein,01,00+,230,309,309,309,309,2910875,7.9,10.62,10.62,10.62,10.62
2023-10-26,Schleswig-Holstein,01,00+,205,286,286,286,286,2910875,7.04,9.83,9.83,9.83,9.83
2023-10-25,Schleswig-Holstein,01,00+,193,275,275,275,275,2910875,6.63,9.45,9.45,9.45,9.45
2023-10-24,Schleswig-Holstein,01,00+,140,238,238,238,238,2910875,4.81,8.18,8.18,8.18,8.18
...
2023-08-24,Schleswig-Holstein,01,00+,87,106,106,106,106,2910875,2.99,3.64,3.64,3.64,3.64
2023-08-23,Schleswig-Holstein,01,00+,85,111,111,111,111,2910875,2.92,3.81,3.81,3.81,3.81
2023-08-22,Schleswig-Holstein,01,00+,61,89,89,89,89,2910875,2.1,3.06,3.06,3.06,3.06
2023-08-21,Schleswig-Holstein,01,00+,68,95,95,95,95,2910875,2.34,3.26,3.26,3.26,3.26
2023-08-20,Schleswig-Holstein,01,00+,72,98,98,98,98,2910875,2.47,3.37,3.37,3.37,3.37
2023-08-19,Schleswig-Holstein,01,00+,72,92,92,92,92,2910875,2.47,3.16,3.16,3.16,3.16
2023-08-18,Schleswig-Holstein,01,00+,70,92,92,92,92,2910875,2.4,3.16,3.16,3.16,3.16
...
2023-05-30,Schleswig-Holstein,01,00+,52,77,77,77,77,2910875,1.79,2.65,2.65,2.65,2.65
2023-05-29,Schleswig-Holstein,01,00+,78,104,104,104,104,2910875,2.68,3.57,3.57,3.57,3.57
2023-05-28,Schleswig-Holstein,01,00+,82,105,105,105,105,2910875,2.82,3.61,3.61,3.61,3.61
2023-05-27,Schleswig-Holstein,01,00+,83,103,103,103,103,2910875,2.85,3.54,3.54,3.54,3.54
2023-05-26,Schleswig-Holstein,01,00+,70,98,98,98,98,2910875,2.4,3.37,3.37,3.37,3.37
2023-05-25,Schleswig-Holstein,01,00+,46,85,85,85,85,2910875,1.58,2.92,2.92,2.92,2.92
2023-05-24,Schleswig-Holstein,01,00+,54,76,76,76,76,2910875,1.86,2.61,2.61,2.61,2.61
2023-05-23,Schleswig-Holstein,01,00+,58,77,77,77,77,2910875,1.99,2.65,2.65,2.65,2.65
2023-05-22,Schleswig-Holstein,01,00+,60,84,84,84,84,2910875,2.06,2.89,2.89,2.89,2.89
2023-05-21,Schleswig-Holstein,01,00+,61,81,81,81,81,2910875,2.1,2.78,2.78,2.78,2.78
2023-05-20,Schleswig-Holstein,01,00+,65,84,84,84,84,2910875,2.23,2.89,2.89,2.89,2.89
2023-05-19,Schleswig-Holstein,01,00+,83,110,110,110,110,2910875,2.85,3.78,3.78,3.78,3.78
2023-05-18,Schleswig-Holstein,01,00+,95,122,122,122,122,2910875,3.26,4.19,4.19,4.19,4.19
...
2023-03-06,Schleswig-Holstein,01,00+,151,212,212,212,212,2910875,5.19,7.28,7.28,7.28,7.28
2023-03-05,Schleswig-Holstein,01,00+,156,205,205,205,205,2910875,5.36,7.04,7.04,7.04,7.04
2023-03-04,Schleswig-Holstein,01,00+,159,205,205,205,205,2910875,5.46,7.04,7.04,7.04,7.04
2023-03-03,Schleswig-Holstein,01,00+,179,221,221,221,221,2910875,6.15,7.59,7.59,7.59,7.59
2023-03-02,Schleswig-Holstein,01,00+,182,228,228,228,228,2910875,6.25,7.83,7.83,7.83,7.83
2023-03-01,Schleswig-Holstein,01,00+,173,231,231,231,231,2910875,5.94,7.94,7.94,7.94,7.94
2023-02-28,Schleswig-Holstein,01,00+,149,223,223,223,223,2910875,5.12,7.66,7.66,7.66,7.66
...
2023-12-20,Hamburg,02,00+,238,238,NA,NA,NA,1852478,12.85,12.85,NA,NA,NA
2023-12-19,Hamburg,02,00+,237,274,NA,NA,NA,1852478,12.79,14.79,NA,NA,NA
2023-12-18,Hamburg,02,00+,209,307,NA,NA,NA,1852478,11.28,16.57,NA,NA,NA
2023-12-17,Hamburg,02,00+,233,327,374,366,385,1852478,12.58,17.65,20.24,19.78,20.8
2023-12-16,Hamburg,02,00+,235,329,377,368,387,1852478,12.69,17.76,20.36,19.9,20.92
2023-12-15,Hamburg,02,00+,247,337,375,368,385,1852478,13.33,18.19,20.26,19.89,20.81
2023-12-14,Hamburg,02,00+,272,362,396,389,405,1852478,14.68,19.54,21.41,21.04,21.91
2023-12-13,Hamburg,02,00+,246,348,375,369,383,1852478,13.28,18.79,20.27,19.96,20.72
2023-12-12,Hamburg,02,00+,252,337,359,354,365,1852478,13.6,18.19,19.39,19.12,19.73
2023-12-11,Hamburg,02,00+,216,311,326,323,332,1852478,11.66,16.79,17.63,17.45,17.93
2023-12-10,Hamburg,02,00+,229,301,315,311,320,1852478,12.36,16.25,17.01,16.84,17.28
2023-12-09,Hamburg,02,00+,229,299,312,309,317,1852478,12.36,16.14,16.89,16.72,17.17
2023-12-08,Hamburg,02,00+,190,274,285,282,290,1852478,10.26,14.79,15.41,15.27,15.66
2023-12-07,Hamburg,02,00+,182,246,254,252,258,1852478,9.82,13.28,13.77,13.64,13.97
2023-12-06,Hamburg,02,00+,126,234,241,239,244,1852478,6.8,12.63,13.04,12.93,13.22
2023-12-05,Hamburg,02,00+,153,227,233,231,236,1852478,8.26,12.25,12.58,12.49,12.75
2023-12-04,Hamburg,02,00+,159,211,215,214,218,1852478,8.58,11.39,11.63,11.55,11.78
2023-12-03,Hamburg,02,00+,172,209,213,211,215,1852478,9.28,11.28,11.51,11.43,11.65
2023-12-02,Hamburg,02,00+,172,209,213,211,215,1852478,9.28,11.28,11.51,11.43,11.65
2023-12-01,Hamburg,02,00+,152,211,214,213,217,1852478,8.21,11.39,11.6,11.53,11.74
2023-11-30,Hamburg,02,00+,154,222,225,224,228,1852478,8.31,11.98,12.18,12.11,12.31
2023-11-29,Hamburg,02,00+,167,228,231,230,233,1852478,9.01,12.31,12.49,12.42,12.61
2023-11-28,Hamburg,02,00+,183,239,241,240,243,1852478,9.88,12.9,13.06,13,13.17
2023-11-27,Hamburg,02,00+,218,260,262,261,264,1852478,11.77,14.04,14.18,14.12,14.28
2023-11-26,Hamburg,02,00+,218,247,249,248,251,1852478,11.77,13.33,13.47,13.41,13.56
2023-11-25,Hamburg,02,00+,218,247,249,248,251,1852478,11.77,13.33,13.47,13.41,13.56
2023-11-24,Hamburg,02,00+,199,248,250,249,251,1852478,10.74,13.39,13.51,13.46,13.59
2023-11-23,Hamburg,02,00+,183,237,238,238,240,1852478,9.88,12.79,12.9,12.86,12.96
2023-11-22,Hamburg,02,00+,167,233,234,233,235,1852478,9.01,12.58,12.67,12.63,12.72
2023-11-21,Hamburg,02,00+,158,202,203,202,203,1852478,8.53,10.9,10.97,10.94,11
2023-11-20,Hamburg,02,00+,149,178,178,178,178,1852478,8.04,9.61,9.64,9.63,9.65
2023-11-19,Hamburg,02,00+,149,178,178,178,178,1852478,8.04,9.61,9.64,9.63,9.65
2023-11-18,Hamburg,02,00+,149,178,178,178,178,1852478,8.04,9.61,9.64,9.63,9.65
2023-11-17,Hamburg,02,00+,154,183,183,183,183,1852478,8.31,9.88,9.9,9.9,9.91
2023-11-16,Hamburg,02,00+,140,175,175,175,175,1852478,7.56,9.45,9.46,9.46,9.47
2023-11-15,Hamburg,02,00+,155,177,177,177,177,1852478,8.37,9.55,9.57,9.56,9.57
2023-11-14,Hamburg,02,00+,152,173,173,173,173,1852478,8.21,9.34,9.35,9.34,9.35
2023-11-13,Hamburg,02,00+,171,198,198,198,198,1852478,9.23,10.69,10.69,10.69,10.69
2023-11-12,Hamburg,02,00+,171,198,198,198,198,1852478,9.23,10.69,10.69,10.69,10.69
2023-11-11,Hamburg,02,00+,171,198,198,198,198,1852478,9.23,10.69,10.69,10.69,10.69
2023-11-10,Hamburg,02,00+,166,193,193,193,193,1852478,8.96,10.42,10.42,10.42,10.42
2023-11-09,Hamburg,02,00+,176,218,218,218,218,1852478,9.5,11.77,11.77,11.77,11.77
2023-11-08,Hamburg,02,00+,231,276,276,276,276,1852478,12.47,14.9,14.9,14.9,14.9
2023-11-07,Hamburg,02,00+,186,248,248,248,248,1852478,10.04,13.39,13.39,13.39,13.39
2023-11-06,Hamburg,02,00+,185,218,218,218,218,1852478,9.99,11.77,11.77,11.77,11.77
2023-11-05,Hamburg,02,00+,186,219,219,219,219,1852478,10.04,11.82,11.82,11.82,11.82
2023-11-04,Hamburg,02,00+,186,219,219,219,219,1852478,10.04,11.82,11.82,11.82,11.82
2023-11-03,Hamburg,02,00+,165,219,219,219,219,1852478,8.91,11.82,11.82,11.82,11.82
...
2023-09-19,Hamburg,02,00+,52,73,73,73,73,1852478,2.81,3.94,3.94,3.94,3.94
2023-09-18,Hamburg,02,00+,59,89,89,89,89,1852478,3.18,4.8,4.8,4.8,4.8
2023-09-17,Hamburg,02,00+,59,89,89,89,89,1852478,3.18,4.8,4.8,4.8,4.8
2023-09-16,Hamburg,02,00+,59,89,89,89,89,1852478,3.18,4.8,4.8,4.8,4.8
2023-09-15,Hamburg,02,00+,72,95,95,95,95,1852478,3.89,5.13,5.13,5.13,5.13
2023-09-14,Hamburg,02,00+,73,96,96,96,96,1852478,3.94,5.18,5.18,5.18,5.18
2023-09-13,Hamburg,02,00+,71,89,89,89,89,1852478,3.83,4.8,4.8,4.8,4.8
2023-09-12,Hamburg,02,00+,63,90,90,90,90,1852478,3.4,4.86,4.86,4.86,4.86
2023-09-11,Hamburg,02,00+,54,73,73,73,73,1852478,2.92,3.94,3.94,3.94,3.94
2023-09-10,Hamburg,02,00+,54,73,73,73,73,1852478,2.92,3.94,3.94,3.94,3.94
2023-09-09,Hamburg,02,00+,54,73,73,73,73,1852478,2.92,3.94,3.94,3.94,3.94
2023-09-08,Hamburg,02,00+,46,62,62,62,62,1852478,2.48,3.35,3.35,3.35,3.35
...
2023-06-19,Hamburg,02,00+,21,31,31,31,31,1852478,1.13,1.67,1.67,1.67,1.67
2023-06-18,Hamburg,02,00+,23,33,33,33,33,1852478,1.24,1.78,1.78,1.78,1.78
2023-06-17,Hamburg,02,00+,23,33,33,33,33,1852478,1.24,1.78,1.78,1.78,1.78
2023-06-16,Hamburg,02,00+,24,41,41,41,41,1852478,1.3,2.21,2.21,2.21,2.21
2023-06-15,Hamburg,02,00+,30,44,44,44,44,1852478,1.62,2.38,2.38,2.38,2.38
2023-06-14,Hamburg,02,00+,27,44,44,44,44,1852478,1.46,2.38,2.38,2.38,2.38
2023-06-13,Hamburg,02,00+,19,42,42,42,42,1852478,1.03,2.27,2.27,2.27,2.27
...
2023-05-16,Hamburg,02,00+,75,102,102,102,102,1852478,4.05,5.51,5.51,5.51,5.51
2023-05-15,Hamburg,02,00+,78,114,114,114,114,1852478,4.21,6.15,6.15,6.15,6.15
2023-05-14,Hamburg,02,00+,81,113,113,113,113,1852478,4.37,6.1,6.1,6.1,6.1
2023-05-13,Hamburg,02,00+,81,114,114,114,114,1852478,4.37,6.15,6.15,6.15,6.15
2023-05-12,Hamburg,02,00+,65,99,99,99,99,1852478,3.51,5.34,5.34,5.34,5.34
2023-05-11,Hamburg,02,00+,59,95,95,95,95,1852478,3.18,5.13,5.13,5.13,5.13
2023-05-10,Hamburg,02,00+,62,86,86,86,86,1852478,3.35,4.64,4.64,4.64,4.64
...
2023-04-24,Hamburg,02,00+,63,107,107,107,107,1852478,3.4,5.78,5.78,5.78,5.78
2023-04-23,Hamburg,02,00+,70,101,101,101,101,1852478,3.78,5.45,5.45,5.45,5.45
2023-04-22,Hamburg,02,00+,70,100,100,100,100,1852478,3.78,5.4,5.4,5.4,5.4
2023-04-21,Hamburg,02,00+,94,115,115,115,115,1852478,5.07,6.21,6.21,6.21,6.21
2023-04-20,Hamburg,02,00+,107,129,129,129,129,1852478,5.78,6.96,6.96,6.96,6.96
2023-04-19,Hamburg,02,00+,109,135,135,135,135,1852478,5.88,7.29,7.29,7.29,7.29
2023-04-18,Hamburg,02,00+,103,156,156,156,156,1852478,5.56,8.42,8.42,8.42,8.42
...
2023-04-04,Hamburg,02,00+,104,146,146,146,146,1852478,5.61,7.88,7.88,7.88,7.88
2023-04-03,Hamburg,02,00+,114,178,178,178,178,1852478,6.15,9.61,9.61,9.61,9.61
2023-04-02,Hamburg,02,00+,115,170,170,170,170,1852478,6.21,9.18,9.18,9.18,9.18
2023-04-01,Hamburg,02,00+,116,167,167,167,167,1852478,6.26,9.01,9.01,9.01,9.01
2023-03-31,Hamburg,02,00+,125,175,175,175,175,1852478,6.75,9.45,9.45,9.45,9.45
2023-03-30,Hamburg,02,00+,110,181,181,181,181,1852478,5.94,9.77,9.77,9.77,9.77
2023-03-29,Hamburg,02,00+,101,187,187,187,187,1852478,5.45,10.09,10.09,10.09,10.09
...
2023-03-13,Hamburg,02,00+,60,104,104,104,104,1852478,3.24,5.61,5.61,5.61,5.61
2023-03-12,Hamburg,02,00+,60,102,102,102,102,1852478,3.24,5.51,5.51,5.51,5.51
2023-03-11,Hamburg,02,00+,62,100,100,100,100,1852478,3.35,5.4,5.4,5.4,5.4
2023-03-10,Hamburg,02,00+,34,89,89,89,89,1852478,1.84,4.8,4.8,4.8,4.8
2023-03-09,Hamburg,02,00+,50,96,96,96,96,1852478,2.7,5.18,5.18,5.18,5.18
2023-03-08,Hamburg,02,00+,38,89,89,89,89,1852478,2.05,4.8,4.8,4.8,4.8
2023-03-07,Hamburg,02,00+,53,88,88,88,88,1852478,2.86,4.75,4.75,4.75,4.75
2023-03-06,Hamburg,02,00+,73,95,95,95,95,1852478,3.94,5.13,5.13,5.13,5.13
2023-03-05,Hamburg,02,00+,75,97,97,97,97,1852478,4.05,5.24,5.24,5.24,5.24
2023-03-04,Hamburg,02,00+,77,98,98,98,98,1852478,4.16,5.29,5.29,5.29,5.29
2023-03-03,Hamburg,02,00+,90,119,119,119,119,1852478,4.86,6.42,6.42,6.42,6.42
2023-03-02,Hamburg,02,00+,80,117,117,117,117,1852478,4.32,6.32,6.32,6.32,6.32
2023-03-01,Hamburg,02,00+,50,123,123,123,123,1852478,2.7,6.64,6.64,6.64,6.64
2023-02-28,Hamburg,02,00+,57,121,121,121,121,1852478,3.08,6.53,6.53,6.53,6.53
2023-02-27,Hamburg,02,00+,54,111,111,111,111,1852478,2.92,5.99,5.99,5.99,5.99
2023-02-26,Hamburg,02,00+,56,111,111,111,111,1852478,3.02,5.99,5.99,5.99,5.99
2023-02-25,Hamburg,02,00+,59,111,111,111,111,1852478,3.18,5.99,5.99,5.99,5.99
2023-02-24,Hamburg,02,00+,51,95,95,95,95,1852478,2.75,5.13,5.13,5.13,5.13
2023-02-23,Hamburg,02,00+,52,93,93,93,93,1852478,2.81,5.02,5.02,5.02,5.02
2023-02-22,Hamburg,02,00+,45,100,100,100,100,1852478,2.43,5.4,5.4,5.4,5.4
2023-02-21,Hamburg,02,00+,50,99,99,99,99,1852478,2.7,5.34,5.34,5.34,5.34
...
2023-02-01,Hamburg,02,00+,46,63,63,63,63,1852478,2.48,3.4,3.4,3.4,3.4
2023-01-31,Hamburg,02,00+,31,62,62,62,62,1852478,1.67,3.35,3.35,3.35,3.35
2023-01-30,Hamburg,02,00+,25,57,57,57,57,1852478,1.35,3.08,3.08,3.08,3.08
2023-01-29,Hamburg,02,00+,25,54,54,54,54,1852478,1.35,2.92,2.92,2.92,2.92
2023-01-28,Hamburg,02,00+,27,55,55,55,55,1852478,1.46,2.97,2.97,2.97,2.97
2023-01-27,Hamburg,02,00+,29,54,54,54,54,1852478,1.57,2.92,2.92,2.92,2.92
2023-01-26,Hamburg,02,00+,32,55,55,55,55,1852478,1.73,2.97,2.97,2.97,2.97
2023-01-25,Hamburg,02,00+,21,50,50,50,50,1852478,1.13,2.7,2.7,2.7,2.7
2023-01-24,Hamburg,02,00+,24,51,51,51,51,1852478,1.3,2.75,2.75,2.75,2.75
2023-01-23,Hamburg,02,00+,30,54,54,54,54,1852478,1.62,2.92,2.92,2.92,2.92
2023-01-22,Hamburg,02,00+,31,57,57,57,57,1852478,1.67,3.08,3.08,3.08,3.08
2023-01-21,Hamburg,02,00+,31,55,55,55,55,1852478,1.67,2.97,2.97,2.97,2.97
2023-01-20,Hamburg,02,00+,44,68,68,68,68,1852478,2.38,3.67,3.67,3.67,3.67
2023-01-19,Hamburg,02,00+,33,67,67,67,67,1852478,1.78,3.62,3.62,3.62,3.62
2023-01-18,Hamburg,02,00+,43,82,82,82,82,1852478,2.32,4.43,4.43,4.43,4.43
2023-01-17,Hamburg,02,00+,49,96,96,96,96,1852478,2.65,5.18,5.18,5.18,5.18
2023-01-16,Hamburg,02,00+,61,117,117,117,117,1852478,3.29,6.32,6.32,6.32,6.32
2023-01-15,Hamburg,02,00+,62,115,115,115,115,1852478,3.35,6.21,6.21,6.21,6.21
2023-01-14,Hamburg,02,00+,64,117,117,117,117,1852478,3.45,6.32,6.32,6.32,6.32
2023-01-13,Hamburg,02,00+,63,116,116,116,116,1852478,3.4,6.26,6.26,6.26,6.26
2023-01-12,Hamburg,02,00+,66,141,141,141,141,1852478,3.56,7.61,7.61,7.61,7.61
2023-01-11,Hamburg,02,00+,108,184,184,184,184,1852478,5.83,9.93,9.93,9.93,9.93
2023-01-10,Hamburg,02,00+,99,191,191,191,191,1852478,5.34,10.31,10.31,10.31,10.31
2023-01-09,Hamburg,02,00+,81,179,179,179,179,1852478,4.37,9.66,9.66,9.66,9.66
2023-01-08,Hamburg,02,00+,82,179,179,179,179,1852478,4.43,9.66,9.66,9.66,9.66
...
2023-12-20,Niedersachsen,03,00+,644,644,NA,NA,NA,8003421,8.05,8.05,NA,NA,NA
2023-12-19,Niedersachsen,03,00+,599,760,NA,NA,NA,8003421,7.48,9.5,NA,NA,NA
2023-12-18,Niedersachsen,03,00+,700,853,NA,NA,NA,8003421,8.75,10.66,NA,NA,NA
2023-12-17,Niedersachsen,03,00+,721,859,991,961,1100,8003421,9.01,10.73,12.39,12.02,13.75
2023-12-16,Niedersachsen,03,00+,754,866,976,958,996,8003421,9.42,10.82,12.2,11.98,12.46
2023-12-15,Niedersachsen,03,00+,733,903,996,979,1018,8003421,9.16,11.28,12.46,12.24,12.72
2023-12-14,Niedersachsen,03,00+,711,887,965,950,984,8003421,8.88,11.08,12.06,11.88,12.31
2023-12-13,Niedersachsen,03,00+,664,870,936,924,954,8003421,8.3,10.87,11.71,11.55,11.93
2023-12-12,Niedersachsen,03,00+,519,861,917,905,933,8003421,6.48,10.76,11.46,11.32,11.66
2023-12-11,Niedersachsen,03,00+,547,792,830,822,844,8003421,6.83,9.9,10.38,10.27,10.55
2023-12-10,Niedersachsen,03,00+,553,780,817,808,830,8003421,6.91,9.75,10.21,10.11,10.38
2023-12-09,Niedersachsen,03,00+,566,759,794,786,807,8003421,7.07,9.48,9.92,9.82,10.08
2023-12-08,Niedersachsen,03,00+,532,736,765,758,777,8003421,6.65,9.2,9.57,9.48,9.71
2023-12-07,Niedersachsen,03,00+,487,709,734,727,744,8003421,6.08,8.86,9.17,9.09,9.31
2023-12-06,Niedersachsen,03,00+,487,718,740,734,750,8003421,6.08,8.97,9.25,9.17,9.38
2023-12-05,Niedersachsen,03,00+,485,715,733,728,743,8003421,6.06,8.93,9.17,9.1,9.29
2023-12-04,Niedersachsen,03,00+,552,739,754,749,763,8003421,6.9,9.23,9.43,9.36,9.54
2023-12-03,Niedersachsen,03,00+,565,742,757,752,766,8003421,7.06,9.27,9.46,9.4,9.58
2023-12-02,Niedersachsen,03,00+,576,740,754,749,764,8003421,7.2,9.25,9.43,9.37,9.55
2023-12-01,Niedersachsen,03,00+,560,710,723,718,731,8003421,7,8.87,9.04,8.98,9.14
2023-11-30,Niedersachsen,03,00+,541,713,725,720,732,8003421,6.76,8.91,9.06,9,9.16
2023-11-29,Niedersachsen,03,00+,447,683,693,689,700,8003421,5.59,8.53,8.66,8.61,8.75
2023-11-28,Niedersachsen,03,00+,466,698,707,703,713,8003421,5.82,8.72,8.83,8.79,8.91
2023-11-27,Niedersachsen,03,00+,574,731,738,735,743,8003421,7.17,9.13,9.23,9.19,9.29
2023-11-26,Niedersachsen,03,00+,577,722,729,726,734,8003421,7.21,9.02,9.11,9.08,9.17
2023-11-25,Niedersachsen,03,00+,592,727,734,731,739,8003421,7.4,9.08,9.17,9.14,9.23
2023-11-24,Niedersachsen,03,00+,565,736,742,740,746,8003421,7.06,9.2,9.28,9.25,9.33
2023-11-23,Niedersachsen,03,00+,523,731,736,734,740,8003421,6.53,9.13,9.21,9.18,9.25
2023-11-22,Niedersachsen,03,00+,494,732,737,735,740,8003421,6.17,9.15,9.21,9.19,9.25
2023-11-21,Niedersachsen,03,00+,407,673,676,675,679,8003421,5.09,8.41,8.46,8.44,8.49
2023-11-20,Niedersachsen,03,00+,415,553,554,554,555,8003421,5.19,6.91,6.93,6.93,6.94
2023-11-19,Niedersachsen,03,00+,424,562,563,563,564,8003421,5.3,7.02,7.05,7.04,7.06
2023-11-18,Niedersachsen,03,00+,438,562,563,563,564,8003421,5.47,7.02,7.05,7.04,7.05
2023-11-17,Niedersachsen,03,00+,377,542,543,542,543,8003421,4.71,6.77,6.79,6.78,6.8
2023-11-16,Niedersachsen,03,00+,369,530,530,530,531,8003421,4.61,6.62,6.63,6.63,6.64
2023-11-15,Niedersachsen,03,00+,352,541,541,541,541,8003421,4.4,6.76,6.77,6.77,6.77
2023-11-14,Niedersachsen,03,00+,282,507,507,507,507,8003421,3.52,6.33,6.34,6.34,6.34
2023-11-13,Niedersachsen,03,00+,340,510,510,510,510,8003421,4.25,6.37,6.37,6.37,6.37
2023-11-12,Niedersachsen,03,00+,351,510,510,510,510,8003421,4.39,6.37,6.37,6.37,6.37
2023-11-11,Niedersachsen,03,00+,360,502,502,502,502,8003421,4.5,6.27,6.27,6.27,6.27
2023-11-10,Niedersachsen,03,00+,323,485,485,485,485,8003421,4.04,6.06,6.06,6.06,6.06
2023-11-09,Niedersachsen,03,00+,320,514,514,514,514,8003421,4,6.42,6.42,6.42,6.42
2023-11-08,Niedersachsen,03,00+,404,584,584,584,584,8003421,5.05,7.3,7.3,7.3,7.3
2023-11-07,Niedersachsen,03,00+,298,521,521,521,521,8003421,3.72,6.51,6.51,6.51,6.51
2023-11-06,Niedersachsen,03,00+,330,512,512,512,512,8003421,4.12,6.4,6.4,6.4,6.4
2023-11-05,Niedersachsen,03,00+,336,507,507,507,507,8003421,4.2,6.33,6.33,6.33,6.33
2023-11-04,Niedersachsen,03,00+,343,509,509,509,509,8003421,4.29,6.36,6.36,6.36,6.36
2023-11-03,Niedersachsen,03,00+,311,525,525,525,525,8003421,3.89,6.56,6.56,6.56,6.56
2023-11-02,Niedersachsen,03,00+,270,503,503,503,503,8003421,3.37,6.28,6.28,6.28,6.28
2023-11-01,Niedersachsen,03,00+,247,422,422,422,422,8003421,3.09,5.27,5.27,5.27,5.27
2023-10-31,Niedersachsen,03,00+,303,487,487,487,487,8003421,3.79,6.08,6.08,6.08,6.08
2023-10-30,Niedersachsen,03,00+,321,475,475,475,475,8003421,4.01,5.93,5.93,5.93,5.93
2023-10-29,Niedersachsen,03,00+,325,474,474,474,474,8003421,4.06,5.92,5.92,5.92,5.92
2023-10-28,Niedersachsen,03,00+,326,464,464,464,464,8003421,4.07,5.8,5.8,5.8,5.8
2023-10-27,Niedersachsen,03,00+,274,436,436,436,436,8003421,3.42,5.45,5.45,5.45,5.45
2023-10-26,Niedersachsen,03,00+,238,388,388,388,388,8003421,2.97,4.85,4.85,4.85,4.85
2023-10-25,Niedersachsen,03,00+,181,330,330,330,330,8003421,2.26,4.12,4.12,4.12,4.12
2023-10-24,Niedersachsen,03,00+,144,298,298,298,298,8003421,1.8,3.72,3.72,3.72,3.72
2023-10-23,Niedersachsen,03,00+,150,231,231,231,231,8003421,1.87,2.89,2.89,2.89,2.89
2023-10-22,Niedersachsen,03,00+,154,228,228,228,228,8003421,1.92,2.85,2.85,2.85,2.85
2023-10-21,Niedersachsen,03,00+,158,234,234,234,234,8003421,1.97,2.92,2.92,2.92,2.92
2023-10-20,Niedersachsen,03,00+,161,228,228,228,228,8003421,2.01,2.85,2.85,2.85,2.85
2023-10-19,Niedersachsen,03,00+,139,223,223,223,223,8003421,1.74,2.79,2.79,2.79,2.79
2023-10-18,Niedersachsen,03,00+,130,210,210,210,210,8003421,1.62,2.62,2.62,2.62,2.62
2023-10-17,Niedersachsen,03,00+,119,196,196,196,196,8003421,1.49,2.45,2.45,2.45,2.45
...
2023-10-12,Niedersachsen,03,00+,149,206,206,206,206,8003421,1.86,2.57,2.57,2.57,2.57
2023-10-11,Niedersachsen,03,00+,155,225,225,225,225,8003421,1.94,2.81,2.81,2.81,2.81
2023-10-10,Niedersachsen,03,00+,113,203,203,203,203,8003421,1.41,2.54,2.54,2.54,2.54
2023-10-09,Niedersachsen,03,00+,116,187,187,187,187,8003421,1.45,2.34,2.34,2.34,2.34
2023-10-08,Niedersachsen,03,00+,116,181,181,181,181,8003421,1.45,2.26,2.26,2.26,2.26
2023-10-07,Niedersachsen,03,00+,119,178,178,178,178,8003421,1.49,2.22,2.22,2.22,2.22
2023-10-06,Niedersachsen,03,00+,94,162,162,162,162,8003421,1.17,2.02,2.02,2.02,2.02
2023-10-05,Niedersachsen,03,00+,76,138,138,138,138,8003421,0.95,1.72,1.72,1.72,1.72
...
2023-09-27,Niedersachsen,03,00+,87,143,143,143,143,8003421,1.09,1.79,1.79,1.79,1.79
2023-09-26,Niedersachsen,03,00+,78,144,144,144,144,8003421,0.97,1.8,1.8,1.8,1.8
2023-09-25,Niedersachsen,03,00+,92,144,144,144,144,8003421,1.15,1.8,1.8,1.8,1.8
2023-09-24,Niedersachsen,03,00+,97,149,149,149,149,8003421,1.21,1.86,1.86,1.86,1.86
2023-09-23,Niedersachsen,03,00+,104,154,154,154,154,8003421,1.3,1.92,1.92,1.92,1.92
2023-09-22,Niedersachsen,03,00+,103,156,156,156,156,8003421,1.29,1.95,1.95,1.95,1.95
2023-09-21,Niedersachsen,03,00+,83,147,147,147,147,8003421,1.04,1.84,1.84,1.84,1.84
...
2023-03-07,Niedersachsen,03,00+,294,422,422,422,422,8003421,3.67,5.27,5.27,5.27,5.27
2023-03-06,Niedersachsen,03,00+,275,416,416,416,416,8003421,3.44,5.2,5.2,5.2,5.2
2023-03-05,Niedersachsen,03,00+,290,412,412,412,412,8003421,3.62,5.15,5.15,5.15,5.15
2023-03-04,Niedersachsen,03,00+,303,399,399,399,399,8003421,3.79,4.99,4.99,4.99,4.99
2023-03-03,Niedersachsen,03,00+,312,415,415,415,415,8003421,3.9,5.19,5.19,5.19,5.19
2023-03-02,Niedersachsen,03,00+,323,439,439,439,439,8003421,4.04,5.49,5.49,5.49,5.49
2023-03-01,Niedersachsen,03,00+,353,478,478,478,478,8003421,4.41,5.97,5.97,5.97,5.97
...
2023-12-20,Bremen,04,00+,83,83,NA,NA,NA,680130,12.2,12.2,NA,NA,NA
2023-12-19,Bremen,04,00+,64,67,NA,NA,NA,680130,9.41,9.85,NA,NA,NA
2023-12-18,Bremen,04,00+,79,85,NA,NA,NA,680130,11.62,12.5,NA,NA,NA
2023-12-17,Bremen,04,00+,79,85,99,96,104,680130,11.62,12.5,14.64,14.15,15.31
2023-12-16,Bremen,04,00+,79,85,99,96,104,680130,11.62,12.5,14.64,14.15,15.31
2023-12-15,Bremen,04,00+,83,89,100,98,103,680130,12.2,13.09,14.75,14.43,15.28
2023-12-14,Bremen,04,00+,62,85,93,91,95,680130,9.12,12.5,13.69,13.47,14.02
2023-12-13,Bremen,04,00+,91,102,109,108,111,680130,13.38,15,16.11,15.92,16.42
2023-12-12,Bremen,04,00+,72,102,108,107,109,680130,10.59,15,15.9,15.74,16.15
2023-12-11,Bremen,04,00+,85,95,99,98,101,680130,12.5,13.97,14.64,14.5,14.89
2023-12-10,Bremen,04,00+,85,95,99,98,101,680130,12.5,13.97,14.64,14.5,14.89
2023-12-09,Bremen,04,00+,85,95,99,98,101,680130,12.5,13.97,14.64,14.5,14.89
2023-12-08,Bremen,04,00+,70,85,88,87,90,680130,10.29,12.5,13.04,12.91,13.24
2023-12-07,Bremen,04,00+,60,79,82,81,83,680130,8.82,11.62,12.08,11.96,12.26
2023-12-06,Bremen,04,00+,35,59,60,60,61,680130,5.15,8.67,8.95,8.87,9.08
2023-12-05,Bremen,04,00+,55,67,68,68,69,680130,8.09,9.85,10.09,10.02,10.22
2023-12-04,Bremen,04,00+,48,57,58,57,58,680130,7.06,8.38,8.56,8.5,8.66
2023-12-03,Bremen,04,00+,48,57,58,57,58,680130,7.06,8.38,8.56,8.5,8.66
2023-12-02,Bremen,04,00+,48,57,58,57,58,680130,7.06,8.38,8.56,8.5,8.66
2023-12-01,Bremen,04,00+,45,50,50,50,51,680130,6.62,7.35,7.5,7.45,7.59
2023-11-30,Bremen,04,00+,51,58,58,58,59,680130,7.5,8.53,8.67,8.62,8.76
2023-11-29,Bremen,04,00+,42,57,57,57,58,680130,6.18,8.38,8.51,8.46,8.59
2023-11-28,Bremen,04,00+,41,49,49,49,49,680130,6.03,7.2,7.28,7.25,7.34
2023-11-27,Bremen,04,00+,48,58,58,58,58,680130,7.06,8.53,8.61,8.58,8.67
2023-11-26,Bremen,04,00+,48,58,58,58,58,680130,7.06,8.53,8.61,8.58,8.67
2023-11-25,Bremen,04,00+,48,58,58,58,58,680130,7.06,8.53,8.61,8.58,8.67
2023-11-24,Bremen,04,00+,48,58,58,58,58,680130,7.06,8.53,8.61,8.58,8.66
2023-11-23,Bremen,04,00+,41,50,50,50,50,680130,6.03,7.35,7.41,7.39,7.45
2023-11-22,Bremen,04,00+,20,47,47,47,47,680130,2.94,6.91,6.96,6.94,6.99
2023-11-21,Bremen,04,00+,39,52,52,52,52,680130,5.73,7.65,7.68,7.67,7.7
2023-11-20,Bremen,04,00+,35,63,63,63,63,680130,5.15,9.26,9.29,9.28,9.29
2023-11-19,Bremen,04,00+,35,63,63,63,63,680130,5.15,9.26,9.29,9.28,9.29
2023-11-18,Bremen,04,00+,35,66,66,66,66,680130,5.15,9.7,9.73,9.72,9.74
2023-11-17,Bremen,04,00+,45,78,78,78,78,680130,6.62,11.47,11.49,11.48,11.5
2023-11-16,Bremen,04,00+,52,88,88,88,88,680130,7.65,12.94,12.96,12.95,12.96
2023-11-15,Bremen,04,00+,68,104,104,104,104,680130,10,15.29,15.31,15.3,15.31
2023-11-14,Bremen,04,00+,56,98,98,98,98,680130,8.23,14.41,14.42,14.41,14.42
2023-11-13,Bremen,04,00+,41,91,91,91,91,680130,6.03,13.38,13.38,13.38,13.38
2023-11-12,Bremen,04,00+,41,91,91,91,91,680130,6.03,13.38,13.38,13.38,13.38
2023-11-11,Bremen,04,00+,41,88,88,88,88,680130,6.03,12.94,12.94,12.94,12.94
2023-11-10,Bremen,04,00+,50,86,86,86,86,680130,7.35,12.64,12.64,12.64,12.64
2023-11-09,Bremen,04,00+,49,97,97,97,97,680130,7.2,14.26,14.26,14.26,14.26
2023-11-08,Bremen,04,00+,67,101,101,101,101,680130,9.85,14.85,14.85,14.85,14.85
2023-11-07,Bremen,04,00+,67,84,84,84,84,680130,9.85,12.35,12.35,12.35,12.35
2023-11-06,Bremen,04,00+,69,81,81,81,81,680130,10.15,11.91,11.91,11.91,11.91
2023-11-05,Bremen,04,00+,69,81,81,81,81,680130,10.15,11.91,11.91,11.91,11.91
2023-11-04,Bremen,04,00+,69,81,81,81,81,680130,10.15,11.91,11.91,11.91,11.91
2023-11-03,Bremen,04,00+,45,83,83,83,83,680130,6.62,12.2,12.2,12.2,12.2
2023-11-02,Bremen,04,00+,47,57,57,57,57,680130,6.91,8.38,8.38,8.38,8.38
2023-11-01,Bremen,04,00+,25,35,35,35,35,680130,3.68,5.15,5.15,5.15,5.15
2023-10-31,Bremen,04,00+,31,41,41,41,41,680130,4.56,6.03,6.03,6.03,6.03
2023-10-30,Bremen,04,00+,26,34,34,34,34,680130,3.82,5,5,5,5
2023-10-29,Bremen,04,00+,26,34,34,34,34,680130,3.82,5,5,5,5
2023-10-28,Bremen,04,00+,26,34,34,34,34,680130,3.82,5,5,5,5
2023-10-27,Bremen,04,00+,22,22,22,22,22,680130,3.23,3.23,3.23,3.23,3.23
2023-10-26,Bremen,04,00+,16,20,20,20,20,680130,2.35,2.94,2.94,2.94,2.94
2023-10-25,Bremen,04,00+,21,22,22,22,22,680130,3.09,3.23,3.23,3.23,3.23
2023-10-24,Bremen,04,00+,14,17,17,17,17,680130,2.06,2.5,2.5,2.5,2.5
...
2023-09-27,Bremen,04,00+,22,28,28,28,28,680130,3.23,4.12,4.12,4.12,4.12
2023-09-26,Bremen,04,00+,16,21,21,21,21,680130,2.35,3.09,3.09,3.09,3.09
2023-09-25,Bremen,04,00+,16,25,25,25,25,680130,2.35,3.68,3.68,3.68,3.68
2023-09-24,Bremen,04,00+,16,25,25,25,25,680130,2.35,3.68,3.68,3.68,3.68
2023-09-23,Bremen,04,00+,16,25,25,25,25,680130,2.35,3.68,3.68,3.68,3.68
2023-09-22,Bremen,04,00+,22,25,25,25,25,680130,3.23,3.68,3.68,3.68,3.68
2023-09-21,Bremen,04,00+,16,23,23,23,23,680130,2.35,3.38,3.38,3.38,3.38
...
2023-09-08,Bremen,04,00+,37,46,46,46,46,680130,5.44,6.76,6.76,6.76,6.76
2023-09-07,Bremen,04,00+,21,30,30,30,30,680130,3.09,4.41,4.41,4.41,4.41
2023-09-06,Bremen,04,00+,38,45,45,45,45,680130,5.59,6.62,6.62,6.62,6.62
2023-09-05,Bremen,04,00+,46,48,48,48,48,680130,6.76,7.06,7.06,7.06,7.06
2023-09-04,Bremen,04,00+,54,57,57,57,57,680130,7.94,8.38,8.38,8.38,8.38
2023-09-03,Bremen,04,00+,54,57,57,57,57,680130,7.94,8.38,8.38,8.38,8.38
2023-09-02,Bremen,04,00+,54,57,57,57,57,680130,7.94,8.38,8.38,8.38,8.38
...
2023-12-20,Nordrhein-Westfalen,05,00+,1325,1325,NA,NA,NA,17925570,7.39,7.39,NA,NA,NA
2023-12-19,Nordrhein-Westfalen,05,00+,1247,1519,NA,NA,NA,17925570,6.96,8.47,NA,NA,NA
2023-12-18,Nordrhein-Westfalen,05,00+,1418,1660,NA,NA,NA,17925570,7.91,9.26,NA,NA,NA
2023-12-17,Nordrhein-Westfalen,05,00+,1427,1663,1930,1887,1975,17925570,7.96,9.28,10.77,10.53,11.02
2023-12-16,Nordrhein-Westfalen,05,00+,1462,1674,1922,1887,1960,17925570,8.16,9.34,10.72,10.53,10.94
2023-12-15,Nordrhein-Westfalen,05,00+,1354,1709,1915,1883,1951,17925570,7.55,9.53,10.68,10.51,10.88
2023-12-14,Nordrhein-Westfalen,05,00+,1360,1742,1917,1888,1952,17925570,7.59,9.72,10.7,10.53,10.89
2023-12-13,Nordrhein-Westfalen,05,00+,1289,1731,1873,1847,1908,17925570,7.19,9.66,10.45,10.3,10.64
2023-12-12,Nordrhein-Westfalen,05,00+,1160,1708,1822,1799,1856,17925570,6.47,9.53,10.17,10.04,10.36
2023-12-11,Nordrhein-Westfalen,05,00+,1166,1557,1631,1614,1658,17925570,6.5,8.69,9.1,9.01,9.25
2023-12-10,Nordrhein-Westfalen,05,00+,1173,1556,1629,1613,1656,17925570,6.54,8.68,9.09,9,9.24
2023-12-09,Nordrhein-Westfalen,05,00+,1211,1560,1632,1616,1658,17925570,6.76,8.7,9.11,9.02,9.25
2023-12-08,Nordrhein-Westfalen,05,00+,1106,1536,1599,1583,1623,17925570,6.17,8.57,8.92,8.84,9.06
2023-12-07,Nordrhein-Westfalen,05,00+,1012,1470,1522,1508,1545,17925570,5.65,8.2,8.49,8.42,8.62
2023-12-06,Nordrhein-Westfalen,05,00+,962,1480,1525,1512,1547,17925570,5.37,8.26,8.51,8.44,8.63
2023-12-05,Nordrhein-Westfalen,05,00+,895,1463,1501,1489,1521,17925570,4.99,8.16,8.38,8.31,8.49
2023-12-04,Nordrhein-Westfalen,05,00+,1134,1550,1582,1571,1601,17925570,6.33,8.65,8.83,8.77,8.94
2023-12-03,Nordrhein-Westfalen,05,00+,1150,1558,1590,1579,1609,17925570,6.42,8.69,8.87,8.81,8.98
2023-12-02,Nordrhein-Westfalen,05,00+,1161,1535,1566,1555,1585,17925570,6.48,8.56,8.74,8.68,8.85
2023-12-01,Nordrhein-Westfalen,05,00+,1085,1541,1569,1559,1588,17925570,6.05,8.6,8.76,8.7,8.86
2023-11-30,Nordrhein-Westfalen,05,00+,1006,1560,1586,1576,1603,17925570,5.61,8.7,8.85,8.79,8.95
2023-11-29,Nordrhein-Westfalen,05,00+,1032,1551,1573,1565,1589,17925570,5.76,8.65,8.78,8.73,8.87
2023-11-28,Nordrhein-Westfalen,05,00+,1037,1606,1626,1618,1640,17925570,5.79,8.96,9.07,9.03,9.15
2023-11-27,Nordrhein-Westfalen,05,00+,1286,1690,1707,1700,1719,17925570,7.17,9.43,9.52,9.49,9.59
2023-11-26,Nordrhein-Westfalen,05,00+,1303,1694,1710,1704,1722,17925570,7.27,9.45,9.54,9.51,9.61
2023-11-25,Nordrhein-Westfalen,05,00+,1326,1707,1723,1717,1735,17925570,7.4,9.52,9.62,9.58,9.68
2023-11-24,Nordrhein-Westfalen,05,00+,1196,1730,1745,1739,1755,17925570,6.67,9.65,9.74,9.7,9.79
2023-11-23,Nordrhein-Westfalen,05,00+,1259,1791,1804,1799,1813,17925570,7.02,9.99,10.07,10.04,10.12
2023-11-22,Nordrhein-Westfalen,05,00+,1107,1726,1737,1733,1744,17925570,6.18,9.63,9.69,9.67,9.73
2023-11-21,Nordrhein-Westfalen,05,00+,990,1683,1692,1689,1697,17925570,5.52,9.39,9.44,9.42,9.47
2023-11-20,Nordrhein-Westfalen,05,00+,1099,1600,1605,1603,1607,17925570,6.13,8.93,8.96,8.95,8.97
2023-11-19,Nordrhein-Westfalen,05,00+,1113,1596,1601,1599,1603,17925570,6.21,8.9,8.93,8.92,8.95
2023-11-18,Nordrhein-Westfalen,05,00+,1133,1592,1597,1595,1599,17925570,6.32,8.88,8.91,8.9,8.92
2023-11-17,Nordrhein-Westfalen,05,00+,1045,1537,1540,1539,1542,17925570,5.83,8.57,8.6,8.59,8.6
2023-11-16,Nordrhein-Westfalen,05,00+,959,1480,1482,1481,1483,17925570,5.35,8.26,8.27,8.27,8.28
2023-11-15,Nordrhein-Westfalen,05,00+,935,1559,1560,1560,1561,17925570,5.22,8.7,8.71,8.7,8.71
2023-11-14,Nordrhein-Westfalen,05,00+,840,1452,1453,1452,1453,17925570,4.69,8.1,8.11,8.1,8.11
2023-11-13,Nordrhein-Westfalen,05,00+,1087,1491,1491,1491,1491,17925570,6.06,8.32,8.32,8.32,8.32
2023-11-12,Nordrhein-Westfalen,05,00+,1107,1495,1495,1495,1495,17925570,6.18,8.34,8.34,8.34,8.34
2023-11-11,Nordrhein-Westfalen,05,00+,1132,1497,1497,1497,1497,17925570,6.32,8.35,8.35,8.35,8.35
2023-11-10,Nordrhein-Westfalen,05,00+,1116,1551,1551,1551,1551,17925570,6.23,8.65,8.65,8.65,8.65
2023-11-09,Nordrhein-Westfalen,05,00+,1107,1652,1652,1652,1652,17925570,6.18,9.22,9.22,9.22,9.22
2023-11-08,Nordrhein-Westfalen,05,00+,901,1379,1379,1379,1379,17925570,5.03,7.69,7.69,7.69,7.69
2023-11-07,Nordrhein-Westfalen,05,00+,884,1450,1450,1450,1450,17925570,4.93,8.09,8.09,8.09,8.09
2023-11-06,Nordrhein-Westfalen,05,00+,882,1341,1341,1341,1341,17925570,4.92,7.48,7.48,7.48,7.48
2023-11-05,Nordrhein-Westfalen,05,00+,898,1339,1339,1339,1339,17925570,5.01,7.47,7.47,7.47,7.47
2023-11-04,Nordrhein-Westfalen,05,00+,914,1332,1332,1332,1332,17925570,5.1,7.43,7.43,7.43,7.43
2023-11-03,Nordrhein-Westfalen,05,00+,728,1248,1248,1248,1248,17925570,4.06,6.96,6.96,6.96,6.96
2023-11-02,Nordrhein-Westfalen,05,00+,687,1126,1126,1126,1126,17925570,3.83,6.28,6.28,6.28,6.28
2023-11-01,Nordrhein-Westfalen,05,00+,840,1278,1278,1278,1278,17925570,4.69,7.13,7.13,7.13,7.13
2023-10-31,Nordrhein-Westfalen,05,00+,800,1236,1236,1236,1236,17925570,4.46,6.9,6.9,6.9,6.9
2023-10-30,Nordrhein-Westfalen,05,00+,853,1149,1149,1149,1149,17925570,4.76,6.41,6.41,6.41,6.41
2023-10-29,Nordrhein-Westfalen,05,00+,873,1151,1151,1151,1151,17925570,4.87,6.42,6.42,6.42,6.42
2023-10-28,Nordrhein-Westfalen,05,00+,897,1159,1159,1159,1159,17925570,5,6.47,6.47,6.47,6.47
2023-10-27,Nordrhein-Westfalen,05,00+,784,1108,1108,1108,1108,17925570,4.37,6.18,6.18,6.18,6.18
2023-10-26,Nordrhein-Westfalen,05,00+,735,1043,1043,1043,1043,17925570,4.1,5.82,5.82,5.82,5.82
2023-10-25,Nordrhein-Westfalen,05,00+,615,962,962,962,962,17925570,3.43,5.37,5.37,5.37,5.37
2023-10-24,Nordrhein-Westfalen,05,00+,480,840,840,840,840,17925570,2.68,4.69,4.69,4.69,4.69
2023-10-23,Nordrhein-Westfalen,05,00+,509,723,723,723,723,17925570,2.84,4.03,4.03,4.03,4.03
2023-10-22,Nordrhein-Westfalen,05,00+,524,716,716,716,716,17925570,2.92,3.99,3.99,3.99,3.99
2023-10-21,Nordrhein-Westfalen,05,00+,536,701,701,701,701,17925570,2.99,3.91,3.91,3.91,3.91
2023-10-20,Nordrhein-Westfalen,05,00+,524,691,691,691,691,17925570,2.92,3.85,3.85,3.85,3.85
2023-10-19,Nordrhein-Westfalen,05,00+,492,632,632,632,632,17925570,2.74,3.53,3.53,3.53,3.53
2023-10-18,Nordrhein-Westfalen,05,00+,460,637,637,637,637,17925570,2.57,3.55,3.55,3.55,3.55
2023-10-17,Nordrhein-Westfalen,05,00+,429,660,660,660,660,17925570,2.39,3.68,3.68,3.68,3.68
2023-10-16,Nordrhein-Westfalen,05,00+,447,639,639,639,639,17925570,2.49,3.56,3.56,3.56,3.56
2023-10-15,Nordrhein-Westfalen,05,00+,455,635,635,635,635,17925570,2.54,3.54,3.54,3.54,3.54
2023-10-14,Nordrhein-Westfalen,05,00+,466,633,633,633,633,17925570,2.6,3.53,3.53,3.53,3.53
2023-10-13,Nordrhein-Westfalen,05,00+,431,614,614,614,614,17925570,2.4,3.43,3.43,3.43,3.43
2023-10-12,Nordrhein-Westfalen,05,00+,421,612,612,612,612,17925570,2.35,3.41,3.41,3.41,3.41
2023-10-11,Nordrhein-Westfalen,05,00+,485,700,700,700,700,17925570,2.71,3.91,3.91,3.91,3.91
2023-10-10,Nordrhein-Westfalen,05,00+,373,570,570,570,570,17925570,2.08,3.18,3.18,3.18,3.18
2023-10-09,Nordrhein-Westfalen,05,00+,356,519,519,519,519,17925570,1.99,2.9,2.9,2.9,2.9
2023-10-08,Nordrhein-Westfalen,05,00+,360,512,512,512,512,17925570,2.01,2.86,2.86,2.86,2.86
2023-10-07,Nordrhein-Westfalen,05,00+,364,507,507,507,507,17925570,2.03,2.83,2.83,2.83,2.83
2023-10-06,Nordrhein-Westfalen,05,00+,358,481,481,481,481,17925570,2,2.68,2.68,2.68,2.68
2023-10-05,Nordrhein-Westfalen,05,00+,275,463,463,463,463,17925570,1.53,2.58,2.58,2.58,2.58
2023-10-04,Nordrhein-Westfalen,05,00+,211,345,345,345,345,17925570,1.18,1.92,1.92,1.92,1.92
2023-10-03,Nordrhein-Westfalen,05,00+,284,425,425,425,425,17925570,1.58,2.37,2.37,2.37,2.37
2023-10-02,Nordrhein-Westfalen,05,00+,294,410,410,410,410,17925570,1.64,2.29,2.29,2.29,2.29
2023-10-01,Nordrhein-Westfalen,05,00+,296,408,408,408,408,17925570,1.65,2.28,2.28,2.28,2.28
2023-09-30,Nordrhein-Westfalen,05,00+,300,406,406,406,406,17925570,1.67,2.26,2.26,2.26,2.26
2023-09-29,Nordrhein-Westfalen,05,00+,295,415,415,415,415,17925570,1.65,2.32,2.32,2.32,2.32
2023-09-28,Nordrhein-Westfalen,05,00+,279,397,397,397,397,17925570,1.56,2.21,2.21,2.21,2.21
2023-09-27,Nordrhein-Westfalen,05,00+,282,407,407,407,407,17925570,1.57,2.27,2.27,2.27,2.27
2023-09-26,Nordrhein-Westfalen,05,00+,280,409,409,409,409,17925570,1.56,2.28,2.28,2.28,2.28
2023-09-25,Nordrhein-Westfalen,05,00+,314,420,420,420,420,17925570,1.75,2.34,2.34,2.34,2.34
2023-09-24,Nordrhein-Westfalen,05,00+,320,425,425,425,425,17925570,1.79,2.37,2.37,2.37,2.37
2023-09-23,Nordrhein-Westfalen,05,00+,328,431,431,431,431,17925570,1.83,2.4,2.4,2.4,2.4
2023-09-22,Nordrhein-Westfalen,05,00+,315,412,412,412,412,17925570,1.76,2.3,2.3,2.3,2.3
2023-09-21,Nordrhein-Westfalen,05,00+,306,421,421,421,421,17925570,1.71,2.35,2.35,2.35,2.35
2023-09-20,Nordrhein-Westfalen,05,00+,294,416,416,416,416,17925570,1.64,2.32,2.32,2.32,2.32
2023-09-19,Nordrhein-Westfalen,05,00+,309,444,444,444,444,17925570,1.72,2.48,2.48,2.48,2.48
2023-09-18,Nordrhein-Westfalen,05,00+,350,480,480,480,480,17925570,1.95,2.68,2.68,2.68,2.68
2023-09-17,Nordrhein-Westfalen,05,00+,357,482,482,482,482,17925570,1.99,2.69,2.69,2.69,2.69
2023-09-16,Nordrhein-Westfalen,05,00+,363,479,479,479,479,17925570,2.03,2.67,2.67,2.67,2.67
2023-09-15,Nordrhein-Westfalen,05,00+,392,512,512,512,512,17925570,2.19,2.86,2.86,2.86,2.86
2023-09-14,Nordrhein-Westfalen,05,00+,407,540,540,540,540,17925570,2.27,3.01,3.01,3.01,3.01
2023-09-13,Nordrhein-Westfalen,05,00+,419,591,591,591,591,17925570,2.34,3.3,3.3,3.3,3.3
2023-09-12,Nordrhein-Westfalen,05,00+,398,595,595,595,595,17925570,2.22,3.32,3.32,3.32,3.32
2023-09-11,Nordrhein-Westfalen,05,00+,426,567,567,567,567,17925570,2.38,3.16,3.16,3.16,3.16
2023-09-10,Nordrhein-Westfalen,05,00+,435,566,566,566,566,17925570,2.43,3.16,3.16,3.16,3.16
2023-09-09,Nordrhein-Westfalen,05,00+,444,569,569,569,569,17925570,2.48,3.17,3.17,3.17,3.17
2023-09-08,Nordrhein-Westfalen,05,00+,433,569,569,569,569,17925570,2.42,3.17,3.17,3.17,3.17
2023-09-07,Nordrhein-Westfalen,05,00+,402,568,568,568,568,17925570,2.24,3.17,3.17,3.17,3.17
2023-09-06,Nordrhein-Westfalen,05,00+,378,526,526,526,526,17925570,2.11,2.93,2.93,2.93,2.93
2023-09-05,Nordrhein-Westfalen,05,00+,342,500,500,500,500,17925570,1.91,2.79,2.79,2.79,2.79
2023-09-04,Nordrhein-Westfalen,05,00+,360,501,501,501,501,17925570,2.01,2.79,2.79,2.79,2.79
2023-09-03,Nordrhein-Westfalen,05,00+,364,498,498,498,498,17925570,2.03,2.78,2.78,2.78,2.78
2023-09-02,Nordrhein-Westfalen,05,00+,375,503,503,503,503,17925570,2.09,2.81,2.81,2.81,2.81
2023-09-01,Nordrhein-Westfalen,05,00+,335,491,491,491,491,17925570,1.87,2.74,2.74,2.74,2.74
2023-08-31,Nordrhein-Westfalen,05,00+,340,480,480,480,480,17925570,1.9,2.68,2.68,2.68,2.68
2023-08-30,Nordrhein-Westfalen,05,00+,328,492,492,492,492,17925570,1.83,2.74,2.74,2.74,2.74
2023-08-29,Nordrhein-Westfalen,05,00+,306,490,490,490,490,17925570,1.71,2.73,2.73,2.73,2.73
2023-08-28,Nordrhein-Westfalen,05,00+,0,509,509,509,509,17925570,0,2.84,2.84,2.84,2.84
2023-08-27,Nordrhein-Westfalen,05,00+,0,510,510,510,510,17925570,0,2.85,2.85,2.85,2.85
2023-08-26,Nordrhein-Westfalen,05,00+,0,504,504,504,504,17925570,0,2.81,2.81,2.81,2.81
2023-08-25,Nordrhein-Westfalen,05,00+,0,497,497,497,497,17925570,0,2.77,2.77,2.77,2.77
2023-08-24,Nordrhein-Westfalen,05,00+,369,493,493,493,493,17925570,2.06,2.75,2.75,2.75,2.75
2023-08-23,Nordrhein-Westfalen,05,00+,353,473,473,473,473,17925570,1.97,2.64,2.64,2.64,2.64
2023-08-22,Nordrhein-Westfalen,05,00+,268,454,454,454,454,17925570,1.5,2.53,2.53,2.53,2.53
2023-08-21,Nordrhein-Westfalen,05,00+,250,380,380,380,380,17925570,1.39,2.12,2.12,2.12,2.12
2023-08-20,Nordrhein-Westfalen,05,00+,257,381,381,381,381,17925570,1.43,2.13,2.13,2.13,2.13
2023-08-19,Nordrhein-Westfalen,05,00+,264,379,379,379,379,17925570,1.47,2.11,2.11,2.11,2.11
2023-08-18,Nordrhein-Westfalen,05,00+,269,376,376,376,376,17925570,1.5,2.1,2.1,2.1,2.1
2023-08-17,Nordrhein-Westfalen,05,00+,241,344,344,344,344,17925570,1.34,1.92,1.92,1.92,1.92
2023-08-16,Nordrhein-Westfalen,05,00+,211,310,310,310,310,17925570,1.18,1.73,1.73,1.73,1.73
2023-08-15,Nordrhein-Westfalen,05,00+,156,287,287,287,287,17925570,0.87,1.6,1.6,1.6,1.6
2023-08-14,Nordrhein-Westfalen,05,00+,159,254,254,254,254,17925570,0.89,1.42,1.42,1.42,1.42
2023-08-13,Nordrhein-Westfalen,05,00+,160,248,248,248,248,17925570,0.89,1.38,1.38,1.38,1.38
2023-08-12,Nordrhein-Westfalen,05,00+,164,245,245,245,245,17925570,0.91,1.37,1.37,1.37,1.37
2023-08-11,Nordrhein-Westfalen,05,00+,132,204,204,204,204,17925570,0.74,1.14,1.14,1.14,1.14
2023-08-10,Nordrhein-Westfalen,05,00+,117,185,185,185,185,17925570,0.65,1.03,1.03,1.03,1.03
2023-08-09,Nordrhein-Westfalen,05,00+,115,169,169,169,169,17925570,0.64,0.94,0.94,0.94,0.94
2023-08-08,Nordrhein-Westfalen,05,00+,107,153,153,153,153,17925570,0.6,0.85,0.85,0.85,0.85
2023-08-07,Nordrhein-Westfalen,05,00+,94,133,133,133,133,17925570,0.52,0.74,0.74,0.74,0.74
2023-08-06,Nordrhein-Westfalen,05,00+,96,135,135,135,135,17925570,0.54,0.75,0.75,0.75,0.75
2023-08-05,Nordrhein-Westfalen,05,00+,98,136,136,136,136,17925570,0.55,0.76,0.76,0.76,0.76
2023-08-04,Nordrhein-Westfalen,05,00+,97,129,129,129,129,17925570,0.54,0.72,0.72,0.72,0.72
2023-08-03,Nordrhein-Westfalen,05,00+,86,118,118,118,118,17925570,0.48,0.66,0.66,0.66,0.66
2023-08-02,Nordrhein-Westfalen,05,00+,71,109,109,109,109,17925570,0.4,0.61,0.61,0.61,0.61
...
2023-05-26,Nordrhein-Westfalen,05,00+,232,283,283,283,283,17925570,1.29,1.58,1.58,1.58,1.58
2023-05-25,Nordrhein-Westfalen,05,00+,180,261,261,261,261,17925570,1,1.46,1.46,1.46,1.46
2023-05-24,Nordrhein-Westfalen,05,00+,172,245,245,245,245,17925570,0.96,1.37,1.37,1.37,1.37
2023-05-23,Nordrhein-Westfalen,05,00+,160,256,256,256,256,17925570,0.89,1.43,1.43,1.43,1.43
2023-05-22,Nordrhein-Westfalen,05,00+,155,250,250,250,250,17925570,0.86,1.39,1.39,1.39,1.39
2023-05-21,Nordrhein-Westfalen,05,00+,162,256,256,256,256,17925570,0.9,1.43,1.43,1.43,1.43
2023-05-20,Nordrhein-Westfalen,05,00+,172,255,255,255,255,17925570,0.96,1.42,1.42,1.42,1.42
2023-05-19,Nordrhein-Westfalen,05,00+,179,267,267,267,267,17925570,1,1.49,1.49,1.49,1.49
2023-05-18,Nordrhein-Westfalen,05,00+,230,316,316,316,316,17925570,1.28,1.76,1.76,1.76,1.76
...
2023-05-11,Nordrhein-Westfalen,05,00+,347,492,492,492,492,17925570,1.94,2.74,2.74,2.74,2.74
2023-05-10,Nordrhein-Westfalen,05,00+,318,515,515,515,515,17925570,1.77,2.87,2.87,2.87,2.87
2023-05-09,Nordrhein-Westfalen,05,00+,383,569,569,569,569,17925570,2.14,3.17,3.17,3.17,3.17
2023-05-08,Nordrhein-Westfalen,05,00+,302,452,452,452,452,17925570,1.68,2.52,2.52,2.52,2.52
2023-05-07,Nordrhein-Westfalen,05,00+,325,469,469,469,469,17925570,1.81,2.62,2.62,2.62,2.62
2023-05-06,Nordrhein-Westfalen,05,00+,342,466,466,466,466,17925570,1.91,2.6,2.6,2.6,2.6
2023-05-05,Nordrhein-Westfalen,05,00+,335,457,457,457,457,17925570,1.87,2.55,2.55,2.55,2.55
...
2023-04-10,Nordrhein-Westfalen,05,00+,494,812,812,812,812,17925570,2.76,4.53,4.53,4.53,4.53
2023-04-09,Nordrhein-Westfalen,05,00+,521,810,810,810,810,17925570,2.91,4.52,4.52,4.52,4.52
2023-04-08,Nordrhein-Westfalen,05,00+,555,816,816,816,816,17925570,3.1,4.55,4.55,4.55,4.55
2023-04-07,Nordrhein-Westfalen,05,00+,710,977,977,977,977,17925570,3.96,5.45,5.45,5.45,5.45
2023-04-06,Nordrhein-Westfalen,05,00+,749,1057,1057,1057,1057,17925570,4.18,5.9,5.9,5.9,5.9
2023-04-05,Nordrhein-Westfalen,05,00+,753,1134,1134,1134,1134,17925570,4.2,6.33,6.33,6.33,6.33
2023-04-04,Nordrhein-Westfalen,05,00+,752,1173,1173,1173,1173,17925570,4.2,6.54,6.54,6.54,6.54
...
2023-03-29,Nordrhein-Westfalen,05,00+,973,1488,1488,1488,1488,17925570,5.43,8.3,8.3,8.3,8.3
2023-03-28,Nordrhein-Westfalen,05,00+,942,1587,1587,1587,1587,17925570,5.26,8.85,8.85,8.85,8.85
2023-03-27,Nordrhein-Westfalen,05,00+,1184,1753,1753,1753,1753,17925570,6.61,9.78,9.78,9.78,9.78
2023-03-26,Nordrhein-Westfalen,05,00+,1263,1791,1791,1791,1791,17925570,7.05,9.99,9.99,9.99,9.99
2023-03-25,Nordrhein-Westfalen,05,00+,1360,1856,1856,1856,1856,17925570,7.59,10.35,10.35,10.35,10.35
2023-03-24,Nordrhein-Westfalen,05,00+,1294,1905,1905,1905,1905,17925570,7.22,10.63,10.63,10.63,10.63
2023-03-23,Nordrhein-Westfalen,05,00+,1342,1986,1986,1986,1986,17925570,7.49,11.08,11.08,11.08,11.08
...
2023-03-07,Nordrhein-Westfalen,05,00+,1303,2182,2182,2182,2182,17925570,7.27,12.17,12.17,12.17,12.17
2023-03-06,Nordrhein-Westfalen,05,00+,1422,2263,2263,2263,2263,17925570,7.93,12.62,12.62,12.62,12.62
2023-03-05,Nordrhein-Westfalen,05,00+,1553,2318,2318,2318,2318,17925570,8.66,12.93,12.93,12.93,12.93
2023-03-04,Nordrhein-Westfalen,05,00+,1687,2382,2382,2382,2382,17925570,9.41,13.29,13.29,13.29,13.29
2023-03-03,Nordrhein-Westfalen,05,00+,1682,2443,2443,2443,2443,17925570,9.38,13.63,13.63,13.63,13.63
2023-03-02,Nordrhein-Westfalen,05,00+,1589,2527,2527,2527,2527,17925570,8.86,14.1,14.1,14.1,14.1
2023-03-01,Nordrhein-Westfalen,05,00+,1528,2576,2576,2576,2576,17925570,8.52,14.37,14.37,14.37,14.37
2023-02-28,Nordrhein-Westfalen,05,00+,1720,2803,2803,2803,2803,17925570,9.6,15.64,15.64,15.64,15.64
...
2023-02-20,Nordrhein-Westfalen,05,00+,1565,2461,2461,2461,2461,17925570,8.73,13.73,13.73,13.73,13.73
2023-02-19,Nordrhein-Westfalen,05,00+,1675,2442,2442,2442,2442,17925570,9.34,13.62,13.62,13.62,13.62
2023-02-18,Nordrhein-Westfalen,05,00+,1786,2443,2443,2443,2443,17925570,9.96,13.63,13.63,13.63,13.63
2023-02-17,Nordrhein-Westfalen,05,00+,1682,2398,2398,2398,2398,17925570,9.38,13.38,13.38,13.38,13.38
2023-02-16,Nordrhein-Westfalen,05,00+,1509,2403,2403,2403,2403,17925570,8.42,13.41,13.41,13.41,13.41
2023-02-15,Nordrhein-Westfalen,05,00+,1410,2295,2295,2295,2295,17925570,7.87,12.8,12.8,12.8,12.8
2023-02-14,Nordrhein-Westfalen,05,00+,1199,2161,2161,2161,2161,17925570,6.69,12.06,12.06,12.06,12.06
...
2023-02-09,Nordrhein-Westfalen,05,00+,1309,1907,1907,1907,1907,17925570,7.3,10.64,10.64,10.64,10.64
2023-02-08,Nordrhein-Westfalen,05,00+,1192,1833,1833,1833,1833,17925570,6.65,10.23,10.23,10.23,10.23
2023-02-07,Nordrhein-Westfalen,05,00+,1079,1776,1776,1776,1776,17925570,6.02,9.91,9.91,9.91,9.91
2023-02-06,Nordrhein-Westfalen,05,00+,1038,1661,1661,1661,1661,17925570,5.79,9.27,9.27,9.27,9.27
2023-02-05,Nordrhein-Westfalen,05,00+,1113,1645,1645,1645,1645,17925570,6.21,9.18,9.18,9.18,9.18
2023-02-04,Nordrhein-Westfalen,05,00+,1178,1615,1615,1615,1615,17925570,6.57,9.01,9.01,9.01,9.01
2023-02-03,Nordrhein-Westfalen,05,00+,1092,1512,1512,1512,1512,17925570,6.09,8.43,8.43,8.43,8.43
2023-02-02,Nordrhein-Westfalen,05,00+,1061,1462,1462,1462,1462,17925570,5.92,8.16,8.16,8.16,8.16
2023-02-01,Nordrhein-Westfalen,05,00+,974,1384,1384,1384,1384,17925570,5.43,7.72,7.72,7.72,7.72
2023-01-31,Nordrhein-Westfalen,05,00+,879,1319,1319,1319,1319,17925570,4.9,7.36,7.36,7.36,7.36
2023-01-30,Nordrhein-Westfalen,05,00+,820,1291,1291,1291,1291,17925570,4.57,7.2,7.2,7.2,7.2
2023-01-29,Nordrhein-Westfalen,05,00+,876,1271,1271,1271,1271,17925570,4.89,7.09,7.09,7.09,7.09
2023-01-28,Nordrhein-Westfalen,05,00+,916,1248,1248,1248,1248,17925570,5.11,6.96,6.96,6.96,6.96
2023-01-27,Nordrhein-Westfalen,05,00+,846,1189,1189,1189,1189,17925570,4.72,6.63,6.63,6.63,6.63
2023-01-26,Nordrhein-Westfalen,05,00+,785,1133,1133,1133,1133,17925570,4.38,6.32,6.32,6.32,6.32
2023-01-25,Nordrhein-Westfalen,05,00+,787,1133,1133,1133,1133,17925570,4.39,6.32,6.32,6.32,6.32
2023-01-24,Nordrhein-Westfalen,05,00+,743,1108,1108,1108,1108,17925570,4.14,6.18,6.18,6.18,6.18
2023-01-23,Nordrhein-Westfalen,05,00+,786,1154,1154,1154,1154,17925570,4.38,6.44,6.44,6.44,6.44
2023-01-22,Nordrhein-Westfalen,05,00+,829,1144,1144,1144,1144,17925570,4.62,6.38,6.38,6.38,6.38
2023-01-21,Nordrhein-Westfalen,05,00+,883,1164,1164,1164,1164,17925570,4.93,6.49,6.49,6.49,6.49
...
2023-12-20,Hessen,06,00+,483,483,NA,NA,NA,6293154,7.68,7.68,NA,NA,NA
2023-12-19,Hessen,06,00+,512,565,NA,NA,NA,6293154,8.14,8.98,NA,NA,NA
2023-12-18,Hessen,06,00+,556,665,NA,NA,NA,6293154,8.83,10.57,NA,NA,NA
2023-12-17,Hessen,06,00+,566,668,786,764,806,6293154,8.99,10.61,12.5,12.14,12.81
2023-12-16,Hessen,06,00+,570,661,769,748,785,6293154,9.06,10.5,12.23,11.9,12.49
2023-12-15,Hessen,06,00+,544,657,744,728,761,6293154,8.64,10.44,11.83,11.57,12.09
2023-12-14,Hessen,06,00+,516,642,712,699,726,6293154,8.2,10.2,11.32,11.11,11.55
2023-12-13,Hessen,06,00+,475,636,692,680,705,6293154,7.55,10.11,11,10.82,11.21
2023-12-12,Hessen,06,00+,446,614,655,647,668,6293154,7.09,9.76,10.42,10.28,10.62
2023-12-11,Hessen,06,00+,404,561,586,580,596,6293154,6.42,8.91,9.33,9.23,9.48
2023-12-10,Hessen,06,00+,408,556,581,575,590,6293154,6.48,8.83,9.24,9.14,9.39
2023-12-09,Hessen,06,00+,410,555,580,574,589,6293154,6.52,8.82,9.22,9.12,9.37
2023-12-08,Hessen,06,00+,423,557,579,573,588,6293154,6.72,8.85,9.21,9.12,9.35
2023-12-07,Hessen,06,00+,415,547,566,561,575,6293154,6.59,8.69,9.01,8.92,9.14
2023-12-06,Hessen,06,00+,404,542,559,554,567,6293154,6.42,8.61,8.89,8.81,9.01
2023-12-05,Hessen,06,00+,343,511,524,520,531,6293154,5.45,8.12,8.34,8.27,8.45
2023-12-04,Hessen,06,00+,367,496,506,502,512,6293154,5.83,7.88,8.05,7.99,8.15
2023-12-03,Hessen,06,00+,367,491,501,497,507,6293154,5.83,7.8,7.96,7.91,8.06
2023-12-02,Hessen,06,00+,373,493,503,499,509,6293154,5.93,7.83,8,7.94,8.09
2023-12-01,Hessen,06,00+,348,487,496,492,501,6293154,5.53,7.74,7.88,7.83,7.98
2023-11-30,Hessen,06,00+,306,480,488,485,493,6293154,4.86,7.63,7.76,7.71,7.84
2023-11-29,Hessen,06,00+,338,504,511,508,516,6293154,5.37,8.01,8.13,8.08,8.2
2023-11-28,Hessen,06,00+,337,520,526,524,531,6293154,5.36,8.26,8.37,8.33,8.44
2023-11-27,Hessen,06,00+,366,530,535,533,538,6293154,5.82,8.42,8.51,8.47,8.56
2023-11-26,Hessen,06,00+,377,543,548,546,552,6293154,5.99,8.63,8.71,8.68,8.77
2023-11-25,Hessen,06,00+,382,543,548,546,552,6293154,6.07,8.63,8.71,8.68,8.77
2023-11-24,Hessen,06,00+,377,532,536,534,539,6293154,5.99,8.45,8.53,8.5,8.58
2023-11-23,Hessen,06,00+,368,541,545,543,548,6293154,5.85,8.6,8.67,8.64,8.71
2023-11-22,Hessen,06,00+,363,518,521,520,523,6293154,5.77,8.23,8.29,8.27,8.32
2023-11-21,Hessen,06,00+,314,482,484,483,486,6293154,4.99,7.66,7.7,7.69,7.73
2023-11-20,Hessen,06,00+,278,444,445,445,446,6293154,4.42,7.06,7.08,7.07,7.09
2023-11-19,Hessen,06,00+,286,440,441,441,442,6293154,4.54,6.99,7.01,7.01,7.02
2023-11-18,Hessen,06,00+,293,441,442,441,442,6293154,4.66,7.01,7.03,7.02,7.04
2023-11-17,Hessen,06,00+,290,451,452,451,452,6293154,4.61,7.17,7.18,7.18,7.19
2023-11-16,Hessen,06,00+,300,453,453,453,454,6293154,4.77,7.2,7.21,7.21,7.22
2023-11-15,Hessen,06,00+,309,456,456,456,456,6293154,4.91,7.25,7.25,7.25,7.26
2023-11-14,Hessen,06,00+,286,435,435,435,435,6293154,4.54,6.91,6.92,6.92,6.92
2023-11-13,Hessen,06,00+,294,439,439,439,439,6293154,4.67,6.98,6.98,6.98,6.98
2023-11-12,Hessen,06,00+,303,439,439,439,439,6293154,4.81,6.98,6.98,6.98,6.98
2023-11-11,Hessen,06,00+,314,444,444,444,444,6293154,4.99,7.06,7.06,7.06,7.06
2023-11-10,Hessen,06,00+,299,426,426,426,426,6293154,4.75,6.77,6.77,6.77,6.77
2023-11-09,Hessen,06,00+,283,411,411,411,411,6293154,4.5,6.53,6.53,6.53,6.53
2023-11-08,Hessen,06,00+,278,400,400,400,400,6293154,4.42,6.36,6.36,6.36,6.36
2023-11-07,Hessen,06,00+,300,451,451,451,451,6293154,4.77,7.17,7.17,7.17,7.17
2023-11-06,Hessen,06,00+,329,471,471,471,471,6293154,5.23,7.48,7.48,7.48,7.48
2023-11-05,Hessen,06,00+,349,482,482,482,482,6293154,5.55,7.66,7.66,7.66,7.66
2023-11-04,Hessen,06,00+,359,480,480,480,480,6293154,5.7,7.63,7.63,7.63,7.63
2023-11-03,Hessen,06,00+,389,505,505,505,505,6293154,6.18,8.02,8.02,8.02,8.02
2023-11-02,Hessen,06,00+,367,500,500,500,500,6293154,5.83,7.95,7.95,7.95,7.95
2023-11-01,Hessen,06,00+,342,496,496,496,496,6293154,5.43,7.88,7.88,7.88,7.88
2023-10-31,Hessen,06,00+,311,471,471,471,471,6293154,4.94,7.48,7.48,7.48,7.48
2023-10-30,Hessen,06,00+,296,449,449,449,449,6293154,4.7,7.13,7.13,7.13,7.13
2023-10-29,Hessen,06,00+,305,439,439,439,439,6293154,4.85,6.98,6.98,6.98,6.98
2023-10-28,Hessen,06,00+,315,439,439,439,439,6293154,5.01,6.98,6.98,6.98,6.98
2023-10-27,Hessen,06,00+,302,412,412,412,412,6293154,4.8,6.55,6.55,6.55,6.55
2023-10-26,Hessen,06,00+,295,409,409,409,409,6293154,4.69,6.5,6.5,6.5,6.5
2023-10-25,Hessen,06,00+,260,392,392,392,392,6293154,4.13,6.23,6.23,6.23,6.23
2023-10-24,Hessen,06,00+,241,379,379,379,379,6293154,3.83,6.02,6.02,6.02,6.02
2023-10-23,Hessen,06,00+,256,366,366,366,366,6293154,4.07,5.82,5.82,5.82,5.82
2023-10-22,Hessen,06,00+,262,363,363,363,363,6293154,4.16,5.77,5.77,5.77,5.77
2023-10-21,Hessen,06,00+,267,359,359,359,359,6293154,4.24,5.7,5.7,5.7,5.7
2023-10-20,Hessen,06,00+,266,361,361,361,361,6293154,4.23,5.74,5.74,5.74,5.74
2023-10-19,Hessen,06,00+,253,351,351,351,351,6293154,4.02,5.58,5.58,5.58,5.58
2023-10-18,Hessen,06,00+,259,361,361,361,361,6293154,4.12,5.74,5.74,5.74,5.74
2023-10-17,Hessen,06,00+,233,340,340,340,340,6293154,3.7,5.4,5.4,5.4,5.4
2023-10-16,Hessen,06,00+,250,329,329,329,329,6293154,3.97,5.23,5.23,5.23,5.23
2023-10-15,Hessen,06,00+,256,328,328,328,328,6293154,4.07,5.21,5.21,5.21,5.21
2023-10-14,Hessen,06,00+,259,325,325,325,325,6293154,4.12,5.16,5.16,5.16,5.16
2023-10-13,Hessen,06,00+,244,318,318,318,318,6293154,3.88,5.05,5.05,5.05,5.05
2023-10-12,Hessen,06,00+,220,325,325,325,325,6293154,3.5,5.16,5.16,5.16,5.16
2023-10-11,Hessen,06,00+,248,339,339,339,339,6293154,3.94,5.39,5.39,5.39,5.39
2023-10-10,Hessen,06,00+,197,296,296,296,296,6293154,3.13,4.7,4.7,4.7,4.7
...
2023-10-02,Hessen,06,00+,157,269,269,269,269,6293154,2.49,4.27,4.27,4.27,4.27
2023-10-01,Hessen,06,00+,158,260,260,260,260,6293154,2.51,4.13,4.13,4.13,4.13
2023-09-30,Hessen,06,00+,158,255,255,255,255,6293154,2.51,4.05,4.05,4.05,4.05
2023-09-29,Hessen,06,00+,154,229,229,229,229,6293154,2.45,3.64,3.64,3.64,3.64
2023-09-28,Hessen,06,00+,140,214,214,214,214,6293154,2.22,3.4,3.4,3.4,3.4
2023-09-27,Hessen,06,00+,128,198,198,198,198,6293154,2.03,3.15,3.15,3.15,3.15
2023-09-26,Hessen,06,00+,128,197,197,197,197,6293154,2.03,3.13,3.13,3.13,3.13
2023-09-25,Hessen,06,00+,139,210,210,210,210,6293154,2.21,3.34,3.34,3.34,3.34
2023-09-24,Hessen,06,00+,141,211,211,211,211,6293154,2.24,3.35,3.35,3.35,3.35
2023-09-23,Hessen,06,00+,144,214,214,214,214,6293154,2.29,3.4,3.4,3.4,3.4
2023-09-22,Hessen,06,00+,146,211,211,211,211,6293154,2.32,3.35,3.35,3.35,3.35
2023-09-21,Hessen,06,00+,146,207,207,207,207,6293154,2.32,3.29,3.29,3.29,3.29
2023-09-20,Hessen,06,00+,132,205,205,205,205,6293154,2.1,3.26,3.26,3.26,3.26
...
2023-05-15,Hessen,06,00+,98,126,126,126,126,6293154,1.56,2,2,2,2
2023-05-14,Hessen,06,00+,100,128,128,128,128,6293154,1.59,2.03,2.03,2.03,2.03
2023-05-13,Hessen,06,00+,102,127,127,127,127,6293154,1.62,2.02,2.02,2.02,2.02
2023-05-12,Hessen,06,00+,101,139,139,139,139,6293154,1.6,2.21,2.21,2.21,2.21
2023-05-11,Hessen,06,00+,119,155,155,155,155,6293154,1.89,2.46,2.46,2.46,2.46
2023-05-10,Hessen,06,00+,130,168,168,168,168,6293154,2.07,2.67,2.67,2.67,2.67
2023-05-09,Hessen,06,00+,160,202,202,202,202,6293154,2.54,3.21,3.21,3.21,3.21
...
2023-04-21,Hessen,06,00+,192,245,245,245,245,6293154,3.05,3.89,3.89,3.89,3.89
2023-04-20,Hessen,06,00+,174,239,239,239,239,6293154,2.76,3.8,3.8,3.8,3.8
2023-04-19,Hessen,06,00+,178,264,264,264,264,6293154,2.83,4.2,4.2,4.2,4.2
2023-04-18,Hessen,06,00+,261,356,356,356,356,6293154,4.15,5.66,5.66,5.66,5.66
2023-04-17,Hessen,06,00+,219,288,288,288,288,6293154,3.48,4.58,4.58,4.58,4.58
2023-04-16,Hessen,06,00+,221,286,286,286,286,6293154,3.51,4.54,4.54,4.54,4.54
2023-04-15,Hessen,06,00+,225,292,292,292,292,6293154,3.58,4.64,4.64,4.64,4.64
...
2023-03-26,Hessen,06,00+,371,527,527,527,527,6293154,5.9,8.37,8.37,8.37,8.37
2023-03-25,Hessen,06,00+,378,527,527,527,527,6293154,6.01,8.37,8.37,8.37,8.37
2023-03-24,Hessen,06,00+,390,547,547,547,547,6293154,6.2,8.69,8.69,8.69,8.69
2023-03-23,Hessen,06,00+,405,565,565,565,565,6293154,6.44,8.98,8.98,8.98,8.98
2023-03-22,Hessen,06,00+,377,557,557,557,557,6293154,5.99,8.85,8.85,8.85,8.85
2023-03-21,Hessen,06,00+,435,614,614,614,614,6293154,6.91,9.76,9.76,9.76,9.76
2023-03-20,Hessen,06,00+,527,697,697,697,697,6293154,8.37,11.08,11.08,11.08,11.08
...
2023-03-09,Hessen,06,00+,525,698,698,698,698,6293154,8.34,11.09,11.09,11.09,11.09
2023-03-08,Hessen,06,00+,520,710,710,710,710,6293154,8.26,11.28,11.28,11.28,11.28
2023-03-07,Hessen,06,00+,536,714,714,714,714,6293154,8.52,11.35,11.35,11.35,11.35
2023-03-06,Hessen,06,00+,572,763,763,763,763,6293154,9.09,12.12,12.12,12.12,12.12
2023-03-05,Hessen,06,00+,583,768,768,768,768,6293154,9.26,12.2,12.2,12.2,12.2
2023-03-04,Hessen,06,00+,595,773,773,773,773,6293154,9.45,12.28,12.28,12.28,12.28
2023-03-03,Hessen,06,00+,543,735,735,735,735,6293154,8.63,11.68,11.68,11.68,11.68
...
2023-02-23,Hessen,06,00+,557,755,755,755,755,6293154,8.85,12,12,12,12
2023-02-22,Hessen,06,00+,545,753,753,753,753,6293154,8.66,11.97,11.97,11.97,11.97
2023-02-21,Hessen,06,00+,506,735,735,735,735,6293154,8.04,11.68,11.68,11.68,11.68
2023-02-20,Hessen,06,00+,529,719,719,719,719,6293154,8.41,11.43,11.43,11.43,11.43
2023-02-19,Hessen,06,00+,535,711,711,711,711,6293154,8.5,11.3,11.3,11.3,11.3
2023-02-18,Hessen,06,00+,548,705,705,705,705,6293154,8.71,11.2,11.2,11.2,11.2
2023-02-17,Hessen,06,00+,522,669,669,669,669,6293154,8.29,10.63,10.63,10.63,10.63
2023-02-16,Hessen,06,00+,477,651,651,651,651,6293154,7.58,10.34,10.34,10.34,10.34
2023-02-15,Hessen,06,00+,398,619,619,619,619,6293154,6.32,9.84,9.84,9.84,9.84
2023-02-14,Hessen,06,00+,390,570,570,570,570,6293154,6.2,9.06,9.06,9.06,9.06
2023-02-13,Hessen,06,00+,396,537,537,537,537,6293154,6.29,8.53,8.53,8.53,8.53
2023-02-12,Hessen,06,00+,403,535,535,535,535,6293154,6.4,8.5,8.5,8.5,8.5
2023-02-11,Hessen,06,00+,414,533,533,533,533,6293154,6.58,8.47,8.47,8.47,8.47
...
2023-01-30,Hessen,06,00+,286,370,370,370,370,6293154,4.54,5.88,5.88,5.88,5.88
2023-01-29,Hessen,06,00+,290,367,367,367,367,6293154,4.61,5.83,5.83,5.83,5.83
2023-01-28,Hessen,06,00+,293,366,366,366,366,6293154,4.66,5.82,5.82,5.82,5.82
2023-01-27,Hessen,06,00+,268,348,348,348,348,6293154,4.26,5.53,5.53,5.53,5.53
2023-01-26,Hessen,06,00+,260,346,346,346,346,6293154,4.13,5.5,5.5,5.5,5.5
2023-01-25,Hessen,06,00+,251,339,339,339,339,6293154,3.99,5.39,5.39,5.39,5.39
2023-01-24,Hessen,06,00+,251,334,334,334,334,6293154,3.99,5.31,5.31,5.31,5.31
...
2023-01-11,Hessen,06,00+,374,563,563,563,563,6293154,5.94,8.95,8.95,8.95,8.95
2023-01-10,Hessen,06,00+,433,624,624,624,624,6293154,6.88,9.92,9.92,9.92,9.92
2023-01-09,Hessen,06,00+,526,695,695,695,695,6293154,8.36,11.04,11.04,11.04,11.04
2023-01-08,Hessen,06,00+,531,693,693,693,693,6293154,8.44,11.01,11.01,11.01,11.01
...
2023-12-20,Rheinland-Pfalz,07,00+,405,405,NA,NA,NA,4098391,9.88,9.88,NA,NA,NA
2023-12-19,Rheinland-Pfalz,07,00+,395,519,NA,NA,NA,4098391,9.64,12.66,NA,NA,NA
2023-12-18,Rheinland-Pfalz,07,00+,548,587,NA,NA,NA,4098391,13.37,14.32,NA,NA,NA
2023-12-17,Rheinland-Pfalz,07,00+,550,586,657,644,670,4098391,13.42,14.3,16.03,15.72,16.37
2023-12-16,Rheinland-Pfalz,07,00+,550,585,655,641,669,4098391,13.42,14.27,15.99,15.65,16.33
2023-12-15,Rheinland-Pfalz,07,00+,510,590,649,638,662,4098391,12.44,14.4,15.84,15.58,16.16
2023-12-14,Rheinland-Pfalz,07,00+,504,607,659,649,671,4098391,12.3,14.81,16.09,15.86,16.39
2023-12-13,Rheinland-Pfalz,07,00+,481,606,652,642,663,4098391,11.74,14.79,15.91,15.69,16.19
2023-12-12,Rheinland-Pfalz,07,00+,432,602,640,631,650,4098391,10.54,14.69,15.62,15.42,15.88
2023-12-11,Rheinland-Pfalz,07,00+,457,514,537,531,545,4098391,11.15,12.54,13.11,12.96,13.31
2023-12-10,Rheinland-Pfalz,07,00+,461,516,539,533,547,4098391,11.25,12.59,13.15,13.01,13.36
2023-12-09,Rheinland-Pfalz,07,00+,466,521,544,538,552,4098391,11.37,12.71,13.28,13.13,13.49
2023-12-08,Rheinland-Pfalz,07,00+,382,493,513,507,520,4098391,9.32,12.03,12.52,12.39,12.7
2023-12-07,Rheinland-Pfalz,07,00+,360,470,486,481,493,4098391,8.78,11.47,11.87,11.75,12.04
2023-12-06,Rheinland-Pfalz,07,00+,349,467,481,476,487,4098391,8.52,11.39,11.74,11.63,11.89
2023-12-05,Rheinland-Pfalz,07,00+,249,415,426,422,431,4098391,6.08,10.13,10.4,10.31,10.54
2023-12-04,Rheinland-Pfalz,07,00+,279,415,423,420,428,4098391,6.81,10.13,10.33,10.26,10.46
2023-12-03,Rheinland-Pfalz,07,00+,284,416,424,421,429,4098391,6.93,10.15,10.36,10.28,10.48
2023-12-02,Rheinland-Pfalz,07,00+,290,417,425,422,430,4098391,7.08,10.17,10.38,10.31,10.5
2023-12-01,Rheinland-Pfalz,07,00+,289,426,433,430,439,4098391,7.05,10.39,10.59,10.52,10.71
2023-11-30,Rheinland-Pfalz,07,00+,292,434,441,438,445,4098391,7.12,10.59,10.76,10.7,10.88
2023-11-29,Rheinland-Pfalz,07,00+,316,415,421,418,425,4098391,7.71,10.13,10.27,10.22,10.38
2023-11-28,Rheinland-Pfalz,07,00+,258,432,437,435,441,4098391,6.3,10.54,10.68,10.62,10.77
2023-11-27,Rheinland-Pfalz,07,00+,308,429,433,431,436,4098391,7.52,10.47,10.58,10.53,10.65
2023-11-26,Rheinland-Pfalz,07,00+,309,426,430,428,433,4098391,7.54,10.39,10.5,10.46,10.57
2023-11-25,Rheinland-Pfalz,07,00+,309,420,424,422,427,4098391,7.54,10.25,10.35,10.31,10.42
2023-11-24,Rheinland-Pfalz,07,00+,295,420,423,422,426,4098391,7.2,10.25,10.34,10.3,10.4
2023-11-23,Rheinland-Pfalz,07,00+,331,429,432,431,434,4098391,8.08,10.47,10.55,10.52,10.6
2023-11-22,Rheinland-Pfalz,07,00+,320,431,433,432,435,4098391,7.81,10.52,10.59,10.56,10.63
2023-11-21,Rheinland-Pfalz,07,00+,235,389,391,390,392,4098391,5.73,9.49,9.54,9.53,9.57
2023-11-20,Rheinland-Pfalz,07,00+,303,358,359,358,359,4098391,7.39,8.74,8.77,8.76,8.78
2023-11-19,Rheinland-Pfalz,07,00+,304,358,359,358,359,4098391,7.42,8.74,8.77,8.76,8.78
2023-11-18,Rheinland-Pfalz,07,00+,309,365,366,365,366,4098391,7.54,8.91,8.94,8.93,8.95
2023-11-17,Rheinland-Pfalz,07,00+,251,351,351,351,352,4098391,6.12,8.56,8.59,8.58,8.6
2023-11-16,Rheinland-Pfalz,07,00+,254,348,348,348,348,4098391,6.2,8.49,8.51,8.5,8.51
2023-11-15,Rheinland-Pfalz,07,00+,282,345,345,345,345,4098391,6.88,8.42,8.43,8.42,8.43
2023-11-14,Rheinland-Pfalz,07,00+,213,347,347,347,347,4098391,5.2,8.47,8.47,8.47,8.48
2023-11-13,Rheinland-Pfalz,07,00+,269,350,350,350,350,4098391,6.56,8.54,8.54,8.54,8.54
2023-11-12,Rheinland-Pfalz,07,00+,270,349,349,349,349,4098391,6.59,8.52,8.52,8.52,8.52
2023-11-11,Rheinland-Pfalz,07,00+,270,342,342,342,342,4098391,6.59,8.34,8.35,8.35,8.35
...
2023-11-08,Rheinland-Pfalz,07,00+,221,307,307,307,307,4098391,5.39,7.49,7.49,7.49,7.49
2023-11-07,Rheinland-Pfalz,07,00+,233,364,364,364,364,4098391,5.69,8.88,8.88,8.88,8.88
...
2023-10-25,Rheinland-Pfalz,07,00+,223,308,308,308,308,4098391,5.44,7.52,7.52,7.52,7.52
2023-10-24,Rheinland-Pfalz,07,00+,189,320,320,320,320,4098391,4.61,7.81,7.81,7.81,7.81
2023-10-23,Rheinland-Pfalz,07,00+,236,309,309,309,309,4098391,5.76,7.54,7.54,7.54,7.54
2023-10-22,Rheinland-Pfalz,07,00+,240,311,311,311,311,4098391,5.86,7.59,7.59,7.59,7.59
2023-10-21,Rheinland-Pfalz,07,00+,240,311,311,311,311,4098391,5.86,7.59,7.59,7.59,7.59
2023-10-20,Rheinland-Pfalz,07,00+,222,304,304,304,304,4098391,5.42,7.42,7.42,7.42,7.42
2023-10-19,Rheinland-Pfalz,07,00+,255,309,309,309,309,4098391,6.22,7.54,7.54,7.54,7.54
2023-10-18,Rheinland-Pfalz,07,00+,211,313,313,313,313,4098391,5.15,7.64,7.64,7.64,7.64
2023-10-17,Rheinland-Pfalz,07,00+,150,276,276,276,276,4098391,3.66,6.73,6.73,6.73,6.73
2023-10-16,Rheinland-Pfalz,07,00+,155,235,235,235,235,4098391,3.78,5.73,5.73,5.73,5.73
2023-10-15,Rheinland-Pfalz,07,00+,158,234,234,234,234,4098391,3.86,5.71,5.71,5.71,5.71
2023-10-14,Rheinland-Pfalz,07,00+,161,237,237,237,237,4098391,3.93,5.78,5.78,5.78,5.78
2023-10-13,Rheinland-Pfalz,07,00+,149,241,241,241,241,4098391,3.64,5.88,5.88,5.88,5.88
2023-10-12,Rheinland-Pfalz,07,00+,168,239,239,239,239,4098391,4.1,5.83,5.83,5.83,5.83
...
2023-09-23,Rheinland-Pfalz,07,00+,97,122,122,122,122,4098391,2.37,2.98,2.98,2.98,2.98
2023-09-22,Rheinland-Pfalz,07,00+,91,121,121,121,121,4098391,2.22,2.95,2.95,2.95,2.95
2023-09-21,Rheinland-Pfalz,07,00+,92,119,119,119,119,4098391,2.24,2.9,2.9,2.9,2.9
2023-09-20,Rheinland-Pfalz,07,00+,110,144,144,144,144,4098391,2.68,3.51,3.51,3.51,3.51
2023-09-19,Rheinland-Pfalz,07,00+,87,152,152,152,152,4098391,2.12,3.71,3.71,3.71,3.71
2023-09-18,Rheinland-Pfalz,07,00+,154,196,196,196,196,4098391,3.76,4.78,4.78,4.78,4.78
2023-09-17,Rheinland-Pfalz,07,00+,156,195,195,195,195,4098391,3.81,4.76,4.76,4.76,4.76
...
2023-09-02,Rheinland-Pfalz,07,00+,64,82,82,82,82,4098391,1.56,2,2,2,2
2023-09-01,Rheinland-Pfalz,07,00+,64,88,88,88,88,4098391,1.56,2.15,2.15,2.15,2.15
2023-08-31,Rheinland-Pfalz,07,00+,65,87,87,87,87,4098391,1.59,2.12,2.12,2.12,2.12
2023-08-30,Rheinland-Pfalz,07,00+,57,81,81,81,81,4098391,1.39,1.98,1.98,1.98,1.98
2023-08-29,Rheinland-Pfalz,07,00+,64,85,85,85,85,4098391,1.56,2.07,2.07,2.07,2.07
2023-08-28,Rheinland-Pfalz,07,00+,0,76,76,76,76,4098391,0,1.85,1.85,1.85,1.85
2023-08-27,Rheinland-Pfalz,07,00+,0,76,76,76,76,4098391,0,1.85,1.85,1.85,1.85
...
2023-08-21,Rheinland-Pfalz,07,00+,38,52,52,52,52,4098391,0.93,1.27,1.27,1.27,1.27
2023-08-20,Rheinland-Pfalz,07,00+,39,53,53,53,53,4098391,0.95,1.29,1.29,1.29,1.29
2023-08-19,Rheinland-Pfalz,07,00+,39,52,52,52,52,4098391,0.95,1.27,1.27,1.27,1.27
2023-08-18,Rheinland-Pfalz,07,00+,33,44,44,44,44,4098391,0.81,1.07,1.07,1.07,1.07
2023-08-17,Rheinland-Pfalz,07,00+,29,46,46,46,46,4098391,0.71,1.12,1.12,1.12,1.12
2023-08-16,Rheinland-Pfalz,07,00+,31,41,41,41,41,4098391,0.76,1,1,1,1
2023-08-15,Rheinland-Pfalz,07,00+,33,42,42,42,42,4098391,0.81,1.02,1.02,1.02,1.02
...
2023-05-10,Rheinland-Pfalz,07,00+,107,133,133,133,133,4098391,2.61,3.25,3.25,3.25,3.25
2023-05-09,Rheinland-Pfalz,07,00+,130,181,181,181,181,4098391,3.17,4.42,4.42,4.42,4.42
2023-05-08,Rheinland-Pfalz,07,00+,107,136,136,136,136,4098391,2.61,3.32,3.32,3.32,3.32
2023-05-07,Rheinland-Pfalz,07,00+,107,138,138,138,138,4098391,2.61,3.37,3.37,3.37,3.37
2023-05-06,Rheinland-Pfalz,07,00+,107,138,138,138,138,4098391,2.61,3.37,3.37,3.37,3.37
2023-05-05,Rheinland-Pfalz,07,00+,104,144,144,144,144,4098391,2.54,3.51,3.51,3.51,3.51
2023-05-04,Rheinland-Pfalz,07,00+,96,144,144,144,144,4098391,2.34,3.51,3.51,3.51,3.51
...
2023-04-25,Rheinland-Pfalz,07,00+,82,129,129,129,129,4098391,2,3.15,3.15,3.15,3.15
2023-04-24,Rheinland-Pfalz,07,00+,96,131,131,131,131,4098391,2.34,3.2,3.2,3.2,3.2
2023-04-23,Rheinland-Pfalz,07,00+,99,134,134,134,134,4098391,2.42,3.27,3.27,3.27,3.27
2023-04-22,Rheinland-Pfalz,07,00+,101,136,136,136,136,4098391,2.46,3.32,3.32,3.32,3.32
2023-04-21,Rheinland-Pfalz,07,00+,97,136,136,136,136,4098391,2.37,3.32,3.32,3.32,3.32
2023-04-20,Rheinland-Pfalz,07,00+,103,151,151,151,151,4098391,2.51,3.68,3.68,3.68,3.68
2023-04-19,Rheinland-Pfalz,07,00+,108,156,156,156,156,4098391,2.64,3.81,3.81,3.81,3.81
...
2023-04-16,Rheinland-Pfalz,07,00+,108,162,162,162,162,4098391,2.64,3.95,3.95,3.95,3.95
2023-04-15,Rheinland-Pfalz,07,00+,111,164,164,164,164,4098391,2.71,4,4,4,4
2023-04-14,Rheinland-Pfalz,07,00+,97,157,157,157,157,4098391,2.37,3.83,3.83,3.83,3.83
2023-04-13,Rheinland-Pfalz,07,00+,98,148,148,148,148,4098391,2.39,3.61,3.61,3.61,3.61
2023-04-12,Rheinland-Pfalz,07,00+,68,153,153,153,153,4098391,1.66,3.73,3.73,3.73,3.73
2023-04-11,Rheinland-Pfalz,07,00+,46,110,110,110,110,4098391,1.12,2.68,2.68,2.68,2.68
2023-04-10,Rheinland-Pfalz,07,00+,109,180,180,180,180,4098391,2.66,4.39,4.39,4.39,4.39
...
2023-03-14,Rheinland-Pfalz,07,00+,304,535,535,535,535,4098391,7.42,13.05,13.05,13.05,13.05
2023-03-13,Rheinland-Pfalz,07,00+,367,549,549,549,549,4098391,8.95,13.4,13.4,13.4,13.4
2023-03-12,Rheinland-Pfalz,07,00+,381,553,553,553,553,4098391,9.3,13.49,13.49,13.49,13.49
2023-03-11,Rheinland-Pfalz,07,00+,388,543,543,543,543,4098391,9.47,13.25,13.25,13.25,13.25
2023-03-10,Rheinland-Pfalz,07,00+,371,531,531,531,531,4098391,9.05,12.96,12.96,12.96,12.96
2023-03-09,Rheinland-Pfalz,07,00+,360,512,512,512,512,4098391,8.78,12.49,12.49,12.49,12.49
2023-03-08,Rheinland-Pfalz,07,00+,312,506,506,506,506,4098391,7.61,12.35,12.35,12.35,12.35
...
2023-02-23,Rheinland-Pfalz,07,00+,420,622,622,622,622,4098391,10.25,15.18,15.18,15.18,15.18
2023-02-22,Rheinland-Pfalz,07,00+,371,568,568,568,568,4098391,9.05,13.86,13.86,13.86,13.86
2023-02-21,Rheinland-Pfalz,07,00+,258,500,500,500,500,4098391,6.3,12.2,12.2,12.2,12.2
2023-02-20,Rheinland-Pfalz,07,00+,347,512,512,512,512,4098391,8.47,12.49,12.49,12.49,12.49
2023-02-19,Rheinland-Pfalz,07,00+,355,502,502,502,502,4098391,8.66,12.25,12.25,12.25,12.25
2023-02-18,Rheinland-Pfalz,07,00+,358,499,499,499,499,4098391,8.74,12.18,12.18,12.18,12.18
2023-02-17,Rheinland-Pfalz,07,00+,331,480,480,480,480,4098391,8.08,11.71,11.71,11.71,11.71
2023-02-16,Rheinland-Pfalz,07,00+,319,448,448,448,448,4098391,7.78,10.93,10.93,10.93,10.93
2023-02-15,Rheinland-Pfalz,07,00+,275,434,434,434,434,4098391,6.71,10.59,10.59,10.59,10.59
2023-02-14,Rheinland-Pfalz,07,00+,299,438,438,438,438,4098391,7.3,10.69,10.69,10.69,10.69
2023-02-13,Rheinland-Pfalz,07,00+,313,433,433,433,433,4098391,7.64,10.57,10.57,10.57,10.57
2023-02-12,Rheinland-Pfalz,07,00+,320,431,431,431,431,4098391,7.81,10.52,10.52,10.52,10.52
2023-02-11,Rheinland-Pfalz,07,00+,330,434,434,434,434,4098391,8.05,10.59,10.59,10.59,10.59
...
2023-12-20,Baden-Württemberg,08,00+,435,435,NA,NA,NA,11103043,3.92,3.92,NA,NA,NA
2023-12-19,Baden-Württemberg,08,00+,388,493,NA,NA,NA,11103043,3.49,4.44,NA,NA,NA
2023-12-18,Baden-Württemberg,08,00+,453,561,NA,NA,NA,11103043,4.08,5.05,NA,NA,NA
2023-12-17,Baden-Württemberg,08,00+,459,557,662,643,734,11103043,4.13,5.02,5.96,5.8,6.62
2023-12-16,Baden-Württemberg,08,00+,466,555,644,632,659,11103043,4.2,5,5.81,5.7,5.94
2023-12-15,Baden-Württemberg,08,00+,395,583,653,643,668,11103043,3.56,5.25,5.89,5.79,6.02
2023-12-14,Baden-Württemberg,08,00+,399,568,624,614,637,11103043,3.59,5.12,5.62,5.54,5.74
2023-12-13,Baden-Württemberg,08,00+,385,561,606,597,616,11103043,3.47,5.05,5.46,5.38,5.55
2023-12-12,Baden-Württemberg,08,00+,372,579,617,609,627,11103043,3.35,5.21,5.56,5.49,5.65
2023-12-11,Baden-Württemberg,08,00+,341,513,537,532,546,11103043,3.07,4.62,4.84,4.79,4.92
2023-12-10,Baden-Württemberg,08,00+,346,512,536,530,545,11103043,3.12,4.61,4.83,4.78,4.91
2023-12-09,Baden-Württemberg,08,00+,356,514,538,532,546,11103043,3.21,4.63,4.85,4.8,4.92
2023-12-08,Baden-Württemberg,08,00+,346,471,490,485,497,11103043,3.12,4.24,4.42,4.37,4.48
2023-12-07,Baden-Württemberg,08,00+,343,483,500,495,507,11103043,3.09,4.35,4.51,4.46,4.57
2023-12-06,Baden-Württemberg,08,00+,309,477,491,487,498,11103043,2.78,4.3,4.43,4.39,4.49
2023-12-05,Baden-Württemberg,08,00+,256,431,442,438,448,11103043,2.31,3.88,3.99,3.95,4.04
2023-12-04,Baden-Württemberg,08,00+,296,439,448,445,453,11103043,2.67,3.95,4.04,4.01,4.09
2023-12-03,Baden-Württemberg,08,00+,302,440,449,446,454,11103043,2.72,3.96,4.05,4.02,4.1
2023-12-02,Baden-Württemberg,08,00+,320,448,457,454,462,11103043,2.88,4.03,4.12,4.09,4.17
2023-12-01,Baden-Württemberg,08,00+,284,445,453,450,458,11103043,2.56,4.01,4.08,4.06,4.13
2023-11-30,Baden-Württemberg,08,00+,286,412,418,416,423,11103043,2.58,3.71,3.77,3.75,3.82
2023-11-29,Baden-Württemberg,08,00+,283,406,411,409,416,11103043,2.55,3.66,3.71,3.69,3.75
2023-11-28,Baden-Württemberg,08,00+,254,411,416,414,420,11103043,2.29,3.7,3.75,3.73,3.78
2023-11-27,Baden-Württemberg,08,00+,278,411,415,413,418,11103043,2.5,3.7,3.74,3.72,3.77
2023-11-26,Baden-Württemberg,08,00+,290,417,421,419,424,11103043,2.61,3.76,3.79,3.78,3.82
2023-11-25,Baden-Württemberg,08,00+,293,401,405,403,407,11103043,2.64,3.61,3.65,3.63,3.67
2023-11-24,Baden-Württemberg,08,00+,294,399,402,401,404,11103043,2.65,3.59,3.63,3.61,3.65
2023-11-23,Baden-Württemberg,08,00+,293,425,428,427,430,11103043,2.64,3.83,3.86,3.85,3.88
2023-11-22,Baden-Württemberg,08,00+,286,422,424,423,426,11103043,2.58,3.8,3.83,3.82,3.84
2023-11-21,Baden-Württemberg,08,00+,306,432,434,433,435,11103043,2.76,3.89,3.91,3.9,3.92
2023-11-20,Baden-Württemberg,08,00+,317,435,436,436,437,11103043,2.86,3.92,3.93,3.93,3.94
2023-11-19,Baden-Württemberg,08,00+,325,433,434,433,434,11103043,2.93,3.9,3.91,3.91,3.92
2023-11-18,Baden-Württemberg,08,00+,335,440,441,440,441,11103043,3.02,3.96,3.98,3.97,3.98
2023-11-17,Baden-Württemberg,08,00+,334,448,449,448,449,11103043,3.01,4.03,4.05,4.04,4.05
2023-11-16,Baden-Württemberg,08,00+,327,460,460,460,461,11103043,2.95,4.14,4.15,4.15,4.15
2023-11-15,Baden-Württemberg,08,00+,332,490,490,490,490,11103043,2.99,4.41,4.42,4.42,4.42
2023-11-14,Baden-Württemberg,08,00+,299,470,470,470,470,11103043,2.69,4.23,4.24,4.24,4.24
2023-11-13,Baden-Württemberg,08,00+,342,496,496,496,496,11103043,3.08,4.47,4.47,4.47,4.47
2023-11-12,Baden-Württemberg,08,00+,351,495,495,495,495,11103043,3.16,4.46,4.46,4.46,4.46
2023-11-11,Baden-Württemberg,08,00+,359,493,493,493,493,11103043,3.23,4.44,4.44,4.44,4.44
2023-11-10,Baden-Württemberg,08,00+,351,513,513,513,513,11103043,3.16,4.62,4.62,4.62,4.62
2023-11-09,Baden-Württemberg,08,00+,402,555,555,555,555,11103043,3.62,5,5,5,5
2023-11-08,Baden-Württemberg,08,00+,294,458,458,458,458,11103043,2.65,4.12,4.12,4.12,4.12
2023-11-07,Baden-Württemberg,08,00+,340,529,529,529,529,11103043,3.06,4.76,4.76,4.76,4.76
2023-11-06,Baden-Württemberg,08,00+,364,550,550,550,550,11103043,3.28,4.95,4.95,4.95,4.95
2023-11-05,Baden-Württemberg,08,00+,369,547,547,547,547,11103043,3.32,4.93,4.93,4.93,4.93
2023-11-04,Baden-Württemberg,08,00+,375,546,546,546,546,11103043,3.38,4.92,4.92,4.92,4.92
2023-11-03,Baden-Württemberg,08,00+,307,529,529,529,529,11103043,2.77,4.76,4.76,4.76,4.76
2023-11-02,Baden-Württemberg,08,00+,284,487,487,487,487,11103043,2.56,4.39,4.39,4.39,4.39
2023-11-01,Baden-Württemberg,08,00+,376,586,586,586,586,11103043,3.39,5.28,5.28,5.28,5.28
2023-10-31,Baden-Württemberg,08,00+,333,578,578,578,578,11103043,3,5.21,5.21,5.21,5.21
2023-10-30,Baden-Württemberg,08,00+,420,598,598,598,598,11103043,3.78,5.39,5.39,5.39,5.39
2023-10-29,Baden-Württemberg,08,00+,434,606,606,606,606,11103043,3.91,5.46,5.46,5.46,5.46
2023-10-28,Baden-Württemberg,08,00+,442,607,607,607,607,11103043,3.98,5.47,5.47,5.47,5.47
2023-10-27,Baden-Württemberg,08,00+,437,624,624,624,624,11103043,3.94,5.62,5.62,5.62,5.62
2023-10-26,Baden-Württemberg,08,00+,401,618,618,618,618,11103043,3.61,5.57,5.57,5.57,5.57
2023-10-25,Baden-Württemberg,08,00+,385,580,580,580,580,11103043,3.47,5.22,5.22,5.22,5.22
...
2023-10-20,Baden-Württemberg,08,00+,289,426,426,426,426,11103043,2.6,3.84,3.84,3.84,3.84
2023-10-19,Baden-Württemberg,08,00+,256,397,397,397,397,11103043,2.31,3.58,3.58,3.58,3.58
2023-10-18,Baden-Württemberg,08,00+,211,395,395,395,395,11103043,1.9,3.56,3.56,3.56,3.56
2023-10-17,Baden-Württemberg,08,00+,194,390,390,390,390,11103043,1.75,3.51,3.51,3.51,3.51
2023-10-16,Baden-Württemberg,08,00+,254,375,375,375,375,11103043,2.29,3.38,3.38,3.38,3.38
2023-10-15,Baden-Württemberg,08,00+,259,374,374,374,374,11103043,2.33,3.37,3.37,3.37,3.37
2023-10-14,Baden-Württemberg,08,00+,263,369,369,369,369,11103043,2.37,3.32,3.32,3.32,3.32
2023-10-13,Baden-Württemberg,08,00+,247,368,368,368,368,11103043,2.22,3.31,3.31,3.31,3.31
2023-10-12,Baden-Württemberg,08,00+,229,375,375,375,375,11103043,2.06,3.38,3.38,3.38,3.38
2023-10-11,Baden-Württemberg,08,00+,253,403,403,403,403,11103043,2.28,3.63,3.63,3.63,3.63
2023-10-10,Baden-Württemberg,08,00+,198,339,339,339,339,11103043,1.78,3.05,3.05,3.05,3.05
2023-10-09,Baden-Württemberg,08,00+,193,295,295,295,295,11103043,1.74,2.66,2.66,2.66,2.66
2023-10-08,Baden-Württemberg,08,00+,197,293,293,293,293,11103043,1.77,2.64,2.64,2.64,2.64
2023-10-07,Baden-Württemberg,08,00+,201,291,291,291,291,11103043,1.81,2.62,2.62,2.62,2.62
2023-10-06,Baden-Württemberg,08,00+,184,273,273,273,273,11103043,1.66,2.46,2.46,2.46,2.46
2023-10-05,Baden-Württemberg,08,00+,159,259,259,259,259,11103043,1.43,2.33,2.33,2.33,2.33
...
2023-09-14,Baden-Württemberg,08,00+,108,152,152,152,152,11103043,0.97,1.37,1.37,1.37,1.37
2023-09-13,Baden-Württemberg,08,00+,103,146,146,146,146,11103043,0.93,1.31,1.31,1.31,1.31
2023-09-12,Baden-Württemberg,08,00+,108,156,156,156,156,11103043,0.97,1.41,1.41,1.41,1.41
2023-09-11,Baden-Württemberg,08,00+,106,144,144,144,144,11103043,0.95,1.3,1.3,1.3,1.3
2023-09-10,Baden-Württemberg,08,00+,110,146,146,146,146,11103043,0.99,1.31,1.31,1.31,1.31
2023-09-09,Baden-Württemberg,08,00+,110,144,144,144,144,11103043,0.99,1.3,1.3,1.3,1.3
2023-09-08,Baden-Württemberg,08,00+,79,114,114,114,114,11103043,0.71,1.03,1.03,1.03,1.03
...
2023-03-31,Baden-Württemberg,08,00+,217,335,335,335,335,11103043,1.95,3.02,3.02,3.02,3.02
2023-03-30,Baden-Württemberg,08,00+,237,356,356,356,356,11103043,2.13,3.21,3.21,3.21,3.21
2023-03-29,Baden-Württemberg,08,00+,241,382,382,382,382,11103043,2.17,3.44,3.44,3.44,3.44
2023-03-28,Baden-Württemberg,08,00+,236,386,386,386,386,11103043,2.13,3.48,3.48,3.48,3.48
2023-03-27,Baden-Württemberg,08,00+,279,417,417,417,417,11103043,2.51,3.76,3.76,3.76,3.76
2023-03-26,Baden-Württemberg,08,00+,290,419,419,419,419,11103043,2.61,3.77,3.77,3.77,3.77
2023-03-25,Baden-Württemberg,08,00+,306,426,426,426,426,11103043,2.76,3.84,3.84,3.84,3.84
...
2023-03-15,Baden-Württemberg,08,00+,407,641,641,641,641,11103043,3.67,5.77,5.77,5.77,5.77
2023-03-14,Baden-Württemberg,08,00+,383,673,673,673,673,11103043,3.45,6.06,6.06,6.06,6.06
2023-03-13,Baden-Württemberg,08,00+,424,663,663,663,663,11103043,3.82,5.97,5.97,5.97,5.97
2023-03-12,Baden-Württemberg,08,00+,449,666,666,666,666,11103043,4.04,6,6,6,6
2023-03-11,Baden-Württemberg,08,00+,465,671,671,671,671,11103043,4.19,6.04,6.04,6.04,6.04
2023-03-10,Baden-Württemberg,08,00+,427,672,672,672,672,11103043,3.85,6.05,6.05,6.05,6.05
2023-03-09,Baden-Württemberg,08,00+,406,675,675,675,675,11103043,3.66,6.08,6.08,6.08,6.08
2023-03-08,Baden-Württemberg,08,00+,419,693,693,693,693,11103043,3.77,6.24,6.24,6.24,6.24
2023-03-07,Baden-Württemberg,08,00+,458,728,728,728,728,11103043,4.12,6.56,6.56,6.56,6.56
2023-03-06,Baden-Württemberg,08,00+,492,786,786,786,786,11103043,4.43,7.08,7.08,7.08,7.08
2023-03-05,Baden-Württemberg,08,00+,520,790,790,790,790,11103043,4.68,7.12,7.12,7.12,7.12
2023-03-04,Baden-Württemberg,08,00+,543,794,794,794,794,11103043,4.89,7.15,7.15,7.15,7.15
2023-03-03,Baden-Württemberg,08,00+,556,840,840,840,840,11103043,5.01,7.57,7.57,7.57,7.57
2023-03-02,Baden-Württemberg,08,00+,580,893,893,893,893,11103043,5.22,8.04,8.04,8.04,8.04
...
2023-02-27,Baden-Württemberg,08,00+,586,923,923,923,923,11103043,5.28,8.31,8.31,8.31,8.31
2023-02-26,Baden-Württemberg,08,00+,614,918,918,918,918,11103043,5.53,8.27,8.27,8.27,8.27
2023-02-25,Baden-Württemberg,08,00+,623,908,908,908,908,11103043,5.61,8.18,8.18,8.18,8.18
2023-02-24,Baden-Württemberg,08,00+,611,925,925,925,925,11103043,5.5,8.33,8.33,8.33,8.33
2023-02-23,Baden-Württemberg,08,00+,565,902,902,902,902,11103043,5.09,8.12,8.12,8.12,8.12
2023-02-22,Baden-Württemberg,08,00+,509,905,905,905,905,11103043,4.58,8.15,8.15,8.15,8.15
2023-02-21,Baden-Württemberg,08,00+,469,891,891,891,891,11103043,4.22,8.02,8.02,8.02,8.02
...
2023-02-07,Baden-Württemberg,08,00+,284,500,500,500,500,11103043,2.56,4.5,4.5,4.5,4.5
2023-02-06,Baden-Württemberg,08,00+,271,450,450,450,450,11103043,2.44,4.05,4.05,4.05,4.05
2023-02-05,Baden-Württemberg,08,00+,282,441,441,441,441,11103043,2.54,3.97,3.97,3.97,3.97
2023-02-04,Baden-Württemberg,08,00+,288,431,431,431,431,11103043,2.59,3.88,3.88,3.88,3.88
2023-02-03,Baden-Württemberg,08,00+,285,431,431,431,431,11103043,2.57,3.88,3.88,3.88,3.88
2023-02-02,Baden-Württemberg,08,00+,310,455,455,455,455,11103043,2.79,4.1,4.1,4.1,4.1
2023-02-01,Baden-Württemberg,08,00+,261,449,449,449,449,11103043,2.35,4.04,4.04,4.04,4.04
...
2023-12-20,Bayern,09,00+,1111,1111,NA,NA,NA,13140183,8.45,8.45,NA,NA,NA
2023-12-19,Bayern,09,00+,1010,1199,NA,NA,NA,13140183,7.69,9.12,NA,NA,NA
2023-12-18,Bayern,09,00+,1116,1335,NA,NA,NA,13140183,8.49,10.16,NA,NA,NA
2023-12-17,Bayern,09,00+,1163,1360,1556,1527,1583,13140183,8.85,10.35,11.85,11.62,12.05
2023-12-16,Bayern,09,00+,1177,1359,1545,1518,1575,13140183,8.96,10.34,11.76,11.56,11.99
2023-12-15,Bayern,09,00+,1068,1348,1500,1476,1530,13140183,8.13,10.26,11.42,11.24,11.65
2023-12-14,Bayern,09,00+,1102,1366,1493,1472,1523,13140183,8.39,10.4,11.37,11.2,11.6
2023-12-13,Bayern,09,00+,1036,1354,1458,1437,1486,13140183,7.88,10.3,11.1,10.94,11.31
2023-12-12,Bayern,09,00+,985,1378,1468,1449,1495,13140183,7.5,10.49,11.18,11.03,11.38
2023-12-11,Bayern,09,00+,938,1255,1315,1301,1337,13140183,7.14,9.55,10.01,9.91,10.18
2023-12-10,Bayern,09,00+,959,1231,1288,1275,1309,13140183,7.3,9.37,9.81,9.7,9.96
2023-12-09,Bayern,09,00+,972,1234,1291,1277,1311,13140183,7.4,9.39,9.83,9.72,9.98
2023-12-08,Bayern,09,00+,926,1255,1306,1293,1326,13140183,7.05,9.55,9.94,9.85,10.1
2023-12-07,Bayern,09,00+,907,1208,1251,1239,1269,13140183,6.9,9.19,9.52,9.43,9.66
2023-12-06,Bayern,09,00+,881,1189,1225,1214,1243,13140183,6.7,9.05,9.33,9.25,9.46
2023-12-05,Bayern,09,00+,868,1184,1215,1205,1231,13140183,6.61,9.01,9.25,9.18,9.37
2023-12-04,Bayern,09,00+,914,1177,1202,1193,1217,13140183,6.96,8.96,9.15,9.08,9.26
2023-12-03,Bayern,09,00+,929,1170,1194,1185,1209,13140183,7.07,8.9,9.09,9.02,9.2
2023-12-02,Bayern,09,00+,951,1178,1202,1193,1217,13140183,7.24,8.96,9.15,9.09,9.26
2023-12-01,Bayern,09,00+,843,1151,1172,1164,1186,13140183,6.42,8.76,8.92,8.86,9.03
2023-11-30,Bayern,09,00+,810,1123,1141,1134,1154,13140183,6.16,8.55,8.69,8.64,8.79
2023-11-29,Bayern,09,00+,735,1103,1119,1113,1130,13140183,5.59,8.39,8.52,8.47,8.6
2023-11-28,Bayern,09,00+,775,1086,1100,1094,1109,13140183,5.9,8.26,8.37,8.33,8.45
2023-11-27,Bayern,09,00+,791,1089,1100,1095,1108,13140183,6.02,8.29,8.37,8.34,8.43
2023-11-26,Bayern,09,00+,807,1092,1103,1098,1111,13140183,6.14,8.31,8.4,8.36,8.46
2023-11-25,Bayern,09,00+,824,1086,1096,1092,1104,13140183,6.27,8.26,8.35,8.31,8.41
2023-11-24,Bayern,09,00+,734,1065,1074,1070,1080,13140183,5.59,8.1,8.18,8.15,8.23
2023-11-23,Bayern,09,00+,786,1071,1079,1076,1084,13140183,5.98,8.15,8.21,8.19,8.26
2023-11-22,Bayern,09,00+,787,1096,1103,1100,1107,13140183,5.99,8.34,8.4,8.38,8.43
2023-11-21,Bayern,09,00+,750,1043,1048,1046,1051,13140183,5.71,7.94,7.98,7.96,8
2023-11-20,Bayern,09,00+,775,1054,1057,1056,1059,13140183,5.9,8.02,8.05,8.04,8.06
2023-11-19,Bayern,09,00+,800,1064,1067,1066,1068,13140183,6.09,8.1,8.12,8.12,8.13
2023-11-18,Bayern,09,00+,845,1091,1094,1093,1095,13140183,6.43,8.3,8.33,8.32,8.34
2023-11-17,Bayern,09,00+,771,1096,1098,1097,1099,13140183,5.87,8.34,8.36,8.36,8.37
2023-11-16,Bayern,09,00+,795,1103,1105,1104,1105,13140183,6.05,8.39,8.41,8.4,8.42
2023-11-15,Bayern,09,00+,814,1121,1122,1121,1122,13140183,6.19,8.53,8.54,8.54,8.54
2023-11-14,Bayern,09,00+,716,1126,1126,1126,1127,13140183,5.45,8.57,8.58,8.57,8.58
2023-11-13,Bayern,09,00+,822,1173,1173,1173,1173,13140183,6.26,8.93,8.93,8.93,8.93
2023-11-12,Bayern,09,00+,843,1166,1166,1166,1166,13140183,6.42,8.87,8.87,8.87,8.87
2023-11-11,Bayern,09,00+,860,1141,1141,1141,1141,13140183,6.54,8.68,8.68,8.68,8.68
2023-11-10,Bayern,09,00+,827,1168,1168,1168,1168,13140183,6.29,8.89,8.89,8.89,8.89
2023-11-09,Bayern,09,00+,883,1260,1260,1260,1260,13140183,6.72,9.59,9.59,9.59,9.59
2023-11-08,Bayern,09,00+,774,1059,1059,1059,1059,13140183,5.89,8.06,8.06,8.06,8.06
2023-11-07,Bayern,09,00+,790,1095,1095,1095,1095,13140183,6.01,8.33,8.33,8.33,8.33
2023-11-06,Bayern,09,00+,721,1077,1077,1077,1077,13140183,5.49,8.2,8.2,8.2,8.2
2023-11-05,Bayern,09,00+,744,1084,1084,1084,1084,13140183,5.66,8.25,8.25,8.25,8.25
2023-11-04,Bayern,09,00+,765,1088,1088,1088,1088,13140183,5.82,8.28,8.28,8.28,8.28
2023-11-03,Bayern,09,00+,734,1107,1107,1107,1107,13140183,5.59,8.42,8.42,8.42,8.42
2023-11-02,Bayern,09,00+,675,1019,1019,1019,1019,13140183,5.14,7.75,7.75,7.75,7.75
2023-11-01,Bayern,09,00+,881,1228,1228,1228,1228,13140183,6.7,9.35,9.35,9.35,9.35
2023-10-31,Bayern,09,00+,862,1259,1259,1259,1259,13140183,6.56,9.58,9.58,9.58,9.58
2023-10-30,Bayern,09,00+,885,1286,1286,1286,1286,13140183,6.74,9.79,9.79,9.79,9.79
2023-10-29,Bayern,09,00+,915,1291,1291,1291,1291,13140183,6.96,9.82,9.82,9.82,9.82
2023-10-28,Bayern,09,00+,928,1282,1282,1282,1282,13140183,7.06,9.76,9.76,9.76,9.76
2023-10-27,Bayern,09,00+,857,1247,1247,1247,1247,13140183,6.52,9.49,9.49,9.49,9.49
...
2023-10-24,Bayern,09,00+,631,1005,1005,1005,1005,13140183,4.8,7.65,7.65,7.65,7.65
...
2023-10-17,Bayern,09,00+,640,993,993,993,993,13140183,4.87,7.56,7.56,7.56,7.56
2023-10-16,Bayern,09,00+,635,950,950,950,950,13140183,4.83,7.23,7.23,7.23,7.23
2023-10-15,Bayern,09,00+,653,960,960,960,960,13140183,4.97,7.31,7.31,7.31,7.31
2023-10-14,Bayern,09,00+,673,956,956,956,956,13140183,5.12,7.28,7.28,7.28,7.28
2023-10-13,Bayern,09,00+,600,912,912,912,912,13140183,4.57,6.94,6.94,6.94,6.94
2023-10-12,Bayern,09,00+,635,905,905,905,905,13140183,4.83,6.89,6.89,6.89,6.89
2023-10-11,Bayern,09,00+,649,957,957,957,957,13140183,4.94,7.28,7.28,7.28,7.28
2023-10-10,Bayern,09,00+,501,791,791,791,791,13140183,3.81,6.02,6.02,6.02,6.02
2023-10-09,Bayern,09,00+,467,748,748,748,748,13140183,3.55,5.69,5.69,5.69,5.69
...
2023-09-25,Bayern,09,00+,306,429,429,429,429,13140183,2.33,3.26,3.26,3.26,3.26
2023-09-24,Bayern,09,00+,316,428,428,428,428,13140183,2.4,3.26,3.26,3.26,3.26
2023-09-23,Bayern,09,00+,326,429,429,429,429,13140183,2.48,3.26,3.26,3.26,3.26
2023-09-22,Bayern,09,00+,301,419,419,419,419,13140183,2.29,3.19,3.19,3.19,3.19
2023-09-21,Bayern,09,00+,302,399,399,399,399,13140183,2.3,3.04,3.04,3.04,3.04
2023-09-20,Bayern,09,00+,269,387,387,387,387,13140183,2.05,2.95,2.95,2.95,2.95
2023-09-19,Bayern,09,00+,232,379,379,379,379,13140183,1.77,2.88,2.88,2.88,2.88
2023-09-18,Bayern,09,00+,259,379,379,379,379,13140183,1.97,2.88,2.88,2.88,2.88
2023-09-17,Bayern,09,00+,267,376,376,376,376,13140183,2.03,2.86,2.86,2.86,2.86
2023-09-16,Bayern,09,00+,272,374,374,374,374,13140183,2.07,2.85,2.85,2.85,2.85
2023-09-15,Bayern,09,00+,263,372,372,372,372,13140183,2,2.83,2.83,2.83,2.83
2023-09-14,Bayern,09,00+,244,354,354,354,354,13140183,1.86,2.69,2.69,2.69,2.69
2023-09-13,Bayern,09,00+,222,346,346,346,346,13140183,1.69,2.63,2.63,2.63,2.63
2023-09-12,Bayern,09,00+,176,302,302,302,302,13140183,1.34,2.3,2.3,2.3,2.3
...
2023-09-08,Bayern,09,00+,138,229,229,229,229,13140183,1.05,1.74,1.74,1.74,1.74
2023-09-07,Bayern,09,00+,135,207,207,207,207,13140183,1.03,1.58,1.58,1.58,1.58
2023-09-06,Bayern,09,00+,135,198,198,198,198,13140183,1.03,1.51,1.51,1.51,1.51
2023-09-05,Bayern,09,00+,123,191,191,191,191,13140183,0.94,1.45,1.45,1.45,1.45
2023-09-04,Bayern,09,00+,129,185,185,185,185,13140183,0.98,1.41,1.41,1.41,1.41
2023-09-03,Bayern,09,00+,133,182,182,182,182,13140183,1.01,1.39,1.39,1.39,1.39
2023-09-02,Bayern,09,00+,138,181,181,181,181,13140183,1.05,1.38,1.38,1.38,1.38
2023-09-01,Bayern,09,00+,134,187,187,187,187,13140183,1.02,1.42,1.42,1.42,1.42
2023-08-31,Bayern,09,00+,134,186,186,186,186,13140183,1.02,1.42,1.42,1.42,1.42
2023-08-30,Bayern,09,00+,132,188,188,188,188,13140183,1,1.43,1.43,1.43,1.43
2023-08-29,Bayern,09,00+,132,200,200,200,200,13140183,1,1.52,1.52,1.52,1.52
2023-08-28,Bayern,09,00+,0,192,192,192,192,13140183,0,1.46,1.46,1.46,1.46
2023-08-27,Bayern,09,00+,0,200,200,200,200,13140183,0,1.52,1.52,1.52,1.52
2023-08-26,Bayern,09,00+,0,200,200,200,200,13140183,0,1.52,1.52,1.52,1.52
2023-08-25,Bayern,09,00+,0,207,207,207,207,13140183,0,1.58,1.58,1.58,1.58
2023-08-24,Bayern,09,00+,112,219,219,219,219,13140183,0.85,1.67,1.67,1.67,1.67
2023-08-23,Bayern,09,00+,154,236,236,236,236,13140183,1.17,1.8,1.8,1.8,1.8
2023-08-22,Bayern,09,00+,116,202,202,202,202,13140183,0.88,1.54,1.54,1.54,1.54
2023-08-21,Bayern,09,00+,119,216,216,216,216,13140183,0.91,1.64,1.64,1.64,1.64
2023-08-20,Bayern,09,00+,123,208,208,208,208,13140183,0.94,1.58,1.58,1.58,1.58
2023-08-19,Bayern,09,00+,125,206,206,206,206,13140183,0.95,1.57,1.57,1.57,1.57
2023-08-18,Bayern,09,00+,95,185,185,185,185,13140183,0.72,1.41,1.41,1.41,1.41
2023-08-17,Bayern,09,00+,77,155,155,155,155,13140183,0.59,1.18,1.18,1.18,1.18
2023-08-16,Bayern,09,00+,61,128,128,128,128,13140183,0.46,0.97,0.97,0.97,0.97
2023-08-15,Bayern,09,00+,77,141,141,141,141,13140183,0.59,1.07,1.07,1.07,1.07
2023-08-14,Bayern,09,00+,69,102,102,102,102,13140183,0.53,0.78,0.78,0.78,0.78
2023-08-13,Bayern,09,00+,74,104,104,104,104,13140183,0.56,0.79,0.79,0.79,0.79
2023-08-12,Bayern,09,00+,77,105,105,105,105,13140183,0.59,0.8,0.8,0.8,0.8
2023-08-11,Bayern,09,00+,73,107,107,107,107,13140183,0.56,0.81,0.81,0.81,0.81
2023-08-10,Bayern,09,00+,70,104,104,104,104,13140183,0.53,0.79,0.79,0.79,0.79
2023-08-09,Bayern,09,00+,58,97,97,97,97,13140183,0.44,0.74,0.74,0.74,0.74
2023-08-08,Bayern,09,00+,48,90,90,90,90,13140183,0.37,0.68,0.68,0.68,0.68
...
2023-08-03,Bayern,09,00+,51,80,80,80,80,13140183,0.39,0.61,0.61,0.61,0.61
2023-08-02,Bayern,09,00+,49,74,74,74,74,13140183,0.37,0.56,0.56,0.56,0.56
2023-08-01,Bayern,09,00+,46,70,70,70,70,13140183,0.35,0.53,0.53,0.53,0.53
2023-07-31,Bayern,09,00+,53,69,69,69,69,13140183,0.4,0.53,0.53,0.53,0.53
2023-07-30,Bayern,09,00+,54,69,69,69,69,13140183,0.41,0.53,0.53,0.53,0.53
2023-07-29,Bayern,09,00+,56,66,66,66,66,13140183,0.43,0.5,0.5,0.5,0.5
2023-07-28,Bayern,09,00+,51,67,67,67,67,13140183,0.39,0.51,0.51,0.51,0.51
...
2023-03-10,Bayern,09,00+,1305,1727,1727,1727,1727,13140183,9.93,13.14,13.14,13.14,13.14
2023-03-09,Bayern,09,00+,1312,1795,1795,1795,1795,13140183,9.98,13.66,13.66,13.66,13.66
...
2023-03-03,Bayern,09,00+,1635,2217,2217,2217,2217,13140183,12.44,16.87,16.87,16.87,16.87
2023-03-02,Bayern,09,00+,1669,2295,2295,2295,2295,13140183,12.7,17.47,17.47,17.47,17.47
...
2023-02-14,Bayern,09,00+,1437,2087,2087,2087,2087,13140183,10.94,15.88,15.88,15.88,15.88
2023-02-13,Bayern,09,00+,1408,1961,1961,1961,1961,13140183,10.72,14.92,14.92,14.92,14.92
2023-02-12,Bayern,09,00+,1448,1937,1937,1937,1937,13140183,11.02,14.74,14.74,14.74,14.74
2023-02-11,Bayern,09,00+,1484,1915,1915,1915,1915,13140183,11.29,14.57,14.57,14.57,14.57
2023-02-10,Bayern,09,00+,1444,1894,1894,1894,1894,13140183,10.99,14.41,14.41,14.41,14.41
2023-02-09,Bayern,09,00+,1340,1802,1802,1802,1802,13140183,10.2,13.71,13.71,13.71,13.71
2023-02-08,Bayern,09,00+,1293,1770,1770,1770,1770,13140183,9.84,13.47,13.47,13.47,13.47
2023-02-07,Bayern,09,00+,1185,1679,1679,1679,1679,13140183,9.02,12.78,12.78,12.78,12.78
2023-02-06,Bayern,09,00+,1096,1544,1544,1544,1544,13140183,8.34,11.75,11.75,11.75,11.75
2023-02-05,Bayern,09,00+,1135,1547,1547,1547,1547,13140183,8.64,11.77,11.77,11.77,11.77
2023-02-04,Bayern,09,00+,1167,1549,1549,1549,1549,13140183,8.88,11.79,11.79,11.79,11.79
2023-02-03,Bayern,09,00+,1144,1520,1520,1520,1520,13140183,8.71,11.57,11.57,11.57,11.57
2023-02-02,Bayern,09,00+,1143,1511,1511,1511,1511,13140183,8.7,11.5,11.5,11.5,11.5
2023-02-01,Bayern,09,00+,1056,1405,1405,1405,1405,13140183,8.04,10.69,10.69,10.69,10.69
...
2023-01-17,Bayern,09,00+,773,1271,1271,1271,1271,13140183,5.88,9.67,9.67,9.67,9.67
2023-01-16,Bayern,09,00+,1067,1434,1434,1434,1434,13140183,8.12,10.91,10.91,10.91,10.91
2023-01-15,Bayern,09,00+,1109,1453,1453,1453,1453,13140183,8.44,11.06,11.06,11.06,11.06
2023-01-14,Bayern,09,00+,1149,1469,1469,1469,1469,13140183,8.74,11.18,11.18,11.18,11.18
2023-01-13,Bayern,09,00+,1040,1324,1324,1324,1324,13140183,7.91,10.08,10.08,10.08,10.08
2023-01-12,Bayern,09,00+,1094,1412,1412,1412,1412,13140183,8.33,10.75,10.75,10.75,10.75
2023-01-11,Bayern,09,00+,1070,1434,1434,1434,1434,13140183,8.14,10.91,10.91,10.91,10.91
2023-01-10,Bayern,09,00+,973,1461,1461,1461,1461,13140183,7.4,11.12,11.12,11.12,11.12
2023-01-09,Bayern,09,00+,826,1357,1357,1357,1357,13140183,6.29,10.33,10.33,10.33,10.33
2023-01-08,Bayern,09,00+,863,1352,1352,1352,1352,13140183,6.57,10.29,10.29,10.29,10.29
...
2023-12-20,Saarland,10,00+,36,36,NA,NA,NA,983991,3.66,3.66,NA,NA,NA
2023-12-19,Saarland,10,00+,37,40,NA,NA,NA,983991,3.76,4.07,NA,NA,NA
2023-12-18,Saarland,10,00+,47,50,NA,NA,NA,983991,4.78,5.08,NA,NA,NA
2023-12-17,Saarland,10,00+,47,50,59,57,62,983991,4.78,5.08,6.01,5.81,6.4
2023-12-16,Saarland,10,00+,47,50,59,57,62,983991,4.78,5.08,6.01,5.81,6.4
2023-12-15,Saarland,10,00+,45,55,64,62,67,983991,4.57,5.59,6.52,6.33,6.87
2023-12-14,Saarland,10,00+,31,43,48,47,50,983991,3.15,4.37,4.91,4.78,5.16
2023-12-13,Saarland,10,00+,35,47,51,50,53,983991,3.56,4.78,5.23,5.12,5.43
2023-12-12,Saarland,10,00+,55,68,72,70,74,983991,5.59,6.91,7.34,7.21,7.54
2023-12-11,Saarland,10,00+,49,63,65,64,66,983991,4.98,6.4,6.69,6.6,6.8
2023-12-10,Saarland,10,00+,49,63,65,64,66,983991,4.98,6.4,6.69,6.6,6.8
2023-12-09,Saarland,10,00+,49,63,65,64,66,983991,4.98,6.4,6.69,6.6,6.8
2023-12-08,Saarland,10,00+,54,69,71,70,72,983991,5.49,7.01,7.29,7.2,7.4
2023-12-07,Saarland,10,00+,54,72,74,73,75,983991,5.49,7.32,7.6,7.5,7.71
2023-12-06,Saarland,10,00+,53,66,68,67,69,983991,5.39,6.71,6.94,6.86,7.05
2023-12-05,Saarland,10,00+,35,42,43,42,43,983991,3.56,4.27,4.38,4.34,4.44
2023-12-04,Saarland,10,00+,42,50,51,50,51,983991,4.27,5.08,5.19,5.14,5.25
2023-12-03,Saarland,10,00+,42,50,51,50,51,983991,4.27,5.08,5.19,5.14,5.25
2023-12-02,Saarland,10,00+,42,50,51,50,51,983991,4.27,5.08,5.19,5.14,5.25
2023-12-01,Saarland,10,00+,40,44,44,44,45,983991,4.07,4.47,4.55,4.52,4.61
2023-11-30,Saarland,10,00+,37,49,49,49,50,983991,3.76,4.98,5.06,5.03,5.11
2023-11-29,Saarland,10,00+,39,51,51,51,52,983991,3.96,5.18,5.26,5.23,5.31
2023-11-28,Saarland,10,00+,30,54,54,54,55,983991,3.05,5.49,5.56,5.53,5.61
2023-11-27,Saarland,10,00+,36,47,47,47,47,983991,3.66,4.78,4.83,4.81,4.86
2023-11-26,Saarland,10,00+,36,47,47,47,47,983991,3.66,4.78,4.83,4.81,4.86
2023-11-25,Saarland,10,00+,37,48,48,48,48,983991,3.76,4.88,4.93,4.91,4.96
2023-11-24,Saarland,10,00+,36,45,45,45,45,983991,3.66,4.57,4.62,4.6,4.65
2023-11-23,Saarland,10,00+,26,38,38,38,38,983991,2.64,3.86,3.89,3.88,3.92
2023-11-22,Saarland,10,00+,32,40,40,40,40,983991,3.25,4.07,4.09,4.08,4.11
2023-11-21,Saarland,10,00+,29,35,35,35,35,983991,2.95,3.56,3.58,3.57,3.59
2023-11-20,Saarland,10,00+,38,45,45,45,45,983991,3.86,4.57,4.59,4.58,4.59
2023-11-19,Saarland,10,00+,38,45,45,45,45,983991,3.86,4.57,4.59,4.58,4.59
2023-11-18,Saarland,10,00+,38,44,44,44,44,983991,3.86,4.47,4.48,4.48,4.49
2023-11-17,Saarland,10,00+,44,50,50,50,50,983991,4.47,5.08,5.09,5.09,5.1
2023-11-16,Saarland,10,00+,45,53,53,53,53,983991,4.57,5.39,5.4,5.39,5.4
2023-11-15,Saarland,10,00+,44,51,51,51,51,983991,4.47,5.18,5.19,5.19,5.19
2023-11-14,Saarland,10,00+,37,51,51,51,51,983991,3.76,5.18,5.19,5.19,5.19
...
2023-12-20,Berlin,11,00+,539,539,NA,NA,NA,3664088,14.71,14.71,NA,NA,NA
2023-12-19,Berlin,11,00+,488,606,NA,NA,NA,3664088,13.32,16.54,NA,NA,NA
2023-12-18,Berlin,11,00+,485,608,NA,NA,NA,3664088,13.24,16.59,NA,NA,NA
2023-12-17,Berlin,11,00+,485,608,698,685,720,3664088,13.24,16.59,19.07,18.7,19.67
2023-12-16,Berlin,11,00+,485,608,698,685,720,3664088,13.24,16.59,19.07,18.7,19.67
2023-12-15,Berlin,11,00+,480,660,732,718,751,3664088,13.1,18.01,20,19.62,20.5
2023-12-14,Berlin,11,00+,477,630,691,679,704,3664088,13.02,17.19,18.86,18.56,19.21
2023-12-13,Berlin,11,00+,471,691,743,733,756,3664088,12.85,18.86,20.3,20.01,20.65
2023-12-12,Berlin,11,00+,495,735,779,769,792,3664088,13.51,20.06,21.27,21,21.64
2023-12-11,Berlin,11,00+,449,713,747,739,759,3664088,12.25,19.46,20.39,20.17,20.73
2023-12-10,Berlin,11,00+,449,713,747,739,759,3664088,12.25,19.46,20.39,20.17,20.73
2023-12-09,Berlin,11,00+,449,713,747,739,759,3664088,12.25,19.46,20.39,20.17,20.73
2023-12-08,Berlin,11,00+,420,642,669,662,679,3664088,11.46,17.52,18.27,18.08,18.55
2023-12-07,Berlin,11,00+,392,610,633,626,642,3664088,10.7,16.65,17.28,17.11,17.54
2023-12-06,Berlin,11,00+,299,528,545,540,552,3664088,8.16,14.41,14.88,14.74,15.09
2023-12-05,Berlin,11,00+,321,465,477,473,483,3664088,8.76,12.69,13.02,12.92,13.2
2023-12-04,Berlin,11,00+,384,461,470,467,476,3664088,10.48,12.58,12.84,12.75,13
2023-12-03,Berlin,11,00+,384,461,470,467,476,3664088,10.48,12.58,12.84,12.75,13
2023-12-02,Berlin,11,00+,384,461,470,467,476,3664088,10.48,12.58,12.84,12.75,13
2023-12-01,Berlin,11,00+,392,482,491,487,496,3664088,10.7,13.15,13.4,13.31,13.56
2023-11-30,Berlin,11,00+,375,471,478,475,484,3664088,10.23,12.85,13.07,12.99,13.21
2023-11-29,Berlin,11,00+,369,477,484,481,488,3664088,10.07,13.02,13.21,13.14,13.34
2023-11-28,Berlin,11,00+,409,513,519,516,523,3664088,11.16,14,14.17,14.11,14.29
2023-11-27,Berlin,11,00+,421,499,504,502,507,3664088,11.49,13.62,13.76,13.7,13.85
2023-11-26,Berlin,11,00+,421,499,504,502,507,3664088,11.49,13.62,13.76,13.7,13.85
2023-11-25,Berlin,11,00+,421,499,504,502,507,3664088,11.49,13.62,13.76,13.7,13.85
2023-11-24,Berlin,11,00+,388,469,473,471,476,3664088,10.59,12.8,12.92,12.87,12.99
2023-11-23,Berlin,11,00+,352,481,484,483,487,3664088,9.61,13.13,13.23,13.19,13.3
2023-11-22,Berlin,11,00+,343,460,463,461,465,3664088,9.36,12.55,12.64,12.61,12.69
2023-11-21,Berlin,11,00+,313,413,415,414,416,3664088,8.54,11.27,11.33,11.31,11.36
2023-11-20,Berlin,11,00+,358,430,431,430,431,3664088,9.77,11.74,11.77,11.76,11.79
2023-11-19,Berlin,11,00+,358,430,431,430,431,3664088,9.77,11.74,11.77,11.76,11.79
2023-11-18,Berlin,11,00+,362,434,435,434,435,3664088,9.88,11.84,11.88,11.87,11.9
2023-11-17,Berlin,11,00+,336,437,438,437,438,3664088,9.17,11.93,11.96,11.95,11.97
2023-11-16,Berlin,11,00+,327,427,427,427,428,3664088,8.92,11.65,11.68,11.67,11.68
2023-11-15,Berlin,11,00+,358,443,443,443,443,3664088,9.77,12.09,12.11,12.1,12.11
2023-11-14,Berlin,11,00+,312,433,433,433,433,3664088,8.52,11.82,11.83,11.82,11.83
2023-11-13,Berlin,11,00+,337,396,396,396,396,3664088,9.2,10.81,10.81,10.81,10.81
2023-11-12,Berlin,11,00+,337,396,396,396,396,3664088,9.2,10.81,10.81,10.81,10.81
2023-11-11,Berlin,11,00+,337,392,392,392,392,3664088,9.2,10.7,10.7,10.7,10.7
2023-11-10,Berlin,11,00+,326,387,387,387,387,3664088,8.9,10.56,10.56,10.56,10.56
...
2023-11-06,Berlin,11,00+,357,427,427,427,427,3664088,9.74,11.65,11.65,11.65,11.65
2023-11-05,Berlin,11,00+,360,430,430,430,430,3664088,9.83,11.74,11.74,11.74,11.74
2023-11-04,Berlin,11,00+,360,430,430,430,430,3664088,9.83,11.74,11.74,11.74,11.74
2023-11-03,Berlin,11,00+,354,434,434,434,434,3664088,9.66,11.84,11.84,11.84,11.84
2023-11-02,Berlin,11,00+,348,434,434,434,434,3664088,9.5,11.84,11.84,11.84,11.84
2023-11-01,Berlin,11,00+,320,435,435,435,435,3664088,8.73,11.87,11.87,11.87,11.87
2023-10-31,Berlin,11,00+,290,385,385,385,385,3664088,7.91,10.51,10.51,10.51,10.51
...
2023-10-26,Berlin,11,00+,190,253,253,253,253,3664088,5.19,6.9,6.9,6.9,6.9
2023-10-25,Berlin,11,00+,153,215,215,215,215,3664088,4.18,5.87,5.87,5.87,5.87
2023-10-24,Berlin,11,00+,125,187,187,187,187,3664088,3.41,5.1,5.1,5.1,5.1
2023-10-23,Berlin,11,00+,116,151,151,151,151,3664088,3.17,4.12,4.12,4.12,4.12
2023-10-22,Berlin,11,00+,116,151,151,151,151,3664088,3.17,4.12,4.12,4.12,4.12
2023-10-21,Berlin,11,00+,116,151,151,151,151,3664088,3.17,4.12,4.12,4.12,4.12
2023-10-20,Berlin,11,00+,99,143,143,143,143,3664088,2.7,3.9,3.9,3.9,3.9
...
2023-05-31,Berlin,11,00+,35,58,58,58,58,3664088,0.96,1.58,1.58,1.58,1.58
2023-05-30,Berlin,11,00+,32,53,53,53,53,3664088,0.87,1.45,1.45,1.45,1.45
2023-05-29,Berlin,11,00+,72,96,96,96,96,3664088,1.97,2.62,2.62,2.62,2.62
2023-05-28,Berlin,11,00+,72,96,96,96,96,3664088,1.97,2.62,2.62,2.62,2.62
2023-05-27,Berlin,11,00+,72,96,96,96,96,3664088,1.97,2.62,2.62,2.62,2.62
2023-05-26,Berlin,11,00+,73,92,92,92,92,3664088,1.99,2.51,2.51,2.51,2.51
2023-05-25,Berlin,11,00+,64,83,83,83,83,3664088,1.75,2.27,2.27,2.27,2.27
...
2023-03-30,Berlin,11,00+,320,434,434,434,434,3664088,8.73,11.84,11.84,11.84,11.84
2023-03-29,Berlin,11,00+,307,445,445,445,445,3664088,8.38,12.14,12.14,12.14,12.14
2023-03-28,Berlin,11,00+,328,538,538,538,538,3664088,8.95,14.68,14.68,14.68,14.68
2023-03-27,Berlin,11,00+,396,596,596,596,596,3664088,10.81,16.27,16.27,16.27,16.27
2023-03-26,Berlin,11,00+,396,592,592,592,592,3664088,10.81,16.16,16.16,16.16,16.16
2023-03-25,Berlin,11,00+,396,591,591,591,591,3664088,10.81,16.13,16.13,16.13,16.13
2023-03-24,Berlin,11,00+,412,622,622,622,622,3664088,11.24,16.98,16.98,16.98,16.98
...
2023-01-10,Berlin,11,00+,207,422,422,422,422,3664088,5.65,11.52,11.52,11.52,11.52
2023-01-09,Berlin,11,00+,273,481,481,481,481,3664088,7.45,13.13,13.13,13.13,13.13
2023-01-08,Berlin,11,00+,273,481,481,481,481,3664088,7.45,13.13,13.13,13.13,13.13
...
2023-12-20,Brandenburg,12,00+,502,502,NA,NA,NA,2531071,19.83,19.83,NA,NA,NA
2023-12-19,Brandenburg,12,00+,546,594,NA,NA,NA,2531071,21.57,23.47,NA,NA,NA
2023-12-18,Brandenburg,12,00+,560,635,NA,NA,NA,2531071,22.13,25.09,NA,NA,NA
2023-12-17,Brandenburg,12,00+,560,627,703,689,725,2531071,22.13,24.77,27.81,27.23,28.66
2023-12-16,Brandenburg,12,00+,567,624,696,683,712,2531071,22.4,24.65,27.53,26.99,28.17
2023-12-15,Brandenburg,12,00+,592,671,739,725,756,2531071,23.39,26.51,29.21,28.67,29.89
2023-12-14,Brandenburg,12,00+,585,676,735,723,750,2531071,23.11,26.71,29.05,28.58,29.67
2023-12-13,Brandenburg,12,00+,583,681,732,722,746,2531071,23.03,26.91,28.93,28.53,29.5
2023-12-12,Brandenburg,12,00+,504,630,670,662,682,2531071,19.91,24.89,26.48,26.16,26.97
2023-12-11,Brandenburg,12,00+,510,612,640,634,651,2531071,20.15,24.18,25.32,25.07,25.73
2023-12-10,Brandenburg,12,00+,513,615,643,637,654,2531071,20.27,24.3,25.44,25.19,25.86
2023-12-09,Brandenburg,12,00+,513,608,636,630,646,2531071,20.27,24.02,25.15,24.9,25.55
2023-12-08,Brandenburg,12,00+,504,577,600,595,610,2531071,19.91,22.8,23.74,23.52,24.11
2023-12-07,Brandenburg,12,00+,463,555,574,569,583,2531071,18.29,21.93,22.71,22.51,23.05
2023-12-06,Brandenburg,12,00+,435,517,533,528,540,2531071,17.19,20.43,21.07,20.88,21.36
2023-12-05,Brandenburg,12,00+,402,518,532,527,539,2531071,15.88,20.47,21.03,20.85,21.31
2023-12-04,Brandenburg,12,00+,406,493,503,499,509,2531071,16.04,19.48,19.89,19.73,20.13
2023-12-03,Brandenburg,12,00+,408,492,502,498,508,2531071,16.12,19.44,19.85,19.69,20.09
2023-12-02,Brandenburg,12,00+,412,497,507,503,513,2531071,16.28,19.64,20.05,19.89,20.29
2023-12-01,Brandenburg,12,00+,432,516,525,521,531,2531071,17.07,20.39,20.77,20.61,21.02
2023-11-30,Brandenburg,12,00+,408,488,496,492,501,2531071,16.12,19.28,19.6,19.47,19.82
2023-11-29,Brandenburg,12,00+,400,492,499,496,504,2531071,15.8,19.44,19.73,19.61,19.93
2023-11-28,Brandenburg,12,00+,436,514,520,517,525,2531071,17.23,20.31,20.57,20.46,20.76
2023-11-27,Brandenburg,12,00+,427,494,499,497,502,2531071,16.87,19.52,19.72,19.64,19.87
2023-11-26,Brandenburg,12,00+,429,494,499,497,502,2531071,16.95,19.52,19.72,19.64,19.86
2023-11-25,Brandenburg,12,00+,436,496,501,499,504,2531071,17.23,19.6,19.8,19.72,19.94
2023-11-24,Brandenburg,12,00+,409,468,472,470,474,2531071,16.16,18.49,18.66,18.59,18.76
2023-11-23,Brandenburg,12,00+,426,486,489,488,492,2531071,16.83,19.2,19.35,19.3,19.45
2023-11-22,Brandenburg,12,00+,401,479,482,481,484,2531071,15.84,18.92,19.05,19.01,19.13
2023-11-21,Brandenburg,12,00+,363,441,443,442,444,2531071,14.34,17.42,17.52,17.48,17.57
2023-11-20,Brandenburg,12,00+,380,439,440,440,441,2531071,15.01,17.34,17.4,17.38,17.43
2023-11-19,Brandenburg,12,00+,381,439,440,440,441,2531071,15.05,17.34,17.4,17.38,17.43
2023-11-18,Brandenburg,12,00+,381,432,433,432,433,2531071,15.05,17.07,17.12,17.11,17.14
2023-11-17,Brandenburg,12,00+,335,411,412,411,412,2531071,13.24,16.24,16.28,16.27,16.3
2023-11-16,Brandenburg,12,00+,327,391,391,391,392,2531071,12.92,15.45,15.48,15.47,15.49
2023-11-15,Brandenburg,12,00+,318,396,396,396,396,2531071,12.56,15.65,15.67,15.66,15.67
2023-11-14,Brandenburg,12,00+,296,395,395,395,395,2531071,11.69,15.61,15.62,15.61,15.62
2023-11-13,Brandenburg,12,00+,340,395,395,395,395,2531071,13.43,15.61,15.61,15.61,15.61
2023-11-12,Brandenburg,12,00+,340,393,393,393,393,2531071,13.43,15.53,15.53,15.53,15.53
2023-11-11,Brandenburg,12,00+,345,398,398,398,398,2531071,13.63,15.72,15.73,15.73,15.73
2023-11-10,Brandenburg,12,00+,318,406,406,406,406,2531071,12.56,16.04,16.04,16.04,16.04
2023-11-09,Brandenburg,12,00+,363,439,439,439,439,2531071,14.34,17.34,17.34,17.34,17.34
2023-11-08,Brandenburg,12,00+,420,524,524,524,524,2531071,16.59,20.7,20.7,20.7,20.7
2023-11-07,Brandenburg,12,00+,348,458,458,458,458,2531071,13.75,18.1,18.1,18.1,18.1
2023-11-06,Brandenburg,12,00+,300,382,382,382,382,2531071,11.85,15.09,15.09,15.09,15.09
2023-11-05,Brandenburg,12,00+,305,387,387,387,387,2531071,12.05,15.29,15.29,15.29,15.29
2023-11-04,Brandenburg,12,00+,306,383,383,383,383,2531071,12.09,15.13,15.13,15.13,15.13
2023-11-03,Brandenburg,12,00+,266,363,363,363,363,2531071,10.51,14.34,14.34,14.34,14.34
2023-11-02,Brandenburg,12,00+,227,331,331,331,331,2531071,8.97,13.08,13.08,13.08,13.08
2023-11-01,Brandenburg,12,00+,140,244,244,244,244,2531071,5.53,9.64,9.64,9.64,9.64
2023-10-31,Brandenburg,12,00+,193,293,293,293,293,2531071,7.63,11.58,11.58,11.58,11.58
2023-10-30,Brandenburg,12,00+,247,336,336,336,336,2531071,9.76,13.28,13.28,13.28,13.28
2023-10-29,Brandenburg,12,00+,248,332,332,332,332,2531071,9.8,13.12,13.12,13.12,13.12
2023-10-28,Brandenburg,12,00+,251,334,334,334,334,2531071,9.92,13.2,13.2,13.2,13.2
2023-10-27,Brandenburg,12,00+,229,332,332,332,332,2531071,9.05,13.12,13.12,13.12,13.12
...
2023-10-24,Brandenburg,12,00+,198,257,257,257,257,2531071,7.82,10.15,10.15,10.15,10.15
2023-10-23,Brandenburg,12,00+,150,199,199,199,199,2531071,5.93,7.86,7.86,7.86,7.86
2023-10-22,Brandenburg,12,00+,152,201,201,201,201,2531071,6.01,7.94,7.94,7.94,7.94
2023-10-21,Brandenburg,12,00+,153,199,199,199,199,2531071,6.04,7.86,7.86,7.86,7.86
2023-10-20,Brandenburg,12,00+,152,195,195,195,195,2531071,6.01,7.7,7.7,7.7,7.7
2023-10-19,Brandenburg,12,00+,146,183,183,183,183,2531071,5.77,7.23,7.23,7.23,7.23
2023-10-18,Brandenburg,12,00+,92,171,171,171,171,2531071,3.63,6.76,6.76,6.76,6.76
...
2023-04-03,Brandenburg,12,00+,238,308,308,308,308,2531071,9.4,12.17,12.17,12.17,12.17
2023-04-02,Brandenburg,12,00+,238,307,307,307,307,2531071,9.4,12.13,12.13,12.13,12.13
2023-04-01,Brandenburg,12,00+,239,308,308,308,308,2531071,9.44,12.17,12.17,12.17,12.17
2023-03-31,Brandenburg,12,00+,237,320,320,320,320,2531071,9.36,12.64,12.64,12.64,12.64
2023-03-30,Brandenburg,12,00+,228,309,309,309,309,2531071,9.01,12.21,12.21,12.21,12.21
2023-03-29,Brandenburg,12,00+,242,326,326,326,326,2531071,9.56,12.88,12.88,12.88,12.88
2023-03-28,Brandenburg,12,00+,229,343,343,343,343,2531071,9.05,13.55,13.55,13.55,13.55
...
2023-01-25,Brandenburg,12,00+,128,157,157,157,157,2531071,5.06,6.2,6.2,6.2,6.2
2023-01-24,Brandenburg,12,00+,114,162,162,162,162,2531071,4.5,6.4,6.4,6.4,6.4
2023-01-23,Brandenburg,12,00+,153,194,194,194,194,2531071,6.04,7.66,7.66,7.66,7.66
2023-01-22,Brandenburg,12,00+,156,196,196,196,196,2531071,6.16,7.74,7.74,7.74,7.74
2023-01-21,Brandenburg,12,00+,157,197,197,197,197,2531071,6.2,7.78,7.78,7.78,7.78
2023-01-20,Brandenburg,12,00+,153,200,200,200,200,2531071,6.04,7.9,7.9,7.9,7.9
2023-01-19,Brandenburg,12,00+,172,224,224,224,224,2531071,6.8,8.85,8.85,8.85,8.85
2023-01-18,Brandenburg,12,00+,182,237,237,237,237,2531071,7.19,9.36,9.36,9.36,9.36
2023-01-17,Brandenburg,12,00+,190,251,251,251,251,2531071,7.51,9.92,9.92,9.92,9.92
2023-01-16,Brandenburg,12,00+,210,262,262,262,262,2531071,8.3,10.35,10.35,10.35,10.35
2023-01-15,Brandenburg,12,00+,211,260,260,260,260,2531071,8.34,10.27,10.27,10.27,10.27
2023-01-14,Brandenburg,12,00+,214,262,262,262,262,2531071,8.45,10.35,10.35,10.35,10.35
2023-01-13,Brandenburg,12,00+,231,283,283,283,283,2531071,9.13,11.18,11.18,11.18,11.18
2023-01-12,Brandenburg,12,00+,246,312,312,312,312,2531071,9.72,12.33,12.33,12.33,12.33
2023-01-11,Brandenburg,12,00+,258,339,339,339,339,2531071,10.19,13.39,13.39,13.39,13.39
...
2023-01-08,Brandenburg,12,00+,330,443,443,443,443,2531071,13.04,17.5,17.5,17.5,17.5
...
2023-12-20,Mecklenburg-Vorpommern,13,00+,323,323,NA,NA,NA,1610774,20.05,20.05,NA,NA,NA
2023-12-19,Mecklenburg-Vorpommern,13,00+,249,400,NA,NA,NA,1610774,15.46,24.83,NA,NA,NA
2023-12-18,Mecklenburg-Vorpommern,13,00+,313,387,NA,NA,NA,1610774,19.43,24.03,NA,NA,NA
2023-12-17,Mecklenburg-Vorpommern,13,00+,314,384,456,445,471,1610774,19.49,23.84,28.37,27.65,29.27
2023-12-16,Mecklenburg-Vorpommern,13,00+,317,386,457,446,473,1610774,19.68,23.96,28.41,27.72,29.37
2023-12-15,Mecklenburg-Vorpommern,13,00+,297,400,452,444,465,1610774,18.44,24.83,28.08,27.57,28.93
2023-12-14,Mecklenburg-Vorpommern,13,00+,315,377,411,404,419,1610774,19.56,23.4,25.53,25.11,26.04
2023-12-13,Mecklenburg-Vorpommern,13,00+,281,395,424,417,431,1610774,17.45,24.52,26.33,25.94,26.79
2023-12-12,Mecklenburg-Vorpommern,13,00+,239,409,434,428,442,1610774,14.84,25.39,26.98,26.61,27.44
2023-12-11,Mecklenburg-Vorpommern,13,00+,282,379,396,392,403,1610774,17.51,23.53,24.65,24.36,25.04
2023-12-10,Mecklenburg-Vorpommern,13,00+,284,380,397,393,404,1610774,17.63,23.59,24.71,24.42,25.11
2023-12-09,Mecklenburg-Vorpommern,13,00+,285,379,396,392,403,1610774,17.69,23.53,24.64,24.35,25.03
2023-12-08,Mecklenburg-Vorpommern,13,00+,252,342,356,352,361,1610774,15.64,21.23,22.13,21.89,22.47
2023-12-07,Mecklenburg-Vorpommern,13,00+,241,337,349,345,354,1610774,14.96,20.92,21.68,21.47,22
2023-12-06,Mecklenburg-Vorpommern,13,00+,202,332,342,339,347,1610774,12.54,20.61,21.27,21.08,21.57
2023-12-05,Mecklenburg-Vorpommern,13,00+,181,305,313,310,317,1610774,11.24,18.93,19.44,19.28,19.7
2023-12-04,Mecklenburg-Vorpommern,13,00+,237,303,309,307,313,1610774,14.71,18.81,19.2,19.06,19.44
2023-12-03,Mecklenburg-Vorpommern,13,00+,239,303,309,307,313,1610774,14.84,18.81,19.2,19.06,19.43
2023-12-02,Mecklenburg-Vorpommern,13,00+,244,308,314,312,318,1610774,15.15,19.12,19.51,19.38,19.75
2023-12-01,Mecklenburg-Vorpommern,13,00+,228,335,341,338,345,1610774,14.15,20.8,21.19,21.05,21.44
2023-11-30,Mecklenburg-Vorpommern,13,00+,233,323,328,326,331,1610774,14.47,20.05,20.39,20.26,20.61
2023-11-29,Mecklenburg-Vorpommern,13,00+,217,325,329,327,333,1610774,13.47,20.18,20.47,20.36,20.68
2023-11-28,Mecklenburg-Vorpommern,13,00+,194,307,310,309,313,1610774,12.04,19.06,19.31,19.21,19.48
2023-11-27,Mecklenburg-Vorpommern,13,00+,29,329,332,331,334,1610774,1.8,20.42,20.64,20.55,20.79
2023-11-26,Mecklenburg-Vorpommern,13,00+,30,329,332,330,334,1610774,1.86,20.42,20.64,20.55,20.79
2023-11-25,Mecklenburg-Vorpommern,13,00+,32,326,329,327,331,1610774,1.99,20.24,20.45,20.36,20.59
2023-11-24,Mecklenburg-Vorpommern,13,00+,74,322,324,323,326,1610774,4.59,19.99,20.17,20.1,20.28
2023-11-23,Mecklenburg-Vorpommern,13,00+,131,339,341,340,343,1610774,8.13,21.05,21.21,21.14,21.31
2023-11-22,Mecklenburg-Vorpommern,13,00+,187,342,344,343,345,1610774,11.61,21.23,21.37,21.32,21.45
2023-11-21,Mecklenburg-Vorpommern,13,00+,218,365,366,366,368,1610774,13.53,22.66,22.78,22.74,22.85
2023-11-20,Mecklenburg-Vorpommern,13,00+,249,343,344,343,344,1610774,15.46,21.29,21.37,21.35,21.4
2023-11-19,Mecklenburg-Vorpommern,13,00+,256,348,349,348,349,1610774,15.89,21.6,21.68,21.66,21.7
2023-11-18,Mecklenburg-Vorpommern,13,00+,259,347,348,347,348,1610774,16.08,21.54,21.61,21.59,21.64
2023-11-17,Mecklenburg-Vorpommern,13,00+,244,342,342,342,343,1610774,15.15,21.23,21.29,21.27,21.31
2023-11-16,Mecklenburg-Vorpommern,13,00+,242,341,341,341,341,1610774,15.02,21.17,21.21,21.2,21.22
2023-11-15,Mecklenburg-Vorpommern,13,00+,228,357,357,357,357,1610774,14.15,22.16,22.19,22.18,22.2
2023-11-14,Mecklenburg-Vorpommern,13,00+,197,348,348,348,348,1610774,12.23,21.6,21.62,21.61,21.62
2023-11-13,Mecklenburg-Vorpommern,13,00+,286,391,391,391,391,1610774,17.76,24.27,24.28,24.28,24.28
...
2023-10-31,Mecklenburg-Vorpommern,13,00+,108,201,201,201,201,1610774,6.7,12.48,12.48,12.48,12.48
2023-10-30,Mecklenburg-Vorpommern,13,00+,140,222,222,222,222,1610774,8.69,13.78,13.78,13.78,13.78
2023-10-29,Mecklenburg-Vorpommern,13,00+,140,221,221,221,221,1610774,8.69,13.72,13.72,13.72,13.72
2023-10-28,Mecklenburg-Vorpommern,13,00+,144,225,225,225,225,1610774,8.94,13.97,13.97,13.97,13.97
2023-10-27,Mecklenburg-Vorpommern,13,00+,123,191,191,191,191,1610774,7.64,11.86,11.86,11.86,11.86
2023-10-26,Mecklenburg-Vorpommern,13,00+,120,180,180,180,180,1610774,7.45,11.17,11.17,11.17,11.17
2023-10-25,Mecklenburg-Vorpommern,13,00+,106,178,178,178,178,1610774,6.58,11.05,11.05,11.05,11.05
...
2023-10-20,Mecklenburg-Vorpommern,13,00+,67,113,113,113,113,1610774,4.16,7.02,7.02,7.02,7.02
2023-10-19,Mecklenburg-Vorpommern,13,00+,62,103,103,103,103,1610774,3.85,6.39,6.39,6.39,6.39
2023-10-18,Mecklenburg-Vorpommern,13,00+,60,95,95,95,95,1610774,3.72,5.9,5.9,5.9,5.9
2023-10-17,Mecklenburg-Vorpommern,13,00+,53,97,97,97,97,1610774,3.29,6.02,6.02,6.02,6.02
2023-10-16,Mecklenburg-Vorpommern,13,00+,67,93,93,93,93,1610774,4.16,5.77,5.77,5.77,5.77
2023-10-15,Mecklenburg-Vorpommern,13,00+,67,90,90,90,90,1610774,4.16,5.59,5.59,5.59,5.59
2023-10-14,Mecklenburg-Vorpommern,13,00+,68,90,90,90,90,1610774,4.22,5.59,5.59,5.59,5.59
2023-10-13,Mecklenburg-Vorpommern,13,00+,70,93,93,93,93,1610774,4.35,5.77,5.77,5.77,5.77
2023-10-12,Mecklenburg-Vorpommern,13,00+,67,88,88,88,88,1610774,4.16,5.46,5.46,5.46,5.46
2023-10-11,Mecklenburg-Vorpommern,13,00+,67,94,94,94,94,1610774,4.16,5.84,5.84,5.84,5.84
2023-10-10,Mecklenburg-Vorpommern,13,00+,43,77,77,77,77,1610774,2.67,4.78,4.78,4.78,4.78
2023-10-09,Mecklenburg-Vorpommern,13,00+,46,68,68,68,68,1610774,2.86,4.22,4.22,4.22,4.22
2023-10-08,Mecklenburg-Vorpommern,13,00+,46,68,68,68,68,1610774,2.86,4.22,4.22,4.22,4.22
2023-10-07,Mecklenburg-Vorpommern,13,00+,46,67,67,67,67,1610774,2.86,4.16,4.16,4.16,4.16
...
2023-06-13,Mecklenburg-Vorpommern,13,00+,20,35,35,35,35,1610774,1.24,2.17,2.17,2.17,2.17
2023-06-12,Mecklenburg-Vorpommern,13,00+,18,30,30,30,30,1610774,1.12,1.86,1.86,1.86,1.86
2023-06-11,Mecklenburg-Vorpommern,13,00+,18,29,29,29,29,1610774,1.12,1.8,1.8,1.8,1.8
2023-06-10,Mecklenburg-Vorpommern,13,00+,18,29,29,29,29,1610774,1.12,1.8,1.8,1.8,1.8
2023-06-09,Mecklenburg-Vorpommern,13,00+,18,26,26,26,26,1610774,1.12,1.61,1.61,1.61,1.61
2023-06-08,Mecklenburg-Vorpommern,13,00+,22,30,30,30,30,1610774,1.37,1.86,1.86,1.86,1.86
2023-06-07,Mecklenburg-Vorpommern,13,00+,17,33,33,33,33,1610774,1.06,2.05,2.05,2.05,2.05
2023-06-06,Mecklenburg-Vorpommern,13,00+,23,29,29,29,29,1610774,1.43,1.8,1.8,1.8,1.8
2023-06-05,Mecklenburg-Vorpommern,13,00+,25,29,29,29,29,1610774,1.55,1.8,1.8,1.8,1.8
2023-06-04,Mecklenburg-Vorpommern,13,00+,25,29,29,29,29,1610774,1.55,1.8,1.8,1.8,1.8
2023-06-03,Mecklenburg-Vorpommern,13,00+,25,29,29,29,29,1610774,1.55,1.8,1.8,1.8,1.8
...
2023-05-22,Mecklenburg-Vorpommern,13,00+,30,47,47,47,47,1610774,1.86,2.92,2.92,2.92,2.92
2023-05-21,Mecklenburg-Vorpommern,13,00+,30,46,46,46,46,1610774,1.86,2.86,2.86,2.86,2.86
2023-05-20,Mecklenburg-Vorpommern,13,00+,33,48,48,48,48,1610774,2.05,2.98,2.98,2.98,2.98
2023-05-19,Mecklenburg-Vorpommern,13,00+,47,58,58,58,58,1610774,2.92,3.6,3.6,3.6,3.6
2023-05-18,Mecklenburg-Vorpommern,13,00+,61,73,73,73,73,1610774,3.79,4.53,4.53,4.53,4.53
2023-05-17,Mecklenburg-Vorpommern,13,00+,57,74,74,74,74,1610774,3.54,4.59,4.59,4.59,4.59
2023-05-16,Mecklenburg-Vorpommern,13,00+,57,74,74,74,74,1610774,3.54,4.59,4.59,4.59,4.59
...
2023-04-28,Mecklenburg-Vorpommern,13,00+,86,110,110,110,110,1610774,5.34,6.83,6.83,6.83,6.83
2023-04-27,Mecklenburg-Vorpommern,13,00+,95,123,123,123,123,1610774,5.9,7.64,7.64,7.64,7.64
2023-04-26,Mecklenburg-Vorpommern,13,00+,114,143,143,143,143,1610774,7.08,8.88,8.88,8.88,8.88
2023-04-25,Mecklenburg-Vorpommern,13,00+,127,153,153,153,153,1610774,7.88,9.5,9.5,9.5,9.5
2023-04-24,Mecklenburg-Vorpommern,13,00+,142,167,167,167,167,1610774,8.82,10.37,10.37,10.37,10.37
2023-04-23,Mecklenburg-Vorpommern,13,00+,142,167,167,167,167,1610774,8.82,10.37,10.37,10.37,10.37
2023-04-22,Mecklenburg-Vorpommern,13,00+,143,169,169,169,169,1610774,8.88,10.49,10.49,10.49,10.49
2023-04-21,Mecklenburg-Vorpommern,13,00+,150,175,175,175,175,1610774,9.31,10.86,10.86,10.86,10.86
2023-04-20,Mecklenburg-Vorpommern,13,00+,165,188,188,188,188,1610774,10.24,11.67,11.67,11.67,11.67
2023-04-19,Mecklenburg-Vorpommern,13,00+,163,193,193,193,193,1610774,10.12,11.98,11.98,11.98,11.98
...
2023-04-11,Mecklenburg-Vorpommern,13,00+,101,123,123,123,123,1610774,6.27,7.64,7.64,7.64,7.64
2023-04-10,Mecklenburg-Vorpommern,13,00+,159,182,182,182,182,1610774,9.87,11.3,11.3,11.3,11.3
2023-04-09,Mecklenburg-Vorpommern,13,00+,162,185,185,185,185,1610774,10.06,11.49,11.49,11.49,11.49
2023-04-08,Mecklenburg-Vorpommern,13,00+,162,182,182,182,182,1610774,10.06,11.3,11.3,11.3,11.3
2023-04-07,Mecklenburg-Vorpommern,13,00+,193,212,212,212,212,1610774,11.98,13.16,13.16,13.16,13.16
2023-04-06,Mecklenburg-Vorpommern,13,00+,194,217,217,217,217,1610774,12.04,13.47,13.47,13.47,13.47
2023-04-05,Mecklenburg-Vorpommern,13,00+,160,224,224,224,224,1610774,9.93,13.91,13.91,13.91,13.91
2023-04-04,Mecklenburg-Vorpommern,13,00+,182,215,215,215,215,1610774,11.3,13.35,13.35,13.35,13.35
2023-04-03,Mecklenburg-Vorpommern,13,00+,198,235,235,235,235,1610774,12.29,14.59,14.59,14.59,14.59
2023-04-02,Mecklenburg-Vorpommern,13,00+,200,234,234,234,234,1610774,12.42,14.53,14.53,14.53,14.53
2023-04-01,Mecklenburg-Vorpommern,13,00+,200,234,234,234,234,1610774,12.42,14.53,14.53,14.53,14.53
2023-03-31,Mecklenburg-Vorpommern,13,00+,202,249,249,249,249,1610774,12.54,15.46,15.46,15.46,15.46
2023-03-30,Mecklenburg-Vorpommern,13,00+,224,260,260,260,260,1610774,13.91,16.14,16.14,16.14,16.14
2023-03-29,Mecklenburg-Vorpommern,13,00+,230,277,277,277,277,1610774,14.28,17.2,17.2,17.2,17.2
2023-03-28,Mecklenburg-Vorpommern,13,00+,243,295,295,295,295,1610774,15.09,18.31,18.31,18.31,18.31
2023-03-27,Mecklenburg-Vorpommern,13,00+,239,291,291,291,291,1610774,14.84,18.07,18.07,18.07,18.07
2023-03-26,Mecklenburg-Vorpommern,13,00+,239,289,289,289,289,1610774,14.84,17.94,17.94,17.94,17.94
2023-03-25,Mecklenburg-Vorpommern,13,00+,239,289,289,289,289,1610774,14.84,17.94,17.94,17.94,17.94
2023-03-24,Mecklenburg-Vorpommern,13,00+,205,267,267,267,267,1610774,12.73,16.58,16.58,16.58,16.58
2023-03-23,Mecklenburg-Vorpommern,13,00+,177,262,262,262,262,1610774,10.99,16.27,16.27,16.27,16.27
2023-03-22,Mecklenburg-Vorpommern,13,00+,185,241,241,241,241,1610774,11.49,14.96,14.96,14.96,14.96
2023-03-21,Mecklenburg-Vorpommern,13,00+,173,222,222,222,222,1610774,10.74,13.78,13.78,13.78,13.78
2023-03-20,Mecklenburg-Vorpommern,13,00+,172,205,205,205,205,1610774,10.68,12.73,12.73,12.73,12.73
2023-03-19,Mecklenburg-Vorpommern,13,00+,172,205,205,205,205,1610774,10.68,12.73,12.73,12.73,12.73
2023-03-18,Mecklenburg-Vorpommern,13,00+,172,205,205,205,205,1610774,10.68,12.73,12.73,12.73,12.73
2023-03-17,Mecklenburg-Vorpommern,13,00+,157,203,203,203,203,1610774,9.75,12.6,12.6,12.6,12.6
...
2023-02-27,Mecklenburg-Vorpommern,13,00+,80,108,108,108,108,1610774,4.97,6.7,6.7,6.7,6.7
2023-02-26,Mecklenburg-Vorpommern,13,00+,84,109,109,109,109,1610774,5.21,6.77,6.77,6.77,6.77
2023-02-25,Mecklenburg-Vorpommern,13,00+,91,101,101,101,101,1610774,5.65,6.27,6.27,6.27,6.27
2023-02-24,Mecklenburg-Vorpommern,13,00+,84,102,102,102,102,1610774,5.21,6.33,6.33,6.33,6.33
2023-02-23,Mecklenburg-Vorpommern,13,00+,80,97,97,97,97,1610774,4.97,6.02,6.02,6.02,6.02
2023-02-22,Mecklenburg-Vorpommern,13,00+,84,100,100,100,100,1610774,5.21,6.21,6.21,6.21,6.21
2023-02-21,Mecklenburg-Vorpommern,13,00+,83,92,92,92,92,1610774,5.15,5.71,5.71,5.71,5.71
...
2023-12-20,Sachsen,14,00+,351,351,NA,NA,NA,4056941,8.65,8.65,NA,NA,NA
2023-12-19,Sachsen,14,00+,366,432,NA,NA,NA,4056941,9.02,10.65,NA,NA,NA
2023-12-18,Sachsen,14,00+,443,555,NA,NA,NA,4056941,10.92,13.68,NA,NA,NA
2023-12-17,Sachsen,14,00+,468,564,682,661,779,4056941,11.54,13.9,16.82,16.3,19.21
2023-12-16,Sachsen,14,00+,499,585,685,674,701,4056941,12.3,14.42,16.9,16.63,17.29
2023-12-15,Sachsen,14,00+,444,589,670,661,686,4056941,10.94,14.52,16.53,16.3,16.93
2023-12-14,Sachsen,14,00+,410,625,694,685,710,4056941,10.11,15.41,17.12,16.9,17.52
2023-12-13,Sachsen,14,00+,385,617,669,659,683,4056941,9.49,15.21,16.5,16.26,16.85
2023-12-12,Sachsen,14,00+,345,639,683,674,696,4056941,8.5,15.75,16.85,16.62,17.18
2023-12-11,Sachsen,14,00+,349,563,591,584,601,4056941,8.6,13.88,14.58,14.4,14.82
2023-12-10,Sachsen,14,00+,363,555,581,574,591,4056941,8.95,13.68,14.35,14.17,14.58
2023-12-09,Sachsen,14,00+,381,545,570,563,579,4056941,9.39,13.43,14.06,13.89,14.28
2023-12-08,Sachsen,14,00+,347,554,577,570,586,4056941,8.55,13.66,14.23,14.07,14.45
2023-12-07,Sachsen,14,00+,310,534,553,547,561,4056941,7.64,13.16,13.64,13.49,13.84
2023-12-06,Sachsen,14,00+,230,493,508,503,515,4056941,5.67,12.15,12.53,12.41,12.71
2023-12-05,Sachsen,14,00+,221,495,508,503,514,4056941,5.45,12.2,12.52,12.41,12.69
2023-12-04,Sachsen,14,00+,291,524,535,531,542,4056941,7.17,12.92,13.2,13.09,13.36
2023-12-03,Sachsen,14,00+,331,555,566,562,573,4056941,8.16,13.68,13.96,13.86,14.14
2023-12-02,Sachsen,14,00+,348,565,576,572,583,4056941,8.58,13.93,14.21,14.1,14.38
2023-12-01,Sachsen,14,00+,339,569,579,575,586,4056941,8.36,14.03,14.28,14.18,14.45
2023-11-30,Sachsen,14,00+,337,588,597,593,603,4056941,8.31,14.49,14.73,14.64,14.89
2023-11-29,Sachsen,14,00+,261,543,551,547,557,4056941,6.43,13.38,13.59,13.51,13.73
2023-11-28,Sachsen,14,00+,188,547,554,551,559,4056941,4.63,13.48,13.66,13.59,13.79
2023-11-27,Sachsen,14,00+,297,576,582,579,586,4056941,7.32,14.2,14.35,14.29,14.46
2023-11-26,Sachsen,14,00+,317,557,562,560,566,4056941,7.81,13.73,13.87,13.81,13.97
2023-11-25,Sachsen,14,00+,335,552,557,555,561,4056941,8.26,13.61,13.74,13.68,13.84
2023-11-24,Sachsen,14,00+,324,541,545,543,549,4056941,7.99,13.34,13.46,13.4,13.53
2023-11-23,Sachsen,14,00+,236,506,509,508,512,4056941,5.82,12.47,12.57,12.53,12.63
2023-11-22,Sachsen,14,00+,284,536,539,538,542,4056941,7,13.21,13.31,13.27,13.37
2023-11-21,Sachsen,14,00+,255,501,503,502,505,4056941,6.29,12.35,12.42,12.39,12.46
2023-11-20,Sachsen,14,00+,282,484,485,485,486,4056941,6.95,11.93,11.97,11.96,12
2023-11-19,Sachsen,14,00+,297,474,475,475,476,4056941,7.32,11.68,11.72,11.71,11.74
2023-11-18,Sachsen,14,00+,314,465,466,466,466,4056941,7.74,11.46,11.5,11.49,11.51
2023-11-17,Sachsen,14,00+,276,456,457,456,457,4056941,6.8,11.24,11.27,11.26,11.28
2023-11-16,Sachsen,14,00+,277,463,463,463,464,4056941,6.83,11.41,11.43,11.43,11.44
2023-11-15,Sachsen,14,00+,288,512,512,512,512,4056941,7.1,12.62,12.64,12.63,12.64
2023-11-14,Sachsen,14,00+,260,477,477,477,477,4056941,6.41,11.76,11.77,11.76,11.77
2023-11-13,Sachsen,14,00+,227,400,400,400,400,4056941,5.6,9.86,9.86,9.86,9.86
2023-11-12,Sachsen,14,00+,244,404,404,404,404,4056941,6.01,9.96,9.96,9.96,9.96
2023-11-11,Sachsen,14,00+,256,406,406,406,406,4056941,6.31,10.01,10.01,10.01,10.01
2023-11-10,Sachsen,14,00+,204,417,417,417,417,4056941,5.03,10.28,10.28,10.28,10.28
2023-11-09,Sachsen,14,00+,197,402,402,402,402,4056941,4.86,9.91,9.91,9.91,9.91
2023-11-08,Sachsen,14,00+,190,387,387,387,387,4056941,4.68,9.54,9.54,9.54,9.54
2023-11-07,Sachsen,14,00+,149,350,350,350,350,4056941,3.67,8.63,8.63,8.63,8.63
2023-11-06,Sachsen,14,00+,168,368,368,368,368,4056941,4.14,9.07,9.07,9.07,9.07
2023-11-05,Sachsen,14,00+,182,360,360,360,360,4056941,4.49,8.87,8.87,8.87,8.87
2023-11-04,Sachsen,14,00+,190,355,355,355,355,4056941,4.68,8.75,8.75,8.75,8.75
2023-11-03,Sachsen,14,00+,133,328,328,328,328,4056941,3.28,8.08,8.08,8.08,8.08
2023-11-02,Sachsen,14,00+,99,319,319,319,319,4056941,2.44,7.86,7.86,7.86,7.86
2023-11-01,Sachsen,14,00+,88,274,274,274,274,4056941,2.17,6.75,6.75,6.75,6.75
2023-10-31,Sachsen,14,00+,124,305,305,305,305,4056941,3.06,7.52,7.52,7.52,7.52
2023-10-30,Sachsen,14,00+,172,289,289,289,289,4056941,4.24,7.12,7.12,7.12,7.12
2023-10-29,Sachsen,14,00+,186,290,290,290,290,4056941,4.58,7.15,7.15,7.15,7.15
2023-10-28,Sachsen,14,00+,197,287,287,287,287,4056941,4.86,7.07,7.07,7.07,7.07
2023-10-27,Sachsen,14,00+,187,280,280,280,280,4056941,4.61,6.9,6.9,6.9,6.9
2023-10-26,Sachsen,14,00+,168,251,251,251,251,4056941,4.14,6.19,6.19,6.19,6.19
...
2023-10-23,Sachsen,14,00+,99,190,190,190,190,4056941,2.44,4.68,4.68,4.68,4.68
2023-10-22,Sachsen,14,00+,103,181,181,181,181,4056941,2.54,4.46,4.46,4.46,4.46
2023-10-21,Sachsen,14,00+,110,176,176,176,176,4056941,2.71,4.34,4.34,4.34,4.34
2023-10-20,Sachsen,14,00+,97,161,161,161,161,4056941,2.39,3.97,3.97,3.97,3.97
2023-10-19,Sachsen,14,00+,94,151,151,151,151,4056941,2.32,3.72,3.72,3.72,3.72
2023-10-18,Sachsen,14,00+,89,141,141,141,141,4056941,2.19,3.48,3.48,3.48,3.48
2023-10-17,Sachsen,14,00+,80,144,144,144,144,4056941,1.97,3.55,3.55,3.55,3.55
2023-10-16,Sachsen,14,00+,80,123,123,123,123,4056941,1.97,3.03,3.03,3.03,3.03
2023-10-15,Sachsen,14,00+,85,123,123,123,123,4056941,2.1,3.03,3.03,3.03,3.03
2023-10-14,Sachsen,14,00+,89,121,121,121,121,4056941,2.19,2.98,2.98,2.98,2.98
2023-10-13,Sachsen,14,00+,83,121,121,121,121,4056941,2.05,2.98,2.98,2.98,2.98
2023-10-12,Sachsen,14,00+,80,126,126,126,126,4056941,1.97,3.11,3.11,3.11,3.11
2023-10-11,Sachsen,14,00+,87,147,147,147,147,4056941,2.14,3.62,3.62,3.62,3.62
2023-10-10,Sachsen,14,00+,74,122,122,122,122,4056941,1.82,3.01,3.01,3.01,3.01
2023-10-09,Sachsen,14,00+,79,125,125,125,125,4056941,1.95,3.08,3.08,3.08,3.08
2023-10-08,Sachsen,14,00+,80,120,120,120,120,4056941,1.97,2.96,2.96,2.96,2.96
2023-10-07,Sachsen,14,00+,86,123,123,123,123,4056941,2.12,3.03,3.03,3.03,3.03
2023-10-06,Sachsen,14,00+,78,121,121,121,121,4056941,1.92,2.98,2.98,2.98,2.98
2023-10-05,Sachsen,14,00+,73,116,116,116,116,4056941,1.8,2.86,2.86,2.86,2.86
...
2023-09-20,Sachsen,14,00+,66,96,96,96,96,4056941,1.63,2.37,2.37,2.37,2.37
2023-09-19,Sachsen,14,00+,57,92,92,92,92,4056941,1.4,2.27,2.27,2.27,2.27
2023-09-18,Sachsen,14,00+,60,84,84,84,84,4056941,1.48,2.07,2.07,2.07,2.07
2023-09-17,Sachsen,14,00+,61,82,82,82,82,4056941,1.5,2.02,2.02,2.02,2.02
2023-09-16,Sachsen,14,00+,64,79,79,79,79,4056941,1.58,1.95,1.95,1.95,1.95
2023-09-15,Sachsen,14,00+,60,81,81,81,81,4056941,1.48,2,2,2,2
2023-09-14,Sachsen,14,00+,58,85,85,85,85,4056941,1.43,2.1,2.1,2.1,2.1
...
2023-12-20,Sachsen-Anhalt,15,00+,284,284,NA,NA,NA,2180684,13.02,13.02,NA,NA,NA
2023-12-19,Sachsen-Anhalt,15,00+,317,324,NA,NA,NA,2180684,14.54,14.86,NA,NA,NA
2023-12-18,Sachsen-Anhalt,15,00+,404,421,NA,NA,NA,2180684,18.53,19.31,NA,NA,NA
2023-12-17,Sachsen-Anhalt,15,00+,404,421,465,455,475,2180684,18.53,19.31,21.34,20.9,21.8
2023-12-16,Sachsen-Anhalt,15,00+,404,421,465,455,475,2180684,18.53,19.31,21.34,20.9,21.8
2023-12-15,Sachsen-Anhalt,15,00+,407,442,484,475,495,2180684,18.66,20.27,22.23,21.82,22.71
2023-12-14,Sachsen-Anhalt,15,00+,383,430,467,459,478,2180684,17.56,19.72,21.46,21.07,21.93
2023-12-13,Sachsen-Anhalt,15,00+,303,374,402,395,410,2180684,13.89,17.15,18.44,18.16,18.81
2023-12-12,Sachsen-Anhalt,15,00+,291,395,421,415,428,2180684,13.34,18.11,19.31,19.04,19.66
2023-12-11,Sachsen-Anhalt,15,00+,238,297,311,307,316,2180684,10.91,13.62,14.27,14.1,14.5
2023-12-10,Sachsen-Anhalt,15,00+,238,297,311,307,316,2180684,10.91,13.62,14.27,14.1,14.5
2023-12-09,Sachsen-Anhalt,15,00+,238,297,311,307,316,2180684,10.91,13.62,14.27,14.1,14.5
2023-12-08,Sachsen-Anhalt,15,00+,234,287,299,295,303,2180684,10.73,13.16,13.71,13.56,13.92
2023-12-07,Sachsen-Anhalt,15,00+,240,278,288,285,292,2180684,11.01,12.75,13.21,13.08,13.41
2023-12-06,Sachsen-Anhalt,15,00+,191,273,281,279,285,2180684,8.76,12.52,12.92,12.79,13.1
2023-12-05,Sachsen-Anhalt,15,00+,249,289,296,293,300,2180684,11.42,13.25,13.59,13.47,13.77
2023-12-04,Sachsen-Anhalt,15,00+,350,379,386,383,391,2180684,16.05,17.38,17.72,17.6,17.94
2023-12-03,Sachsen-Anhalt,15,00+,350,379,386,383,391,2180684,16.05,17.38,17.72,17.6,17.94
2023-12-02,Sachsen-Anhalt,15,00+,350,379,386,383,391,2180684,16.05,17.38,17.72,17.6,17.94
2023-12-01,Sachsen-Anhalt,15,00+,340,375,381,379,386,2180684,15.59,17.2,17.52,17.39,17.72
2023-11-30,Sachsen-Anhalt,15,00+,323,369,375,372,379,2180684,14.81,16.92,17.21,17.1,17.41
2023-11-29,Sachsen-Anhalt,15,00+,283,374,379,377,383,2180684,12.98,17.15,17.42,17.31,17.6
2023-11-28,Sachsen-Anhalt,15,00+,295,366,370,368,374,2180684,13.53,16.78,17.01,16.92,17.17
2023-11-27,Sachsen-Anhalt,15,00+,299,325,328,326,330,2180684,13.71,14.9,15.05,14.99,15.16
2023-11-26,Sachsen-Anhalt,15,00+,299,325,328,326,330,2180684,13.71,14.9,15.05,14.99,15.16
2023-11-25,Sachsen-Anhalt,15,00+,299,325,328,326,330,2180684,13.71,14.9,15.05,14.99,15.16
2023-11-24,Sachsen-Anhalt,15,00+,305,340,343,341,344,2180684,13.99,15.59,15.73,15.67,15.82
2023-11-23,Sachsen-Anhalt,15,00+,317,356,358,357,360,2180684,14.54,16.33,16.45,16.4,16.53
2023-11-22,Sachsen-Anhalt,15,00+,294,350,352,351,353,2180684,13.48,16.05,16.16,16.12,16.23
2023-11-21,Sachsen-Anhalt,15,00+,282,348,349,349,350,2180684,12.93,15.96,16.04,16.01,16.09
2023-11-20,Sachsen-Anhalt,15,00+,300,342,343,342,343,2180684,13.76,15.68,15.73,15.72,15.75
2023-11-19,Sachsen-Anhalt,15,00+,301,344,345,344,345,2180684,13.8,15.77,15.83,15.81,15.84
2023-11-18,Sachsen-Anhalt,15,00+,301,344,345,344,345,2180684,13.8,15.77,15.83,15.81,15.84
2023-11-17,Sachsen-Anhalt,15,00+,229,319,319,319,320,2180684,10.5,14.63,14.67,14.66,14.68
2023-11-16,Sachsen-Anhalt,15,00+,291,346,346,346,346,2180684,13.34,15.87,15.89,15.89,15.91
2023-11-15,Sachsen-Anhalt,15,00+,252,352,352,352,352,2180684,11.56,16.14,16.16,16.16,16.17
2023-11-14,Sachsen-Anhalt,15,00+,214,313,313,313,313,2180684,9.81,14.35,14.36,14.36,14.37
2023-11-13,Sachsen-Anhalt,15,00+,244,280,280,280,280,2180684,11.19,12.84,12.84,12.84,12.84
2023-11-12,Sachsen-Anhalt,15,00+,251,285,285,285,285,2180684,11.51,13.07,13.07,13.07,13.07
2023-11-11,Sachsen-Anhalt,15,00+,254,288,288,288,288,2180684,11.65,13.21,13.21,13.21,13.21
2023-11-10,Sachsen-Anhalt,15,00+,254,297,297,297,297,2180684,11.65,13.62,13.62,13.62,13.62
2023-11-09,Sachsen-Anhalt,15,00+,212,274,274,274,274,2180684,9.72,12.56,12.56,12.56,12.56
2023-11-08,Sachsen-Anhalt,15,00+,297,336,336,336,336,2180684,13.62,15.41,15.41,15.41,15.41
2023-11-07,Sachsen-Anhalt,15,00+,228,297,297,297,297,2180684,10.46,13.62,13.62,13.62,13.62
2023-11-06,Sachsen-Anhalt,15,00+,225,269,269,269,269,2180684,10.32,12.34,12.34,12.34,12.34
2023-11-05,Sachsen-Anhalt,15,00+,226,264,264,264,264,2180684,10.36,12.11,12.11,12.11,12.11
2023-11-04,Sachsen-Anhalt,15,00+,226,263,263,263,263,2180684,10.36,12.06,12.06,12.06,12.06
2023-11-03,Sachsen-Anhalt,15,00+,193,258,258,258,258,2180684,8.85,11.83,11.83,11.83,11.83
2023-11-02,Sachsen-Anhalt,15,00+,164,243,243,243,243,2180684,7.52,11.14,11.14,11.14,11.14
...
2023-10-25,Sachsen-Anhalt,15,00+,126,161,161,161,161,2180684,5.78,7.38,7.38,7.38,7.38
2023-10-24,Sachsen-Anhalt,15,00+,119,148,148,148,148,2180684,5.46,6.79,6.79,6.79,6.79
2023-10-23,Sachsen-Anhalt,15,00+,113,139,139,139,139,2180684,5.18,6.37,6.37,6.37,6.37
2023-10-22,Sachsen-Anhalt,15,00+,114,136,136,136,136,2180684,5.23,6.24,6.24,6.24,6.24
2023-10-21,Sachsen-Anhalt,15,00+,115,133,133,133,133,2180684,5.27,6.1,6.1,6.1,6.1
2023-10-20,Sachsen-Anhalt,15,00+,120,145,145,145,145,2180684,5.5,6.65,6.65,6.65,6.65
2023-10-19,Sachsen-Anhalt,15,00+,109,134,134,134,134,2180684,5,6.14,6.14,6.14,6.14
2023-10-18,Sachsen-Anhalt,15,00+,93,126,126,126,126,2180684,4.26,5.78,5.78,5.78,5.78
2023-10-17,Sachsen-Anhalt,15,00+,82,113,113,113,113,2180684,3.76,5.18,5.18,5.18,5.18
2023-10-16,Sachsen-Anhalt,15,00+,98,120,120,120,120,2180684,4.49,5.5,5.5,5.5,5.5
2023-10-15,Sachsen-Anhalt,15,00+,99,120,120,120,120,2180684,4.54,5.5,5.5,5.5,5.5
2023-10-14,Sachsen-Anhalt,15,00+,99,119,119,119,119,2180684,4.54,5.46,5.46,5.46,5.46
2023-10-13,Sachsen-Anhalt,15,00+,86,112,112,112,112,2180684,3.94,5.14,5.14,5.14,5.14
2023-10-12,Sachsen-Anhalt,15,00+,79,113,113,113,113,2180684,3.62,5.18,5.18,5.18,5.18
2023-10-11,Sachsen-Anhalt,15,00+,94,127,127,127,127,2180684,4.31,5.82,5.82,5.82,5.82
2023-10-10,Sachsen-Anhalt,15,00+,71,114,114,114,114,2180684,3.26,5.23,5.23,5.23,5.23
...
2023-04-10,Sachsen-Anhalt,15,00+,93,122,122,122,122,2180684,4.26,5.59,5.59,5.59,5.59
2023-04-09,Sachsen-Anhalt,15,00+,93,120,120,120,120,2180684,4.26,5.5,5.5,5.5,5.5
2023-04-08,Sachsen-Anhalt,15,00+,93,121,121,121,121,2180684,4.26,5.55,5.55,5.55,5.55
2023-04-07,Sachsen-Anhalt,15,00+,106,136,136,136,136,2180684,4.86,6.24,6.24,6.24,6.24
2023-04-06,Sachsen-Anhalt,15,00+,109,145,145,145,145,2180684,5,6.65,6.65,6.65,6.65
2023-04-05,Sachsen-Anhalt,15,00+,124,157,157,157,157,2180684,5.69,7.2,7.2,7.2,7.2
2023-04-04,Sachsen-Anhalt,15,00+,125,171,171,171,171,2180684,5.73,7.84,7.84,7.84,7.84
...
2023-12-20,Thüringen,16,00+,355,355,NA,NA,NA,2120237,16.74,16.74,NA,NA,NA
2023-12-19,Thüringen,16,00+,338,384,NA,NA,NA,2120237,15.94,18.11,NA,NA,NA
2023-12-18,Thüringen,16,00+,352,387,NA,NA,NA,2120237,16.6,18.25,NA,NA,NA
2023-12-17,Thüringen,16,00+,353,386,441,431,452,2120237,16.65,18.21,20.82,20.37,21.36
2023-12-16,Thüringen,16,00+,356,386,440,430,452,2120237,16.79,18.21,20.75,20.29,21.33
2023-12-15,Thüringen,16,00+,263,325,361,354,371,2120237,12.4,15.33,17.06,16.71,17.5
2023-12-14,Thüringen,16,00+,261,345,377,370,386,2120237,12.31,16.27,17.81,17.47,18.24
2023-12-13,Thüringen,16,00+,251,331,357,351,365,2120237,11.84,15.61,16.88,16.58,17.26
2023-12-12,Thüringen,16,00+,238,302,322,317,328,2120237,11.23,14.24,15.2,14.97,15.51
2023-12-11,Thüringen,16,00+,230,287,300,297,305,2120237,10.85,13.54,14.18,14.01,14.4
2023-12-10,Thüringen,16,00+,233,290,303,300,308,2120237,10.99,13.68,14.32,14.15,14.55
2023-12-09,Thüringen,16,00+,235,289,302,298,307,2120237,11.08,13.63,14.26,14.1,14.49
2023-12-08,Thüringen,16,00+,224,284,296,292,300,2120237,10.56,13.39,13.97,13.81,14.19
2023-12-07,Thüringen,16,00+,204,256,265,262,269,2120237,9.62,12.07,12.51,12.38,12.69
2023-12-06,Thüringen,16,00+,193,261,269,266,272,2120237,9.1,12.31,12.7,12.57,12.87
2023-12-05,Thüringen,16,00+,188,260,267,264,270,2120237,8.87,12.26,12.6,12.49,12.77
2023-12-04,Thüringen,16,00+,192,239,244,242,247,2120237,9.06,11.27,11.51,11.42,11.65
2023-12-03,Thüringen,16,00+,196,240,245,243,248,2120237,9.24,11.32,11.56,11.47,11.7
2023-12-02,Thüringen,16,00+,200,242,247,245,250,2120237,9.43,11.41,11.65,11.56,11.79
2023-12-01,Thüringen,16,00+,192,241,245,243,248,2120237,9.06,11.37,11.58,11.5,11.72
2023-11-30,Thüringen,16,00+,197,244,248,246,250,2120237,9.29,11.51,11.7,11.63,11.83
2023-11-29,Thüringen,16,00+,177,241,244,243,246,2120237,8.35,11.37,11.53,11.47,11.65
2023-11-28,Thüringen,16,00+,189,245,248,246,250,2120237,8.91,11.56,11.7,11.64,11.8
2023-11-27,Thüringen,16,00+,234,278,280,279,282,2120237,11.04,13.11,13.24,13.19,13.33
2023-11-26,Thüringen,16,00+,237,279,281,280,283,2120237,11.18,13.16,13.29,13.24,13.38
2023-11-25,Thüringen,16,00+,239,277,279,278,281,2120237,11.27,13.06,13.19,13.14,13.28
2023-11-24,Thüringen,16,00+,240,283,285,284,287,2120237,11.32,13.35,13.47,13.42,13.55
2023-11-23,Thüringen,16,00+,261,295,297,296,298,2120237,12.31,13.91,14.02,13.98,14.09
2023-11-22,Thüringen,16,00+,242,311,313,312,314,2120237,11.41,14.67,14.76,14.73,14.82
2023-11-21,Thüringen,16,00+,248,307,308,308,309,2120237,11.7,14.48,14.56,14.53,14.6
2023-11-20,Thüringen,16,00+,238,283,283,283,284,2120237,11.23,13.35,13.39,13.38,13.41
2023-11-19,Thüringen,16,00+,239,278,278,278,279,2120237,11.27,13.11,13.16,13.14,13.17
2023-11-18,Thüringen,16,00+,244,281,281,281,282,2120237,11.51,13.25,13.3,13.28,13.31
2023-11-17,Thüringen,16,00+,231,297,297,297,298,2120237,10.9,14.01,14.04,14.03,14.06
2023-11-16,Thüringen,16,00+,256,314,314,314,314,2120237,12.07,14.81,14.83,14.83,14.84
2023-11-15,Thüringen,16,00+,245,303,303,303,303,2120237,11.56,14.29,14.31,14.3,14.31
2023-11-14,Thüringen,16,00+,223,291,291,291,291,2120237,10.52,13.72,13.73,13.73,13.74
2023-11-13,Thüringen,16,00+,312,368,368,368,368,2120237,14.72,17.36,17.36,17.36,17.36
2023-11-12,Thüringen,16,00+,312,367,367,367,367,2120237,14.72,17.31,17.31,17.31,17.31
2023-11-11,Thüringen,16,00+,317,367,367,367,367,2120237,14.95,17.31,17.31,17.31,17.31
2023-11-10,Thüringen,16,00+,294,358,358,358,358,2120237,13.87,16.88,16.88,16.88,16.88
2023-11-09,Thüringen,16,00+,284,324,324,324,324,2120237,13.39,15.28,15.28,15.28,15.28
2023-11-08,Thüringen,16,00+,328,381,381,381,381,2120237,15.47,17.97,17.97,17.97,17.97
2023-11-07,Thüringen,16,00+,214,358,358,358,358,2120237,10.09,16.88,16.88,16.88,16.88
2023-11-06,Thüringen,16,00+,188,249,249,249,249,2120237,8.87,11.74,11.74,11.74,11.74
2023-11-05,Thüringen,16,00+,190,251,251,251,251,2120237,8.96,11.84,11.84,11.84,11.84
2023-11-04,Thüringen,16,00+,191,247,247,247,247,2120237,9.01,11.65,11.65,11.65,11.65
2023-11-03,Thüringen,16,00+,190,242,242,242,242,2120237,8.96,11.41,11.41,11.41,11.41
2023-11-02,Thüringen,16,00+,180,234,234,234,234,2120237,8.49,11.04,11.04,11.04,11.04
2023-11-01,Thüringen,16,00+,106,160,160,160,160,2120237,5,7.55,7.55,7.55,7.55
2023-10-31,Thüringen,16,00+,159,211,211,211,211,2120237,7.5,9.95,9.95,9.95,9.95
2023-10-30,Thüringen,16,00+,182,222,222,222,222,2120237,8.58,10.47,10.47,10.47,10.47
2023-10-29,Thüringen,16,00+,184,222,222,222,222,2120237,8.68,10.47,10.47,10.47,10.47
2023-10-28,Thüringen,16,00+,185,223,223,223,223,2120237,8.73,10.52,10.52,10.52,10.52
2023-10-27,Thüringen,16,00+,159,208,208,208,208,2120237,7.5,9.81,9.81,9.81,9.81
...
2023-10-19,Thüringen,16,00+,133,178,178,178,178,2120237,6.27,8.4,8.4,8.4,8.4
2023-10-18,Thüringen,16,00+,130,169,169,169,169,2120237,6.13,7.97,7.97,7.97,7.97
2023-10-17,Thüringen,16,00+,135,177,177,177,177,2120237,6.37,8.35,8.35,8.35,8.35
2023-10-16,Thüringen,16,00+,108,140,140,140,140,2120237,5.09,6.6,6.6,6.6,6.6
2023-10-15,Thüringen,16,00+,108,136,136,136,136,2120237,5.09,6.41,6.41,6.41,6.41
2023-10-14,Thüringen,16,00+,108,136,136,136,136,2120237,5.09,6.41,6.41,6.41,6.41
2023-10-13,Thüringen,16,00+,87,128,128,128,128,2120237,4.1,6.04,6.04,6.04,6.04
...
2023-06-29,Thüringen,16,00+,7,12,12,12,12,2120237,0.33,0.57,0.57,0.57,0.57
2023-06-28,Thüringen,16,00+,7,13,13,13,13,2120237,0.33,0.61,0.61,0.61,0.61
2023-06-27,Thüringen,16,00+,7,11,11,11,11,2120237,0.33,0.52,0.52,0.52,0.52
2023-06-26,Thüringen,16,00+,12,14,14,14,14,2120237,0.57,0.66,0.66,0.66,0.66
2023-06-25,Thüringen,16,00+,12,14,14,14,14,2120237,0.57,0.66,0.66,0.66,0.66
2023-06-24,Thüringen,16,00+,12,14,14,14,14,2120237,0.57,0.66,0.66,0.66,0.66
2023-06-23,Thüringen,16,00+,15,16,16,16,16,2120237,0.71,0.75,0.75,0.75,0.75
...
2023-05-02,Thüringen,16,00+,65,87,87,87,87,2120237,3.07,4.1,4.1,4.1,4.1
2023-05-01,Thüringen,16,00+,92,116,116,116,116,2120237,4.34,5.47,5.47,5.47,5.47
2023-04-30,Thüringen,16,00+,95,119,119,119,119,2120237,4.48,5.61,5.61,5.61,5.61
2023-04-29,Thüringen,16,00+,96,116,116,116,116,2120237,4.53,5.47,5.47,5.47,5.47
2023-04-28,Thüringen,16,00+,90,113,113,113,113,2120237,4.24,5.33,5.33,5.33,5.33
2023-04-27,Thüringen,16,00+,72,104,104,104,104,2120237,3.4,4.91,4.91,4.91,4.91
2023-04-26,Thüringen,16,00+,59,90,90,90,90,2120237,2.78,4.24,4.24,4.24,4.24
...
2023-03-21,Thüringen,16,00+,297,356,356,356,356,2120237,14.01,16.79,16.79,16.79,16.79
2023-03-20,Thüringen,16,00+,278,351,351,351,351,2120237,13.11,16.55,16.55,16.55,16.55
2023-03-19,Thüringen,16,00+,285,350,350,350,350,2120237,13.44,16.51,16.51,16.51,16.51
2023-03-18,Thüringen,16,00+,293,351,351,351,351,2120237,13.82,16.55,16.55,16.55,16.55
2023-03-17,Thüringen,16,00+,286,361,361,361,361,2120237,13.49,17.03,17.03,17.03,17.03
2023-03-16,Thüringen,16,00+,283,349,349,349,349,2120237,13.35,16.46,16.46,16.46,16.46
2023-03-15,Thüringen,16,00+,277,352,352,352,352,2120237,13.06,16.6,16.6,16.6,16.6
2023-03-14,Thüringen,16,00+,266,335,335,335,335,2120237,12.55,15.8,15.8,15.8,15.8
2023-03-13,Thüringen,16,00+,242,319,319,319,319,2120237,11.41,15.05,15.05,15.05,15.05
2023-03-12,Thüringen,16,00+,245,315,315,315,315,2120237,11.56,14.86,14.86,14.86,14.86
2023-03-11,Thüringen,16,00+,247,308,308,308,308,2120237,11.65,14.53,14.53,14.53,14.53
2023-03-10,Thüringen,16,00+,213,272,272,272,272,2120237,10.05,12.83,12.83,12.83,12.83
2023-03-09,Thüringen,16,00+,203,268,268,268,268,2120237,9.57,12.64,12.64,12.64,12.64
2023-03-08,Thüringen,16,00+,200,273,273,273,273,2120237,9.43,12.88,12.88,12.88,12.88
2023-03-07,Thüringen,16,00+,190,250,250,250,250,2120237,8.96,11.79,11.79,11.79,11.79
2023-03-06,Thüringen,16,00+,212,255,255,255,255,2120237,10,12.03,12.03,12.03,12.03
2023-03-05,Thüringen,16,00+,216,255,255,255,255,2120237,10.19,12.03,12.03,12.03,12.03
2023-03-04,Thüringen,16,00+,221,258,258,258,258,2120237,10.42,12.17,12.17,12.17,12.17
2023-03-03,Thüringen,16,00+,219,262,262,262,262,2120237,10.33,12.36,12.36,12.36,12.36
2023-03-02,Thüringen,16,00+,218,267,267,267,267,2120237,10.28,12.59,12.59,12.59,12.59
2023-03-01,Thüringen,16,00+,219,267,267,267,267,2120237,10.33,12.59,12.59,12.59,12.59
2023-02-28,Thüringen,16,00+,220,293,293,293,293,2120237,10.38,13.82,13.82,13.82,13.82
...
2023-02-03,Thüringen,16,00+,80,132,132,132,132,2120237,3.77,6.23,6.23,6.23,6.23
2023-02-02,Thüringen,16,00+,82,119,119,119,119,2120237,3.87,5.61,5.61,5.61,5.61
2023-02-01,Thüringen,16,00+,62,110,110,110,110,2120237,2.92,5.19,5.19,5.19,5.19
2023-01-31,Thüringen,16,00+,65,102,102,102,102,2120237,3.07,4.81,4.81,4.81,4.81
2023-01-30,Thüringen,16,00+,78,99,99,99,99,2120237,3.68,4.67,4.67,4.67,4.67
2023-01-29,Thüringen,16,00+,80,94,94,94,94,2120237,3.77,4.43,4.43,4.43,4.43
2023-01-28,Thüringen,16,00+,81,94,94,94,94,2120237,3.82,4.43,4.43,4.43,4.43
...
`;const C0={cologne:{svnPath:"original-data/hospital-cases/cologne/KoelnAllgemeinpatienten.csv",csvCasesColumn:"allgemeinpatienten",legendText:"Reported: Hospitalizations (City)"}},r1=y0+"original-data/hospital-cases/cologne/DiviIncidenceNRW.csv",O0={cologne:y0+"original-data/Fallzahlen/"+"Cologne/cologne-hospital.csv"},x0={berlin:{name:"Berlin"},cologne:{name:"Nordrhein-Westfalen"}};let I0=1,H0=[],k0=[],w0=[];async function a1(){if(k0.length||(k0=f0.parse(e1,{header:!0,dynamicTyping:!0,skipEmptyLines:!0,comments:"#"}).data),!w0.length){const c=await(await fetch(r1)).text();w0=f0.parse(c,{header:!0,dynamicTyping:!0,skipEmptyLines:!0,comments:"#"}).data}}async function s1(a){return await i1(a)}async function i1(a){const{data:c,totalPopulation:W,city:b,intakesHosp:S}=a,V=[];await a1();const R=new Map;let z=new Set;for(let f=0;f<c.length;f++)if(c[f].measurement!=null){let y=c[f].measurement.trim(),v=c[f].severity.trim(),Q=c[f].date.trim(),n0=c[f].n,$=y+v;const K=new Date(Q);if(K.getDay()==0)K.setDate(K.getDate()-3),Q=K.toISOString().substring(0,10);else continue;z.add(Q);let e0=[];R.has($)&&(e0=R.get($)),e0.push(n0),R.set($,e0)}let s=Array.from(z);return S?R.forEach((f,y)=>{y.startsWith("intakes")&&V.push({name:y,visible:!0,x:s,y:f,line:{width:1}})}):R.forEach((f,y)=>{y.startsWith("occupancy")&&V.push({name:y,visible:!0,x:s,y:f,line:{width:1}})}),S?await t1(V,b):await l1(V,W,b),V}const T0={},R0={};async function l1(a,c,W){if(I0=c/1e5,C0[W]){const b=C0[W];if(!(W in T0)){const V=y0+b.svnPath;console.log(V);const R=await fetch(V).then(async s=>await s.text()),z=f0.parse(R,{header:!0,dynamicTyping:!1,skipEmptyLines:!0}).data;T0[W]=z}const S=T0[W];a.push({name:b.legendText,visible:!0,x:S.map(V=>V.date.split("T")[0]),y:S.map(V=>parseFloat(V[b.csvCasesColumn])/I0),line:{width:1}})}}async function t1(a,c){H0=[];try{if(O0[c]){if(!(c in R0)){const y=await(await fetch(O0[c])).text(),v=f0.parse(y,{header:!0,dynamicTyping:!0,skipEmptyLines:!0,comments:"#"}).data;R0[c]=v}const s=R0[c];if(s.length){H0=s;for(let f=0;f<a.length;f++)a[f].name=="Observed Hospitalization Case Rate"&&a.splice(f,1);a.length&&a.push({name:"Observed Hospitalization Case Rate",visible:!0,x:H0.map(f=>f.date),y:H0.map(f=>f.realHospitalizationRate),line:{width:1}})}}}catch(s){console.error(s)}if(!x0[c])return;const W=x0[c],S=k0.filter(s=>s.Altersgruppe==="00+").filter(s=>s.Bundesland===W.name);for(let s=0;s<a.length;s++)a[s].name=="Observed: "+W.name+" (RKI)"&&a.splice(s,1),a[s].name=="Adjusted: "+W.name+" (RKI)"&&a.splice(s,1);a.push({name:"Observed: "+W.name+" (RKI) WITH Covid",visible:!0,x:S.map(s=>s.Datum),y:S.map(s=>s.aktualisierte_7T_Hospitalisierung_Inzidenz||s["7T_Hospitalisierung_Inzidenz"]),line:{width:1}}),a.push({name:"Adjusted: "+W.name+" (RKI) WITH Covid",visible:!0,x:S.map(s=>s.Datum),y:S.map(s=>s.PS_adjustierte_7T_Hospitalisierung_Inzidenz),line:{width:1}});const V=/^202[2-9]/,R=S.filter(s=>!V.test(s.Datum)).map(s=>s.PS_adjustierte_7T_Hospitalisierung_Inzidenz*2/3),z=S.filter(s=>V.test(s.Datum)).map(s=>s.PS_adjustierte_7T_Hospitalisierung_Inzidenz/3);a.push({name:"Adjusted: "+W.name+" (RKI) FROM Covid",visible:!0,x:S.map(s=>s.Datum),y:z.concat(R),line:{width:1}});try{let s=!1;a.forEach(y=>{y.name=="Observed : Nordrhein-Westfalen (DIVI)"&&(s=!0)});const f=w0;f.length&&a.length&&!s&&a.push({name:"Observed : Nordrhein-Westfalen (DIVI)",visible:!0,x:f.map(y=>y.Date),y:f.map(y=>y.DIVIIncidence),line:{width:1}})}catch(s){console.error(s)}}X0({buildDataLines:s1})})();
//# sourceMappingURL=postHospital.worker-DDhiHJZ8.js.map
